...
cd confidential-containers-containerd-"$PKG_VERSION"
go mod edit -modfile=go.mod -require=google.golang.org/grpc@v1.83.2
go mod edit -modfile=go.mod -require=go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc@v0.69.0
