...
* Mon Apr 06 2026 azldev <> - 0.7.35-4
...
* Tue Apr 05 2016 Igor Gnatenko <ignatenko@redhat.com> - 0.6.19-89
- re-organize spec file

* Tue Mar 08 2016 Jaroslav Mracek <jmracek@redhat.com>
- Apply 9 patches from upstream

* Sat Feb 27 2016 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- Update to 0.6.19

* Tue Feb 02 2016 Peter Robinson <pbrobinson@gmail.com>
- Explicitly add rubypick and ruubygems build dependencies

* Tue Jan 12 2016 Vít Ondruch <vondruch@redhat.com>
- Rebuilt for https://fedoraproject.org/wiki/Changes/Ruby_2.3

* Sun Jan 10 2016 Dan Horák <dan@danny.cz>
- fix build on non-Fedora with python3

* Tue Jan 05 2016 Jaroslav Mracek <jmracek@redhat.com>
- Fix bzip2 support for python3 build (RhBug:1293652)

* Fri Dec 18 2015 Michal Luscon <mluscon@redhat.com>
- Revert reworked multiversion orphaned handling

* Thu Dec 17 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- Update to 0.6.15

* Thu Dec 10 2015 Jaroslav Mracek <jmracek@redhat.com>
- Enable bzip2 support

* Thu Nov 26 2015 Adam Williamson <awilliam@redhat.com>
- revert obsolete, as %%python_provide does it (undocumented)

* Wed Nov 18 2015 Adam Williamson <awilliam@redhat.com>
...
* Wed Oct 14 2015 Michal Luscon <mluscon@redhat.com>
- Backport upstream patches

* Mon Oct 12 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- fix examples in docs

* Mon Oct 12 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- Update to 0.6.14; Backport patches from upstream

* Thu Sep 10 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- include pkgconfig file to devel subpkg

* Thu Sep 10 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- Update to 0.6.12

* Thu Aug 06 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- drop unused patch

* Wed Aug 05 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com>
- really upload sources + spec cleanup from patch

* Wed Aug 05 2015 Colin Walters <walters@verbum.org>
...
* Wed Aug 05 2015 Jan Silhan <jsilhan@redhat.com>
...
* Tue Aug 04 2015 Adam Williamson <awilliam@redhat.com>
- bindings require the exact matching version of the lib (#1243737)

* Mon Jun 22 2015 Jan Silhan <jsilhan@redhat.com>
- New version: 2db517f

* Wed Jun 17 2015 Dennis Gilmore <dennis@ausil.us>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_23_Mass_Rebuild

* Fri Mar 27 2015 Jan Silhan <jsilhan@redhat.com>
- New version: 99edb54

* Wed Mar 25 2015 Jan Silhan <jsilhan@redhat.com>
- new tar
...
* Fri Mar 06 2015 Jan Silhan <jsilhan@redhat.com>
- building python2-solv subpkg finally

* Mon Mar 02 2015 Jan Silhan <jsilhan@redhat.com>
- fixed source

* Mon Mar 02 2015 Jan Silhan <jsilhan@redhat.com>
- adds python3 requirement

* Thu Feb 26 2015 Jan Silhan <jsilhan@redhat.com>
- tmp

* Tue Feb 24 2015 Jan Silhan <jsilhan@redhat.com>
- generating python3-solv subpackage

* Tue Feb 24 2015 Jan Silhan <jsilhan@redhat.com>
- rebase to 78c8a55

* Mon Jan 19 2015 Vít Ondruch <vondruch@redhat.com>
- Rebuilt for https://fedoraproject.org/wiki/Changes/Ruby_2.2

* Fri Jan 16 2015 Richard Hughes <richard@hughsie.com>
- Update to latest upstream release to fix a crash in PackageKit

* Sun Aug 17 2014 Peter Robinson <pbrobinson@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_22_Mass_Rebuild

* Mon Aug 11 2014 Jan Silhan <jsilhan@redhat.com>
- rebase to 12af31a

* Mon Jul 28 2014 Ales Kozumplik <ales@redhat.com>
- rebase to 5bd9589

* Mon Jul 14 2014 Jan Silhan <jsilhan@redhat.com>
...
* Tue May 27 2014 Ales Kozumplik <ales@redhat.com>
- rebase to 6d968f1

* Fri Apr 25 2014 Jan Silhan <jsilhan@redhat.com>
- rebase to f78f5de

* Thu Apr 24 2014 Vít Ondruch <vondruch@redhat.com>
- Rebuilt for https://fedoraproject.org/wiki/Changes/Ruby_2.1

* Wed Apr 09 2014 Jan Silhan <jsilhan@redhat.com>
...
* Thu Jan 23 2014 Ales Kozumplik <ales@redhat.com>
- rebase

* Mon Dec 16 2013 Ales Kozumplik <ales@redhat.com>
- rebase to a8e47f1

* Fri Nov 22 2013 Zdenek Pavlas <zpavlas@redhat.com>
- Rebase to 0.4.0, upstream commit 4442b7f.
- support DELTA_LOCATION_BASE for completeness

* Tue Oct 29 2013 Ales Kozumplik <ales@redhat.com>
- rebase to d49d319.

* Sat Aug 03 2013 Petr Písař <ppisar@redhat.com>
- Perl 5.18 rebuild

* Wed Jul 31 2013 Ales Kozumplik <ales@redhat.com>
- Rebase to upstream a59d11d

* Mon Jul 22 2013 Ales Kozumplik <ales@redhat.com>
- missing requires

* Mon Jul 22 2013 Ales Kozumplik <ales@redhat.com>
- forgot to bump the release.

* Fri Jul 19 2013 Ales Kozumplik <ales@redhat.com>
- add build flags.

* Wed Jul 17 2013 Petr Písař <ppisar@redhat.com>
- Perl 5.18 rebuild

* Mon Jun 24 2013 Ales Kozumplik <ales@redhat.com>
- rebased to upstream 228d412

* Thu Jun 20 2013 Ales Kozumplik <ales@redhat.com>
- fix: bogus date in changelog

* Thu Jun 20 2013 Ales Kozumplik <ales@redhat.com>
- rebase to upstream 209e9cb

* Thu May 16 2013 Ales Kozumplik <ales@redhat.com>
- run make test

* Thu May 16 2013 Ales Kozumplik <ales@redhat.com>
- rebase to 7399ad1.

* Mon Apr 08 2013 Ales Kozumplik <ales@redhat.com>
- rebase to upstream e372b78

* Thu Feb 14 2013 Dennis Gilmore <dennis@ausil.us>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_19_Mass_Rebuild

* Fri Dec 21 2012 Ales Kozumplik <ales@redhat.com>
- Add missing sources.

* Fri Dec 21 2012 Ales Kozumplik <ales@redhat.com>
- wip

* Thu Aug 23 2012 Ales Kozumplik <ales@redhat.com>
- Rebase to 6c9d3eb.

* Mon Jul 23 2012 Ales Kozumplik <ales@redhat.com>
- Fix Perl build.

* Mon Jul 23 2012 Ales Kozumplik <ales@redhat.com>
- Rebuild.

* Thu Jul 19 2012 Dennis Gilmore <dennis@ausil.us>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_18_Mass_Rebuild

* Mon Jul 16 2012 Ales Kozumplik <ales@redhat.com>
- preliminary fix for JOB resons in solver_describe_decision().

* Sun Jul 01 2012 Ales Kozumplik <ales@redhat.com>
- rebuild

* Thu Jun 07 2012 Ales Kozumplik <ales@redhat.com>
- Rebase to the latest upstream.

* Fri May 18 2012 Ales Kozumplik <akozumpl@redhat.com>
- Rebase to upstream 8cf7650.

* Thu Apr 12 2012 Ales Kozumplik <akozumpl@redhat.com>
- rebase to af1465a2.

* Thu Apr 05 2012 Karel Klic <kklic@redhat.com>
- rebuild

* Mon Apr 02 2012 Karel Klic <kklic@redhat.com>
- rebuild

* Wed Mar 21 2012 Ales Kozumplik <akozumpl@redhat.com>
- the previous build had a wrong relase number in spec.

* Wed Mar 21 2012 Ales Kozumplik <akozumpl@redhat.com>
- Update to upstream libsolv HEAD 857fe28.

* Tue Feb 07 2012 Karel Klic <kklic@redhat.com>
- Adapted to Ruby 1.9.3

* Mon Feb 06 2012 Karel Klic <kklic@redhat.com>
- Initial commit
