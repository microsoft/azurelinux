...
install -D -m0644 deployments/multus-daemonset.yml %{buildroot}%{_datadir}/k8s-yaml/multus/multus.yaml
...
%changelog
* Thu Feb 12 2026 Azure Linux Security Servicing Account <azurelinux-security@microsoft.com> - 4.0.2-10
- Patch for CVE-2025-58190, CVE-2025-47911

* Thu Sep 04 2025 Akhila Guruju <v-guakhila@microsoft.com> - 4.0.2-9
- Bump release to rebuild with golang

* Fri Apr 25 2025 Kevin Lockwood <v-klockwood@microsoft.com> - 4.0.2-8
