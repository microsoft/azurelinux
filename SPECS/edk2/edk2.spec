...
(cd CryptoPkg/Library/OpensslLib/openssl && patch -p1 ) < %{PATCH1005}
...
%changelog
* Mon Apr 14 2025 Archana Choudhary <archana1@microsoft.com> - 20240524git3e722403cd16-6
