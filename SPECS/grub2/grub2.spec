...
%changelog
* Mon Mar 13 2023 Daniel McIlvaney <damcilva@microsoft.com> - 2.06-9
- Support loading /boot from mdraid devices using more recent metadata (>=1.0)
