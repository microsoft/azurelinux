...
Patch4:         CVE-2024-4032.patch
Patch5:         CVE-2024-6345.patch
BuildRequires:  bazel
...
# Patch CVE-2024-4032, CVE-2024-6345 in the bundled python for applicable archs: `ExclusiveArch:  x86_64`
...
%changelog
* Mon Oct 21 2024 Archana Choudhary <archana1@microsoft.com> - 2.16.1-8.cm2
- Bump release to build with new python3 to fix CVE-2024-4032, CVE-2024-6345
