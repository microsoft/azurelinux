...
%exclude /usr/local/libexec/dnf-utils-2
%exclude %_libdir/python2.7/site-packages/dnf-plugins/*
%exclude %_libdir/python2.7/site-packages/dnfpluginscore/
%exclude %{_mandir}/man1/yum-changelog.1.gz
%exclude %{_mandir}/man8/*.8.gz
%exclude %{_mandir}/man5/yum-versionlock.conf.5.gz
%exclude /usr/local/share/man/*
%exclude /usr/local/share/locale/*/LC_MESSAGES/dnf-plugins-core.mo
%exclude %{_datadir}/locale/*/LC_MESSAGES/dnf-plugins-core.mo
%exclude %_sysconfdir/dnf/plugins/local.conf
%exclude %_sysconfdir/dnf/plugins/post-transaction-actions.conf

%files -n python3-%{name}
%{python3_sitelib}/dnf-plugins/*
%{python3_sitelib}/dnfpluginscore/
%_sysconfdir/dnf/plugins/copr.conf
%_sysconfdir/dnf/plugins/debuginfo-install.conf
%_sysconfdir/dnf/plugins/versionlock.list
%_sysconfdir/dnf/plugins/versionlock.conf
