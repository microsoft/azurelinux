...
#      patch -p1 < 0002-build-update-several-go-dependencies-11581.patch
#      patch -p1 < 0003-build-Add-explicit-requirement-on-rules_cc.patch
#      patch -p1 < 0004-build-Use-new-bazel.patch
#      patch -p1 < 0005-fix-gcc11-compiler-issue.patch
...
CC=gcc CXX=g++ bazel --batch build \
    ...
    --cxxopt="-Wno-array-parameter" \
    --copt="-Wno-range-loop-construct" \
    --cxxopt="-Wno-range-loop-construct" \
    --curses=no \
...
- Add 0005-fix-gcc11-compiler-issue.patch to use the latest version of 
  com_google_absl to resolve gcc compile issue
- Add bazel build option to stop treating range-loop-construct and
  array-parameter warning as error
