%global bdftopcf 1.1
%global fonttosfnt 1.2.3
%global mkfontscale 1.2.2
...
%changelog
* Fri Feb 16 2024 Nan Liu <liunan@microsoft.com> - 7.5-51
- Upgrade to mkfontscale 1.2.2, font-util 1.4.1, fonttosfnt 1.2.3
- Update source urls
- Remove mkfontdir which is now in mkfontscale
