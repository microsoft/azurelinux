...
Source0:        https://github.com/libgd/libgd/releases/download/%{name}-%{version}/%{prjname}-%{version}.tar.xz
...
-   Added patch file(s) CVE-2021-38115.patch
