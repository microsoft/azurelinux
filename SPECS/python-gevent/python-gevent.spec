...
Patch1000:      CVE-2023-22217.patch
...
%autosetup -p 1 -n gevent-%{version} -N
# -M Apply patches up to 999
%autopatch -M 999
# Rebuild generated sources with system Cython
rm $(grep -rl '/\* Generated by Cython')

# Need to patch CVE-2023-22217 in the bundled c-ares
(cd deps/c-ares && patch -p1 ) < %{PATCH1000}
...
%changelog
* Wed Oct 18 2023 Francisco Huelsz Prince <frhuelsz@microsoft.com> - 1.3.6-9
