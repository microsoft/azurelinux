...
Source0:         %{_distro_sources_url}/iser-%{target_mlnx_ofa_kernel_version}.tgz
...
%prep
%setup -n iser-%{target_mlnx_ofa_kernel_version}
set -- *
mkdir source
mv "$@" source/
mkdir obj
...
%changelog
* Tue Feb 10 2026 Mykhailo Bykhovtsev <mbykhovtsev@microsoft.com> - 25.07-5_6.12.57.1.1
