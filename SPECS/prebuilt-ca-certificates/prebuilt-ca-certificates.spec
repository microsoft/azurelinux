...
%changelog
* Mon Jun 29 2026 CBL-Mariner Servicing Account <cblmargh@microsoft.com> - 1:2.0.0-26
...
* Wed Sep 24 2025 CBL-Mariner Servicing Account <cblmargh@microsoft.com> - 1:2.0.0-23
- Making 'Release' match with 'ca-certificates'

* Fri Sep 05 2025 CBL-Mariner Servicing Account <cblmargh@microsoft.com> - 1:2.0.0-22
- Making 'Release' match with 'ca-certificates'

* Tue Sep 02 2025 Pawel Winogrodzki <pawelwi@microsoft.com> - 1:2.0.0-21
- Making 'Release' match with 'ca-certificates'

* Thu Aug 28 2025 CBL-Mariner Servicing Account <cblmargh@microsoft.com> - 1:2.0.0-20
- Making 'Release' match with 'ca-certificates'
