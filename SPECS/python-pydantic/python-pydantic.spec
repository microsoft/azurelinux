...
* Mon Apr 06 2026 azldev <> - 2.12.5-2
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.12.0~a1-12
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.12.0~a1-11
- Rebuilt for Python 3.14.0rc2 bytecode

* Sun Jul 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.12.0~a1-10
- Update to 2.12.0~a1

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org>
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Jul 23 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Sun Jul 06 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to a newer snapshot with more Python 3.14 fixes

* Sat Jun 21 2025 Benjamin A. Beasley <code@musicinmybrain.net>
