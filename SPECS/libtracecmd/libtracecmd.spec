...
%changelog
* Thu Aug 29 2024 Henry Beberman <henry.beberman@microsoft.com> - 1.5.1-2
- Backport from Azure Linux 3.0
- Remove freeglut-devel dependency because we dont ship the gui tool
