...
Source0:        https://cache.ruby-lang.org/pub/ruby/%{ruby_version_majmin}/%{name}-%{ruby_version}.tar.xz
Source1:        macros.ruby
...
%changelog
* Fri Sep 13 2024 Harshit Gupta <guptaharshit@microsoft.com> - 3.3.5-1
