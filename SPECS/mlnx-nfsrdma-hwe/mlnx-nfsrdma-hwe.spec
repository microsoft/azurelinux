...
Source0:         %{_distro_sources_url}/mlnx-nfsrdma-%{target_mlnx_ofa_kernel_version}.tgz
...
%prep
%setup -n mlnx-nfsrdma-%{target_mlnx_ofa_kernel_version}
set -- *
mkdir source
mv "$@" source/
mkdir obj
...
%changelog
* Mon May 11 2026 Azure Linux Team <azurelinux@lists.microsoft.com> - 26.01-1_6.18.31.1.1
