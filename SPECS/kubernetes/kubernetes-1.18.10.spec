...
#Source0:       https://kubernetesartifacts.azureedge.net/kubernetes/v1.18.10-hotfix.20210310/binaries/kubernetes-node-linux-amd64.tar.gz
...
%changelog
* Mon Apr 26 2021 Thomas Crain <thcrain@microsoft.com> - 1.18.10-7
- Replace incorrect %%{_lib} usage with %%{_libdir}

* Thu Mar 18 2021 CBL-Mariner Service Account <cblmargh@microsoft.com> - 1.18.10-6
- Update to version  "1.18.10-hotfix.20210310".
...
- Original version for CBL-Mariner of K8s 1.18.10.
