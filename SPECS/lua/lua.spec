...
cat > %{buildroot}%{_libdir}/pkgconfig/lua.pc <<- "EOF"
    ...
    Cflags: -I${includedir}
EOF
rmdir %{buildroot}%{_libdir}/lua/5.4
...
%changelog
* Wed Jan 19 2022 Henry Li <lihl@microsoft.com> - 5.4.3-1
- Upgrade to version 5.4.3
- Remove patches that no longer apply
- Update lua-5.3.4-shared_library-1.patch and rename to lua-5.4.3-shared_library-1.patch
