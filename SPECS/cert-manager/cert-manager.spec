...
#   2. edit SPECS/cert-manager/nested-vendoring.sh DESIRED_VERSION field to the version you update to
#   2. sudo ./nested-vendoring.sh
#   3. should produce %{name}-%{version}-govendor.tar.gz
