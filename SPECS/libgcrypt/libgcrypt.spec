...
%changelog
* Mon Aug 24 2026 Aditya Singh <v-aditysing@microsoft.com> - 1.11.3-1
- Upgrade to version 1.11.3
- Pin libgpg-error to version 1.49 as it's the minimum version needed by libgcrypt
