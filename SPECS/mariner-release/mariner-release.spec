...
DISTRIB_DESCRIPTION="CBL-Mariner %{mariner_release_version} Preview-H"
EOF
...
Welcome to CBL-Mariner %{mariner_release_version} Preview-H (%{_arch}) - Kernel \r (\l)
EOF

cat > %{buildroot}%{_sysconfdir}/issue.net <<- EOF
Welcome to CBL-Mariner %{mariner_release_version} Preview-H (%{_arch}) - Kernel %r (%t)
EOF
