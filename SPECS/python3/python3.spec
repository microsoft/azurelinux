...
# pip install is being run to esnure that the pip subpackage is built correctly.
%check
...
%changelog
* Fri Jun 27 2025 Aninda Pradhsn <v-anipradhan@microsoft.com> - 3.9.19-14
- Add patches for CVE-2025-50181 and CVE-2025-6069
