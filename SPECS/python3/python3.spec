...
Patch2:        CVE-2025-1795.patch

Patch1000:      CVE-2024-3651.patch
Patch1001:      CVE-2023-43804.patch
Patch1002:      CVE-2024-37891.patch
# Patch for pip
Patch1003:      CVE-2025-50181.patch
Patch1004:      CVE-2023-5752.patch
Patch1005:      CVE-2023-45803.patch
...
patch -p1 %{buildroot}%{_libdir}/python%{majmin}/site-packages/pip/_vendor/idna/core.py < %{PATCH1000}
echo 'Patching CVE-2023-43804 in bundled wheel file %{_libdir}/python%{majmin}/site-packages/pip/_vendor/urllib3/util/retry.py'
patch -p1 %{buildroot}%{_libdir}/python%{majmin}/site-packages/pip/_vendor/urllib3/util/retry.py < %{PATCH1001}
echo 'Patching CVE-2024-37891 in bundled wheel file %{_libdir}/python%{majmin}/site-packages/pip/_vendor/urllib3/util/retry.py'
patch -p1 %{buildroot}%{_libdir}/python%{majmin}/site-packages/pip/_vendor/urllib3/util/retry.py < %{PATCH1002}
...
patch -p1 %{buildroot}%{_libdir}/python%{majmin}/site-packages/pip/_vendor/urllib3/poolmanager.py < %{PATCH1003}
echo 'Patching CVE-2023-5752 in bundled wheel file %{_libdir}/python%{majmin}/site-packages/pip/_internal/vcs/mercurial.py'
patch -p1 %{buildroot}%{_libdir}/python%{majmin}/site-packages/pip/_internal/vcs/mercurial.py < %{PATCH1004}
echo 'Patching CVE-2023-45803 in bundled wheel file %{_libdir}/python%{majmin}/site-packages/pip/_vendor/urllib3'
patch -p1 -d %{buildroot}%{_libdir}/python%{majmin}/site-packages/ < %{PATCH1005}
...
%changelog
* Tue Nov 11 2025 Akhila Guruju <v-guakhila@microsoft.com> - 3.9.25-1
- Upgrade to 3.9.25
