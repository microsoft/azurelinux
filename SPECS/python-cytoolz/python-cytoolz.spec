...
BuildRequires:  gcc
# Patch for test fixes in python 3.13 (and one for 3.12)
# patch can be removed when upgrading past v1.0.0 when included
# https://github.com/pytoolz/cytoolz/commit/946c1985dabc832689715f29ee90506905d1f81b
...
%changelog
* Mon Feb 02 2025 Sam Meluch <sammeluch@microsoft.com> - 0.12.2-3
- Add patch to fix a test failure in test_inspect_wrapped_property
