...
go build -mod=vendor \
    -ldflags '-w -s -X github.com/docker/buildx/version.Version=%{version} -X github.com/docker/buildx/version.Revision=%{BUILDX_GITCOMMIT} -X github.com/docker/buildx/version.Package=github.com/docker/buildx ' \
    -o buildx \
    ./cmd/buildx
