...
* Mon Apr 06 2026 azldev <> - 343-12
- Latest state for redhat-rpm-config

* Tue Aug 05 2025 Jerry James <loganjerry@gmail.com> - 343-11
- Remove macros.gap-srpm
- Depend on the gap-srpm-macros package

* Mon Jul 28 2025 Michal Schorm <mschorm@redhat.com> - 343-10
- [Fedora 43 Change] Add new set of '_pkg_extra_***flags' build macros

* Mon Jul 28 2025 Nikita Popov <npopov@redhat.com> - 343-9
- Enable -fstack-clash-protection on aarch64 with clang

* Mon Jul 28 2025 Nikita Popov <npopov@redhat.com> - 343-8
- Enable -mtls-dialect=gnu2 with clang

* Tue Jul 22 2025 Frank Ch. Eigler <fche@redhat.com> - 343-7
- /usr/lib/rpm/redhat/macros: preserve static library debuginfo by default

* Fri May 16 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 343-6
- Require java-srpm-macros for Java-related SRPM macros

* Sat May 10 2025 Björn Persson <Bjorn@Rombobjörn.se> - 343-5
- Split out GPGverify.

* Tue Apr 22 2025 Timm Bäder <tbaeder@redhat.com> - 343-4
- Add %%_hardening_linker_errors back to GCC ldflags

* Thu Apr 03 2025 Charalampos Stratakis <cstratak@redhat.com> - 343-3
- Add -mbranch-protection=standard to extension builder flags
- mbranch-protection=standard from the standard hardening flags on aarch64,
  enables BTI and PAC. PAC is ABI dependent and we want extensions to be
  compatible.

* Wed Mar 26 2025 Andrea Bolognani <abologna@redhat.com> - 343-2
- Add riscv64 config (thanks David Abdurachmanov)

* Fri Mar 21 2025 Florian Festi <ffesti@redhat.com> - 343-1
- Use upstream versions of find-provides/requires

* Wed Mar 19 2025 Jason Tibbitts <j@tib.bs> - 342-3
- %%_fix_broken_configure_for_lto: preserve line continuations

* Sat Feb 01 2025 Peter Oliver <git@mavit.org.uk> - 342-2
- Require tree-sitter-srpm-macros

* Fri Jan 17 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 342-1
- Change numbering scheme to 3xx, use %%autorelease
