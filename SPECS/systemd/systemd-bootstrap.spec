...
Summary:        Systemd %{?with_bootstrap: bootstrap version to work around circular dependnecy}
Name:           %{base_name}%{?with_bootstrap:-bootstrap}
Version:        254.5
Release:        2%{?dist}
...
Source0:        https://github.com/%{base_name}/%{base_name}-stable/archive/refs/tags/v%{version}.tar.gz#/%{base_name}-%{version}.tar.gz
...
BuildArch:      noarch
%if %{without bootstrap}
Obsoletes:      systemd-bootstrap-rpm-macros
%endif
...
meson  --prefix %{_prefix}                                            \
       ...
       -Dlibcurl=false                                                \
       -Dpolkit=true                                                  \
       %{?without_bootstrap:-Dlibcryptsetup=true}                     \
       %{?without_bootstrap:-Dgcrypt=true}                            \
       -Dlz4=true                                                     \
       -Dzstd=true                                                    \
...
%changelog
* Wed Jan 17 2024 Daniel McIlvaney <damcilva@microsoft.com> - 254.5-2
- Make bootstrap mode configurable via the 'bootstrap' bcond
