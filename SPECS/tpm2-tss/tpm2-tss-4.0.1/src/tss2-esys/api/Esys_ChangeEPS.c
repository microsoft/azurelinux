    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_ChangeEPS_Finish(esysContext);
 ...
 *
 * This function invokes the TPM2_ChangeEPS command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_ChangeEPS_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  authHandle TPM2_RH_PLATFORM+{PP}.
 * @param[in]  shandle1 Session handle for authorization of authHandle
 ...
 *
 * This function returns the results of a TPM2_ChangeEPS command
 * invoked via Esys_ChangeEPS_Finish. All non-simple output parameters
