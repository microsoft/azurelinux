 ...
 * @param[in]  auth TPM2_RH_PLATFORM+TPM2_PP.
 * @param[in]  shandle1 Session handle for authorization of auth
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  setList List of commands to be added to those that will require
 *             that Physical Presence be asserted.
 * @param[in]  clearList List of commands that will no longer require that
    ...
    const TPML_CC *clearList)
{
     ...
     */
    do {
        r = Esys_PP_Commands_Finish(esysContext);
 ...
 *
 * This function invokes the TPM2_PP_Commands command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_PP_Commands_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  auth TPM2_RH_PLATFORM+TPM2_PP.
 * @param[in]  shandle1 Session handle for authorization of auth
 ...
 *
 * This function returns the results of a TPM2_PP_Commands command
 * invoked via Esys_PP_Commands_Finish. All non-simple output parameters
