 ...
 * @param[in]  authHandle TPM2_RH_LOCKOUT, TPM2_RH_ENDORSEMENT, TPM2_RH_OWNER or
 *             TPM2_RH_PLATFORM+{PP}.
 * @param[in]  shandle1 Session handle for authorization of authHandle
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  newAuth New authorization value.
    ...
    const TPM2B_AUTH *newAuth)
{
     ...
     */
    do {
        r = Esys_HierarchyChangeAuth_Finish(esysContext);
...
/** Asynchronous function for TPM2_HierarchyChangeAuth
 *
 * This function invokes the TPM2_HierarchyChangeAuth command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_HierarchyChangeAuth_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  authHandle TPM2_RH_LOCKOUT, TPM2_RH_ENDORSEMENT, TPM2_RH_OWNER or
 *             TPM2_RH_PLATFORM+{PP}.
...
/** Asynchronous finish function for TPM2_HierarchyChangeAuth
 *
 * This function returns the results of a TPM2_HierarchyChangeAuth command
 * invoked via Esys_HierarchyChangeAuth_Finish. All non-simple output parameters
