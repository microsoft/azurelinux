 ...
 * @param[in]  keyHandle Handle of a loaded ECC key public area..
 * @param[in]  shandle1 First session handle.
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[out] zPoint Results of P := h[de]Qs.
 *             (callee-allocated)
 * @param[out] pubPoint Generated ephemeral public point (Qe).
 *             (callee-allocated)
...
/** Asynchronous function for TPM2_ECDH_KeyGen
 *
