 ...
 * @param[in]  authHandle TPM2_RH_PLATFORM.
    ...
    UINT32 algorithmSet)
{
     ...
     */
    do {
        r = Esys_SetAlgorithmSet_Finish(esysContext);
...
/** Asynchronous function for TPM2_SetAlgorithmSet
 *
 * This function invokes the TPM2_SetAlgorithmSet command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_SetAlgorithmSet_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  authHandle TPM2_RH_PLATFORM.
 * @param[in]  shandle1 Session handle for authorization of authHandle
...
/** Asynchronous finish function for TPM2_SetAlgorithmSet
 *
 * This function returns the results of a TPM2_SetAlgorithmSet command
 * invoked via Esys_SetAlgorithmSet_Finish. All non-simple output parameters
