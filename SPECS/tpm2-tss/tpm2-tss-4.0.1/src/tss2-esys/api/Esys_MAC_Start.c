 ...
 * @param[in]  handle Handle of an MAC key.
 ...
 * @param[in]  inScheme The hash algorithm scheme to use for the MAC.
    ...
    ESYS_TR *sequenceHandle)
{
    ...
    r = Esys_MAC_Start_Async(esysContext, handle, handleSession1, optionalSession2, optionalSession3,
                              auth, inScheme);
     ...
     */
    do {
        r = Esys_MAC_Start_Finish(esysContext, sequenceHandle);
...
/** Asynchronous function for TPM2_MAC_Start
 *
 * This function invokes the TPM2_MAC_Start command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_MAC_Start_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  handle Handle of an MAC key.
 * @param[in]  shandle1 Session handle for authorization of handle
    ...
    TPMI_ALG_MAC_SCHEME inScheme)
{
    ...
    LOG_TRACE("context=%p, handle=%"PRIx32 ", auth=%p,"
              "inScheme=%04"PRIx16"",
              esysContext, handle, auth, inScheme);
...
/** Asynchronous finish function for TPM2_MAC_Start
 *
 * This function returns the results of a TPM2_MAC_Start command
 * invoked via Esys_MAC_Start_Finish. All non-simple output parameters
