 ...
 * @param[in]  nvIndex The NV Index to remove from NV space.
    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_NV_UndefineSpace_Finish(esysContext);
...
/** Asynchronous function for TPM2_NV_UndefineSpace
 *
 * This function invokes the TPM2_NV_UndefineSpace command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_NV_UndefineSpace_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  authHandle TPM2_RH_OWNER or TPM2_RH_PLATFORM+{PP}.
 * @param[in]  nvIndex The NV Index to remove from NV space.
...
/** Asynchronous finish function for TPM2_NV_UndefineSpace
 *
 * This function returns the results of a TPM2_NV_UndefineSpace command
 * invoked via Esys_NV_UndefineSpace_Finish. All non-simple output parameters
