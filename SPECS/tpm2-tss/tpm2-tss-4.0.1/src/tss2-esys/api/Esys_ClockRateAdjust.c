 ...
 * @param[in]  rateAdjust Adjustment to current Clock update rate.
    ...
    TPM2_CLOCK_ADJUST rateAdjust)
{
     ...
     */
    do {
        r = Esys_ClockRateAdjust_Finish(esysContext);
 ...
 *
 * This function invokes the TPM2_ClockRateAdjust command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_ClockRateAdjust_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  auth TPM2_RH_OWNER or TPM2_RH_PLATFORM+{PP}.
 * @param[in]  shandle1 Session handle for authorization of auth
 ...
 *
 * This function returns the results of a TPM2_ClockRateAdjust command
 * invoked via Esys_ClockRateAdjust_Finish. All non-simple output parameters
