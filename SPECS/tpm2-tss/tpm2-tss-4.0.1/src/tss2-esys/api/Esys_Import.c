 ...
 * @param[in]  parentHandle The handle of the new parent for the object.
 * @param[in]  shandle1 Session handle for authorization of parentHandle
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  encryptionKey The optional symmetric encryption key used as the
 *             inner wrapper for duplicate.
 * @param[in]  objectPublic The public area of the object to be imported.
 ...
 *
 * This function invokes the TPM2_Import command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_Import_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  parentHandle The handle of the new parent for the object.
 * @param[in]  shandle1 Session handle for authorization of parentHandle
 ...
 *
 * This function returns the results of a TPM2_Import command
 * invoked via Esys_Import_Finish. All non-simple output parameters
