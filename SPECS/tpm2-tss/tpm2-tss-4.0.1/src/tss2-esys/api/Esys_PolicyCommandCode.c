    ...
    TPM2_CC code)
{
     ...
     */
    do {
        r = Esys_PolicyCommandCode_Finish(esysContext);
...
/** Asynchronous function for TPM2_PolicyCommandCode
 *
 * This function invokes the TPM2_PolicyCommandCode command in a asynchronous
...
/** Asynchronous finish function for TPM2_PolicyCommandCode
 *
 * This function returns the results of a TPM2_PolicyCommandCode command
 * invoked via Esys_PolicyCommandCode_Finish. All non-simple output parameters
