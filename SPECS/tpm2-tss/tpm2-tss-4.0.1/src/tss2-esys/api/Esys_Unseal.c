 ...
 * @param[in]  itemHandle Handle of a loaded data object.
 * @param[in]  shandle1 Session handle for authorization of itemHandle
...
/** Asynchronous function for TPM2_Unseal
 *
