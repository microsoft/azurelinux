 ...
 * @param[in]  actHandle Handle of the selected ACT.
 * @param[in]  shandle1 Session handle for authorization of actHandle
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  startTimeout Timeout value.
    ...
    UINT32 startTimeout)
{
     ...
     */
    do {
        r = Esys_ACT_SetTimeout_Finish(esysContext);
...
/** Asynchronous function for TPM2_ACT_SetTimeout
 *
 * This function invokes the TPM2_ACT_SetTimeout command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_ACT_SetTimeout_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  actHandle Handle of the selected ACT.
 * @param[in]  shandle1 Session handle for authorization of actHandle
...
/** Asynchronous finish function for TPM2_ACT_SetTimeout
 *
 * This function returns the results of a TPM2_ACT_SetTimeout command
 * invoked via Esys_ACT_SetTimeout_Finish. All non-simple output parameters
