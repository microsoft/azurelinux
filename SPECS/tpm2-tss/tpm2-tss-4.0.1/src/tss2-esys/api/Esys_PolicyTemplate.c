 ...
 * @param[in]  templateHash The digest to be added to the policy.
    ...
    const TPM2B_DIGEST *templateHash)
{
     ...
     */
    do {
        r = Esys_PolicyTemplate_Finish(esysContext);
...
/** Asynchronous function for TPM2_PolicyTemplate
 *
 * This function invokes the TPM2_PolicyTemplate command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_PolicyTemplate_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  policySession Handle for the policy session being extended.
 * @param[in]  shandle1 First session handle.
...
/** Asynchronous finish function for TPM2_PolicyTemplate
 *
 * This function returns the results of a TPM2_PolicyTemplate command
 * invoked via Esys_PolicyTemplate_Finish. All non-simple output parameters
