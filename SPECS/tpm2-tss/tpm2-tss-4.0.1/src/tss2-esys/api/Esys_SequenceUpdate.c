    ...
    const TPM2B_MAX_BUFFER *buffer)
{
     ...
     */
    do {
        r = Esys_SequenceUpdate_Finish(esysContext);
...
/** Asynchronous function for TPM2_SequenceUpdate
 *
 * This function invokes the TPM2_SequenceUpdate command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_SequenceUpdate_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  sequenceHandle Handle for the sequence object.
 * @param[in]  shandle1 Session handle for authorization of sequenceHandle
...
/** Asynchronous finish function for TPM2_SequenceUpdate
 *
 * This function returns the results of a TPM2_SequenceUpdate command
 * invoked via Esys_SequenceUpdate_Finish. All non-simple output parameters
