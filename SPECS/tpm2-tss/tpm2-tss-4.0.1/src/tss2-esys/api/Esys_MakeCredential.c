 ...
 * @param[in]  handle Loaded public area, used to encrypt the sensitive area
 *             containing the credential key.
 * @param[in]  shandle1 First session handle.
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  credential The credential information.
 * @param[in]  objectName Name of the object to which the credential applies.
 * @param[out] credentialBlob The credential.
 *             (callee-allocated)
 * @param[out] secret Handle algorithm-dependent data that wraps the key that
