 ...
 * @param[in]  bits The data to OR with the current contents.
    ...
    UINT64 bits)
{
     ...
     */
    do {
        r = Esys_NV_SetBits_Finish(esysContext);
...
/** Asynchronous function for TPM2_NV_SetBits
 *
 * This function invokes the TPM2_NV_SetBits command in a asynchronous
...
/** Asynchronous finish function for TPM2_NV_SetBits
 *
 * This function returns the results of a TPM2_NV_SetBits command
 * invoked via Esys_NV_SetBits_Finish. All non-simple output parameters
