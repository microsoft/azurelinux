 ...
 * @param[in]  buffer HMAC data.
 * @param[in]  hashAlg Algorithm to use for HMAC.
 * @param[out] outHMAC The returned HMAC in a sized buffer.
 *             (callee-allocated)
...
/** Asynchronous function for TPM2_HMAC
 *
