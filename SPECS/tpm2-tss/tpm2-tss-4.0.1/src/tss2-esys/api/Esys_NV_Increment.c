    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_NV_Increment_Finish(esysContext);
 ...
 *
 * This function invokes the TPM2_NV_Increment command in a asynchronous
 ...
 *
 * This function returns the results of a TPM2_NV_Increment command
 * invoked via Esys_NV_Increment_Finish. All non-simple output parameters
