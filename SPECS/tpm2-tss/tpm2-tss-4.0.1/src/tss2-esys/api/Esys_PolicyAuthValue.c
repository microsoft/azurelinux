    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_PolicyAuthValue_Finish(esysContext);
...
/** Asynchronous function for TPM2_PolicyAuthValue
 *
 * This function invokes the TPM2_PolicyAuthValue command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_PolicyAuthValue_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  policySession Handle for the policy session being extended.
 * @param[in]  shandle1 First session handle.
...
/** Asynchronous finish function for TPM2_PolicyAuthValue
 *
 * This function returns the results of a TPM2_PolicyAuthValue command
 * invoked via Esys_PolicyAuthValue_Finish. All non-simple output parameters
