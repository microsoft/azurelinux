 ...
 * @param[in]  shutdownType TPM2_SU_CLEAR or TPM2_SU_STATE.
    ...
    TPM2_SU shutdownType)
{
     ...
     */
    do {
        r = Esys_Shutdown_Finish(esysContext);
...
/** Asynchronous function for TPM2_Shutdown
 *
 * This function invokes the TPM2_Shutdown command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_Shutdown_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  shandle1 First session handle.
 * @param[in]  shandle2 Second session handle.
...
/** Asynchronous finish function for TPM2_Shutdown
 *
 * This function returns the results of a TPM2_Shutdown command
 * invoked via Esys_Shutdown_Finish. All non-simple output parameters
