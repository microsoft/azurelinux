    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_PolicyPassword_Finish(esysContext);
...
/** Asynchronous function for TPM2_PolicyPassword
 *
 * This function invokes the TPM2_PolicyPassword command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_PolicyPassword_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  policySession Handle for the policy session being extended.
 * @param[in]  shandle1 First session handle.
...
/** Asynchronous finish function for TPM2_PolicyPassword
 *
 * This function returns the results of a TPM2_PolicyPassword command
 * invoked via Esys_PolicyPassword_Finish. All non-simple output parameters
