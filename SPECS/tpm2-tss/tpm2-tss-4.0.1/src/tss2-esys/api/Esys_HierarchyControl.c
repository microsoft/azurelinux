...
/** Asynchronous function for TPM2_HierarchyControl
 *
 * This function invokes the TPM2_HierarchyControl command in a asynchronous
 ...
 *
 * This function returns the results of a TPM2_HierarchyControl command
 * invoked via Esys_HierarchyControl_Finish. All non-simple output parameters
