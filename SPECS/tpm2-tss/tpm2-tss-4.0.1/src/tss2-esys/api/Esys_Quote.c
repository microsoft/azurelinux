 ...
 * @param[in]  signHandle Handle of key that will perform signature.
 * @param[in]  shandle1 Session handle for authorization of signHandle
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  qualifyingData Data supplied by the caller.
 * @param[in]  inScheme TPM2_Signing scheme to use if the scheme for signHandle is
 *             TPM2_ALG_NULL.
 * @param[in]  PCRselect PCR set to quote.
 * @param[out] quoted The quoted information.
 *             (callee-allocated)
 * @param[out] signature The signature over quoted .
 *             (callee-allocated)
