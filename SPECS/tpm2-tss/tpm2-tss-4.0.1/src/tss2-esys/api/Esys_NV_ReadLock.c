 ...
 *             value.
 * @param[in]  nvIndex The NV Index to be locked.
    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_NV_ReadLock_Finish(esysContext);
...
/** Asynchronous function for TPM2_NV_ReadLock
 *
 * This function invokes the TPM2_NV_ReadLock command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_NV_ReadLock_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  authHandle The handle indicating the source of the authorization
 *             value.
...
/** Asynchronous finish function for TPM2_NV_ReadLock
 *
 * This function returns the results of a TPM2_NV_ReadLock command
 * invoked via Esys_NV_ReadLock_Finish. All non-simple output parameters
