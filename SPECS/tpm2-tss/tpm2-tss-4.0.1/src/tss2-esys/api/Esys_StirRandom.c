 ...
 * @param[in]  inData Additional information.
    ...
    const TPM2B_SENSITIVE_DATA *inData)
{
     ...
     */
    do {
        r = Esys_StirRandom_Finish(esysContext);
...
/** Asynchronous function for TPM2_StirRandom
 *
 * This function invokes the TPM2_StirRandom command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_StirRandom_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  shandle1 First session handle.
 * @param[in]  shandle2 Second session handle.
...
/** Asynchronous finish function for TPM2_StirRandom
 *
 * This function returns the results of a TPM2_StirRandom command
 * invoked via Esys_StirRandom_Finish. All non-simple output parameters
