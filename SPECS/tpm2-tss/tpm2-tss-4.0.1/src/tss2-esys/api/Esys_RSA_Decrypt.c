 ...
 * @param[in]  keyHandle RSA key to use for decryption.
 ...
 * @param[in]  label Label whose association with the message is to be verified.
 * @param[out] message Decrypted output.
 *             (callee-allocated)
