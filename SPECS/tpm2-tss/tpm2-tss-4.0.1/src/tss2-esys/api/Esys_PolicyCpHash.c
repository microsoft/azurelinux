 ...
 * @param[in]  cpHashA The cpHash added to the policy.
    ...
    const TPM2B_DIGEST *cpHashA)
{
     ...
     */
    do {
        r = Esys_PolicyCpHash_Finish(esysContext);
...
/** Asynchronous function for TPM2_PolicyCpHash
 *
 * This function invokes the TPM2_PolicyCpHash command in a asynchronous
...
/** Asynchronous finish function for TPM2_PolicyCpHash
 *
 * This function returns the results of a TPM2_PolicyCpHash command
 * invoked via Esys_PolicyCpHash_Finish. All non-simple output parameters
