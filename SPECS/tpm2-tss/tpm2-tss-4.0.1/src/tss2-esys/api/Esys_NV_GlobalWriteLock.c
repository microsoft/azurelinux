    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_NV_GlobalWriteLock_Finish(esysContext);
...
/** Asynchronous function for TPM2_NV_GlobalWriteLock
 *
 * This function invokes the TPM2_NV_GlobalWriteLock command in a asynchronous
 * variant. This means the function will return as soon as the command has been
 * sent downwards the stack to the TPM. All input parameters are const.
 * In order to retrieve the TPM's response call Esys_NV_GlobalWriteLock_Finish.
 *
 * @param[in,out] esysContext The ESYS_CONTEXT.
 * @param[in]  authHandle TPM2_RH_OWNER or TPM2_RH_PLATFORM+{PP}.
 * @param[in]  shandle1 Session handle for authorization of authHandle
...
/** Asynchronous finish function for TPM2_NV_GlobalWriteLock
 *
 * This function returns the results of a TPM2_NV_GlobalWriteLock command
 * invoked via Esys_NV_GlobalWriteLock_Finish. All non-simple output parameters
