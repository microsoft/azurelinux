    ...
    ESYS_TR shandle3)
{
     ...
     */
    do {
        r = Esys_NV_WriteLock_Finish(esysContext);
...
/** Asynchronous function for TPM2_NV_WriteLock
 *
 * This function invokes the TPM2_NV_WriteLock command in a asynchronous
...
/** Asynchronous finish function for TPM2_NV_WriteLock
 *
 * This function returns the results of a TPM2_NV_WriteLock command
 * invoked via Esys_NV_WriteLock_Finish. All non-simple output parameters
