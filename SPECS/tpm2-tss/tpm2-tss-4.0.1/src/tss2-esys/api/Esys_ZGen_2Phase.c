 ...
 * @param[in]  keyA Handle of an unrestricted decryption key ECC.
 * @param[in]  shandle1 Session handle for authorization of keyA
 * @param[in]  shandle2 Second session handle.
 * @param[in]  shandle3 Third session handle.
 * @param[in]  inQsB Other party's static public key (Qs,B = (Xs,B, Ys,B)).
