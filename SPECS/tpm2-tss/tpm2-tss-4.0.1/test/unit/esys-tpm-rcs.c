...
static TSS2_RC
tcti_tpmerror_receive(TSS2_TCTI_CONTEXT * tctiContext,
                     ...
                     uint8_t * response_buffer, int32_t timeout)
{
    ...
    *response_size = sizeof(response);
    if (response_buffer != NULL)
        memcpy(response_buffer, &response[0], sizeof(response));
...
static TSS2_RC
tcti_tpmerror_initialize(TSS2_TCTI_CONTEXT * tctiContext, size_t * contextSize)
{
    TSS2_TCTI_CONTEXT_TPMERROR *tcti_tpmerror =
        (TSS2_TCTI_CONTEXT_TPMERROR *) tctiContext;
...
test_AC_GetCapability(void **state)
{
    ...
    TPMI_YES_NO moreData;
    r = Esys_AC_GetCapability(esys_context,
                           ESYS_TR_NONE,
                           ESYS_TR_NONE,
                           ESYS_TR_NONE,
                           capability,
