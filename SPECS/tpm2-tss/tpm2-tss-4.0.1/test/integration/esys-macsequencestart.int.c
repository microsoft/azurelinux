...
/** Test the ESYS commands: MAC_Start, SequenceUpdate, and SequenceComplete.
 *
 * The MAC key is created by using Esys_CreatePrimary.
 *
...
int
test_esys_macsequencestart(ESYS_CONTEXT * esys_context)
{
    TSS2_RC r;
    ...
    /* Check MAC_Start with auth equal NULL */
...
test_invoke_esys(ESYS_CONTEXT * esys_context) {
    return test_esys_macsequencestart(esys_context);
}
