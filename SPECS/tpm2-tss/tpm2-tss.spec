...
# json-c was (and continues) to be a requirement for CBL-Mariner.
BuildRequires:  json-c-devel

Requires: openssl
Requires: systemd-bootstrap-rpm-macros
...
%changelog
* Thu Feb 01 2024 Brian Fjeldstad <bfjelds@microsoft.com> - 4.0.1-3
- Use systemd-bootstrap-rpm-macros with 4.0.1-1 spec.
