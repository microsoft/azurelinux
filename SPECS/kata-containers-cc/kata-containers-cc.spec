...
Version:      0.6.2
Release:      3%{?dist}
Summary:      Kata Confidential Containers package for Confidential Containers on AKS
License:      ASL 2.0
...
The package sources are based on a Microsoft fork of the kata-containers project.
