...
# Go vendor tree for src/runtime, generated by generate_source_tarball.sh
...
%prep
%autosetup -N -a1 -n %{sourceName}-%{version}
# Replace the runtime's vendor tree from Source0 with the regenerated one.
rm -rf src/runtime/vendor
...
%changelog
* Thu Sep 21 2026 Kavya Sree Kaitepalli <kkaitepalli@microsoft.com> - 3.15.0.aks0-22
