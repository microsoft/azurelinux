...
NAME_VER="kata-containers-$PKG_VERSION.aks0"
VENDOR_TARBALL="$OUT_FOLDER/$NAME_VER-vendor.tar.gz"

echo "Unpacking source tarball..."
tar -xf $SRC_TARBALL

# The Go module root is src/runtime, not the tarball root.
GO_MOD_DIR="src/runtime"

pushd "$NAME_VER/$GO_MOD_DIR" > /dev/null
...
popd > /dev/null
echo "kata-containers vendored modules are available at $VENDOR_TARBALL"