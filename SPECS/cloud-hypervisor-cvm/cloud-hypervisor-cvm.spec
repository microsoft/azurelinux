...
# * You have both x86_64-unknown-linux-gnu and x86_64-unknown-linux-musl, or
# * You have both aarch64-unknown-linux-gnu and aarch64-unknown-linux-musl
#   targets installed.
...
%global gitver   38.0
%global gitnum   72
%global gitrev   8f7209bdc
%global clh_name cloud-hypervisor
%global clh_type cvm

Name:           %{clh_name}-%{clh_type}
...
Release:        1000.%{gitrev}%{?dist}
License:        ASL 2.0 or BSD-3-clause
Group:          Applications/System
URL:            https://github.com/cloud-hypervisor/cloud-hypervisor
Source0:        https://github.com/microsoft/cloud-hypervisor/archive/refs/tags/msft/v%{version}.tar.gz#/%{clh_name}-%{version}.tar.gz
%if 0%{?using_vendored_crates}
Source1:        %{clh_name}-%{version}-vendor.tar.gz
Source2:        config.toml
%endif
...
%autosetup -p1 -n %{clh_name}-%{version}
pushd %{_builddir}/%{clh_name}-%{version}
%if 0%{?using_vendored_crates}
tar xf %{SOURCE1}
mkdir -p .cargo
