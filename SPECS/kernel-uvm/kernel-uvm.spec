...
%ifarch x86_64
# install -D -m 644 arch/x86/boot/compressed/vmlinux.bin %{buildroot}%{_datadir}/cloud-hypervisor/vmlinux.bin
install -D -m 644 %{image} $D/%{image_fname}
install -D -m 644 arch/%{arch}/boot/bzImage $D/bzImage
%endif

%ifarch aarch64
# install -D -m 644 arch/arm64/boot/Image /usr/share/cloud-hypervisor/bzImage
