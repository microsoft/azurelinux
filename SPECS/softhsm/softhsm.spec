...
getent passwd ods >/dev/null || \
    useradd -r -g ods -d %{_sharedstatedir}/softhsm -s %{_sbindir}/nologin \
...
if [ -f %{_var}/softhsm/slot0.db ]; then
      runuser -g ods ods -c 'softhsm2-migrate --db %{_var}/softhsm/slot0.db --pin 1234 --slot 0' || :
fi
%changelog
* Mon Aug 30 2021 Bala <balakumaran.kannan@microsoft.com> - 2.6.1-5
- License verified
- Added initial CBL import message in previous changelog entry
