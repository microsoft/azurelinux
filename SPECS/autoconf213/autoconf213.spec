...
Source:         https://ftp.gnu.org/pub/gnu/autoconf/autoconf-%{version}.tar.gz
...
rm %{buildroot}/%{_bindir}/autoscan-%{version}
...
%changelog
* Thu Dec 02 2021 Jamie Magee <jamagee@microsoft.com> - 2.13-48
