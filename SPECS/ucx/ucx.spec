...
Source:         https://github.com/openucx/%{name}/releases/download/v1.17.0/ucx-1.17.0.tar.gz
...
%changelog
* Wed Dec 04 2024 Alberto David Perez Guevara <aperezguevar@microsoft.com> 1.17.0-2
- Azure Linux update to version 1.17.0
