...
Source0:        https://github.com/tensorflow/tensorboard/archive/refs/tags/%{version}.tar.gz#/%{pypi_name}-%{version}.tar.gz
...
Requires:   python3-google-auth-oauthlib = 0.5.3
Requires:   python3-google-auth = 2.6.6
