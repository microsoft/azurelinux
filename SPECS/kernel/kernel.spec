...
Patch1:         be309f8eae8b-afunix-fix-uaf-unix_stream_data_wait.patch
...
- Backport af_unix UAF (Jann Horn/Project Zero). Custom 5.15 backport: keeps last_len param and adds sk_receive_queue.lock around tail->len read (upstream Cc:stable#6.5.x doesn't apply to 5.15).
...
* Fri May 30 2025 CBL-Mariner Servicing Account <cblmargh@microsoft.com> - 5.15.184.1-1
- Auto-upgrade to 5.15.184.1

* Sat May 17 2025 CBL-Mariner Servicing Account <cblmargh@microsoft.com> - 5.15.182.1-1
