...
echo 'Starting rubygem-http_parser source tarball creation'
cd $TEMPDIR
git clone --depth 1 https://github.com/tmm1/http_parser.rb.git
pushd http_parser.rb
git fetch --all --tags
git checkout tags/v$PKG_VERSION -b http_parser-$PKG_VERSION
git submodule update --init
popd
mv http_parser.rb/ext ext

TARBALL_NAME="http_parser-$PKG_VERSION-submodules.tar.gz"
