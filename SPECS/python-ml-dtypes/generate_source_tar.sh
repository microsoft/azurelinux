...
echo 'Starting ml_dtypes source tarball creation'
cd $TEMPDIR
git clone --depth 1 https://github.com/jax-ml/ml_dtypes
pushd ml_dtypes
git fetch --all --tags
git checkout tags/v$PKG_VERSION -b ml_dtypes-$PKG_VERSION
git submodule update --init --recursive
popd
mv ml_dtypes/third_party third_party


TARBALL_NAME="ml_dtypes-$PKG_VERSION-submodules.tar.gz"
