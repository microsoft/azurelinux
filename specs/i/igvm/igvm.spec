...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.4.0-11
- Uncommitted changes

* Mon Jun 08 2026 Luigi Leonardi <leonardi@redhat.com> - 0.4.0-10
- Bump bitfield-struct to 0.13.0

* Thu Mar 05 2026 Luigi Leonardi <leonardi@redhat.com> - 0.4.0-9
- Backport upstream commit to reduce future git conflict

* Tue Mar 03 2026 Luigi Leonardi <leonardi@redhat.com> - 0.4.0-8
- Backport upstream fix for pkg-config
