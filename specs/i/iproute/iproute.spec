...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 6.17.0-3
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.17.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Oct 07 2025 Andrea Claudi <aclaudi@redhat.com> - 6.17.0-1
- iproute-6.17.0-1.f44

* Fri Sep 19 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 6.16.0-2
- Import README.etc

* Wed Sep 03 2025 Andrea Claudi <aclaudi@redhat.com> - 6.16.0-1
- iproute-6.16.0-1.f44
