...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.12.3-7
- feat(render): convert static changelogs to interleaved releases for i*
  components

* Mon May 11 2026 Chris Co <chrco@microsoft.com> - 1.12.3-6
- chore(imlib2): disable HEIF loader

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.12.3-5
