...
%{load:%{_sourcedir}/taglib.azl.macros}
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.3-3
- Uncommitted changes

* Sat May 23 2026 Nicolas Chauvet <kwizart@gmail.com> - 2.3-2
- Fix build condition --without mingw

* Fri May 22 2026 Xavier Bachelot <xavier@bachelot.org> - 2.3-1
- Update to 2.3

* Thu Mar 19 2026 Peter Lemenkov <lemenkov@gmail.com> - 2.2.1-2
- Simplify .gitignore

* Wed Mar 18 2026 Uwe Klotz <uwe.klotz@gmail.com> - 2.2.1-1
- Upgrade to v2.2.1

* Fri Jan 23 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 2.1.1-2
- Use bundled utf8cpp on RHEL

* Fri Jan 23 2026 Uwe Klotz <uwe.klotz@gmail.com> - 2.1.1-1
- Upgrade to v2.1.1

* Fri Jan 23 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 1.13.1-8
- Enable tests, cleanup spec

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.13.1-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.13.1-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 20 2025 Peter Lemenkov <lemenkov@gmail.com> - 1.13.1-5
