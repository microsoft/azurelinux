...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.5.2-4
- feat(render): convert static changelogs to interleaved releases for t*
  components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 5.5.2-3
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.5.2-2
...
* Fri Aug 15 2025 Sandro Mani <manisandro@gmail.com> - 5.5.1-4
- Rebuild (icu)
