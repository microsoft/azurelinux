...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.7c-2
- Uncommitted changes

* Tue Aug 18 2026 Filipe Rosset <rosset.filipe@gmail.com> - 3.7c-1
- Update to 3.7c

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.7b-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jul 09 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.7b-2
- fix 3.7b build

* Thu Jul 09 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.7b-1
- update to 3.7b fixes rhbz#2498485

* Sun Jun 28 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.7-2
- remove systemd tmux.service commands

* Sun Jun 28 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.7-1
- update to 3.7, remove upstreamed patch, handle tmux@service

* Sun Jun 21 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.6b-5
- opt-in to packit for rawhide [skip changelog]

* Sun Jun 21 2026 Filipe Rosset <filiperosset@fedoraproject.org> - 3.6b-4
- simplify .gitignore file [skip changelog]
