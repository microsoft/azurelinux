...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.20.9-2
- Uncommitted changes

* Sat Jul 18 2026 Kevin Fenzi <kevin@scrye.com> - 4.20.9-1
- Update to 4.20.9

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.20.8-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sun Mar 29 2026 Kevin Fenzi <kevin@scrye.com> - 4.20.8-1
- Update to 4.20.8. Fixes rhbz#2452756
