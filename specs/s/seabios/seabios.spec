...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.17.0-12
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.17.0-11
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.17.0-10
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Wed Nov 26 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-9
- Revert "add seabios.igvm"

* Wed Nov 26 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-8
- turn off SMM support

* Wed Nov 05 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-7
- update release date

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.17.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jul 15 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-5
- add seabios.igvm

* Mon Jun 16 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-4
- add epoch to libguestfs version

* Mon Jun 16 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-3
- add conflict with libguestfs versions older than 1.56.1

* Mon Jun 16 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-2
- add docs to *-bin packages too

* Wed Jun 11 2025 Gerd Hoffmann <kraxel@redhat.com> - 1.17.0-1
- Update to 1.17.0 release

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.16.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sat Jul 20 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.16.3-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Sat Jan 27 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.16.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Tue Nov 28 2023 Gerd Hoffmann <kraxel@redhat.com> - 1.16.3-1
- Update 1.16.3 release
