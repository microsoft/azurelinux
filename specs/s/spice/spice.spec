...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.16.0-6
- feat(render): convert static changelogs to interleaved releases for s*
  components

* Fri May 08 2026 Binu Jose Philip <binujp@gmail.com> - 0.16.0-5
- fix(spice): remove dependency on opus to drop it

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.16.0-4
