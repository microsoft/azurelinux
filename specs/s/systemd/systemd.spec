...
* Tue Sep 22 2026 George Mileka <gmileka@users.noreply.github.com> - 258.4-9
- Never build the boot-unsigned sub-package now that the non-OBS sd-boot
  binary is signed too; only the signed boot package/description/files apply

* Tue Sep 22 2026 George Mileka <gmileka@users.noreply.github.com> - 258.4-8
- Gate non-OBS pesign BuildRequires and sd-boot signing on want_bootloader; sign
  via %%pesign with a dedicated systemd-boot-signer cert into a separate output
  file
