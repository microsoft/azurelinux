...
* Thu Apr 03 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-18
- fmf: Check out mkosi to some directory in /var/tmp

* Thu Apr 03 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-16
- fmf: Use mkosi/mkosi.local.conf if the mkosi/ directory exists

* Tue Mar 25 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-14
- Relax dependencies from noarch packages on archful packages for OBS
  builds

* Sun Mar 23 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-13
...
* Sun Mar 23 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.4-11
...
* Fri Mar 21 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-7
- Merge #196 `Migrate fmf metadata and test script from the upstream
  repository`

* Thu Mar 20 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 257.4-6
- Limit sdubby dependency to Fedora

* Fri Mar 07 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-5
- Clean up debuginfo files as well in %%clean

* Fri Mar 07 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.4-4
- Fix missing question mark

* Fri Mar 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.4-3
- Also drop auxiliary files related to sysusers compat

* Fri Mar 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.4-2
- Change python-zstd depenedency to python-zstandard

* Fri Mar 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.4-1
- Version 257.4
- Fixes for systemd itself, systemd-dissect, systemd-sbsign, systemd-
  networkd, systemd-repart, systemd-tmpfiles, systemd-id128, systemd-
  resolved, ukify, internal shared library, fido2 code, virtualization
  detection, shell completions, documentation.
- Adds new DNSSEC anchor key for systemd-resolved.

* Thu Mar 06 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-16
- Neuter sysusers macros

* Wed Mar 05 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-15
- Drop old self-Obsoletes and provides

* Wed Mar 05 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.3-14
- Drop libbpf versioned dependency version to 1.4.7

* Tue Mar 04 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-13
- Make self-obsoletes for the sysusers split conditional

* Tue Mar 04 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.3-12
- Include epoch in versioned libbpf dependency

* Mon Mar 03 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.3-11
- Make sure we pull in libbpf >= 1.5.0 if libbpf is installed

* Tue Feb 25 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.3-10
- Stop using version_no_tilde for github archives

* Tue Feb 25 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.3-9
- List the fallback Source0 first

* Wed Feb 19 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 257.3-8
- Do not use dynamic spec generation for non-upstream builds

* Sun Feb 16 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-7
- Allow co-installation of systemd-sysusers-standalone and systemd

* Fri Feb 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-6
- Split out -sysusers and -shared (rhbz#2344322)

* Fri Feb 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-5
- Use dynamic spec generation for triggers

* Fri Feb 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.3-4
- Move more auxiliary files into subpackages
...
* Sat Feb 01 2025 Björn Esser <besser82@fedoraproject.org> - 257.2-18
- Add explicit BR: libxcrypt-devel

* Mon Jan 27 2025 Adam Williamson <awilliam@redhat.com> - 257.2-16
- Backport PR #36194 to add Georgian mapping to kbd-model-map

* Tue Jan 21 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.2-15
- Drop override of $PATH in the user manager

* Fri Jan 17 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 257.2-14
- Backport patch to emit audit events from systemd-sysusers
