...
Patch6: systemd-filter-linux-7-errno-aliases.patch
Patch7: systemd-add-nullfs-magic.patch
%description
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 258.10-2
- Uncommitted changes
...
* Sat Jun 27 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@amutable.com> - 258.9-1
- Version 258.9
- Various fixes
- Hardware database update

* Sat May 30 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@amutable.com> - 258.8-1
- Version 258.8
- Various correctness and security fixes
- Update of hardware database

* Fri Mar 13 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@amutable.com> - 258.7-1
- Version 258.7
- Even more fixes, incl. a fix for a bad patch in .6

* Thu Mar 12 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@amutable.com> - 258.6-1
- Version 258.6
- A bunch of bugfixes
- More sanitization for invalid values received from hardware and firmware

* Wed Mar 04 2026 Marcin Juszkiewicz <mjuszkiewicz@redhat.com> - 258.5-2
- riscv64 port has LTO disabled

* Fri Feb 27 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@amutable.com> - 258.5-1
- Version 259.5
