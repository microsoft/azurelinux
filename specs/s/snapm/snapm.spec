...
* Wed Nov 19 2025 Bryn M. Reeves <bmr@redhat.com> - 0.5.2-2
- Add fix for snapm#606 (timeline index calculation bug)

* Sun Nov 16 2025 Bryn M. Reeves <bmr@redhat.com> - 0.5.2-1
- Merge branch 'private-bmr-0.5.2-rebase' into private-bmr-0.5.2-rebase-f43

* Tue Nov 04 2025 Bryn M. Reeves <bmr@redhat.com> - 0.5.1-1
- Merge branch 'rawhide' into private-bmr-0.5.1-rebase-f43

* Mon Sep 22 2025 Bryn M. Reeves <bmr@redhat.com> - 0.4.3-10
- Rebuilt for rhbz#2397030

* Mon Aug 18 2025 Bryn M. Reeves <bmr@redhat.com> - 0.4.3-9
...
* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.4.3-6
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.4.3-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 0.4.3-4
- Rebuilt for Python 3.14

* Wed Apr 30 2025 Bryn M. Reeves <bmr@redhat.com> - 0.4.3-3
- Add TMT tests and enable gating

* Thu Apr 24 2025 Bryn M. Reeves <bmr@redhat.com> - 0.4.3-2
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.4.3-1
