...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.9.2-3
- Uncommitted changes

* Fri Jul 17 2026 the Mulhern <amulhern@amulhern.bos.csb> - 3.9.2-2
- Require testing repo version 3.9.1

* Fri Jul 17 2026 the Mulhern <amulhern@amulhern.bos.csb> - 3.9.2-1
- Update to version 3.9.2

* Tue Jun 23 2026 mulhern <amulhern@redhat.com> - 3.9.1-1
- Update to version 3.9.1

* Wed May 20 2026 mulhern <amulhern@redhat.com> - 3.9.0-2
- Do not compile stratis-min or stratisd-min with dbus_enabled

* Mon Apr 27 2026 mulhern <amulhern@redhat.com> - 3.9.0-1
- Update to version 3.9.0

* Mon Apr 27 2026 mulhern <amulhern@redhat.com> - 3.8.6-4
- Revert "Allow procfs 0.18"

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.8.6-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sat Jan 03 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.8.6-2
- Allow procfs 0.18

* Tue Nov 18 2025 mulhern <amulhern@redhat.com> - 3.8.6-1
- Update to version 3.8.6

* Mon Sep 15 2025 Chung Chung <cchung@redhat.com> - 3.8.5-1
- Update to version 3.8.5

* Thu Aug 28 2025 Chung Chung <cchung@redhat.com> - 3.8.4-1
