...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.8.1.1-2
- Uncommitted changes

* Tue May 26 2026 Paul Wouters <paul.wouters@aiven.io> - 1.8.1.1-1
- Update to 1.8.1.1

* Mon May 11 2026 Pavol Žáčik <pzacik@redhat.com> - 1.8.1.0-3
- Add patch to fix OpenSSL 4.0 compatibility

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.1.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 09 2025 Martin Osvald <mosvald@redhat.com> - 1.8.1.0-1
- Update to 1.8.1.0 (rhbz#2419992) - Fixes FTBFS for ELN/rawhide

* Tue Aug 12 2025 František Hrdina <fhrdina@redhat.com> - 1.8.0.3-2
- Update of fmf plans
