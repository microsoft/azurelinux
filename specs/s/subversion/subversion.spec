...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.14.5-27
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.14.5-26
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Jan 08 2026 Mamoru TASAKA <mtasaka@fedoraproject.org> - 1.14.5-25
- Rebuild for https://fedoraproject.org/wiki/Changes/Ruby_4.0

* Mon Nov 17 2025 Joe Orton <jorton@redhat.com> - 1.14.5-24
- fix FTBFS with SWIG 4.4 (#2405291)

* Mon Nov 17 2025 Joe Orton <jorton@redhat.com> - 1.14.5-23
- mod_dav_svn: inherit DavBasePath setting from mod_dav

* Mon Nov 17 2025 Joe Orton <jorton@redhat.com> - 1.14.5-22
- updated version of Python 3.14 compatibility fixes from upstream

* Mon Nov 17 2025 Joe Orton <jorton@redhat.com> - 1.14.5-21
- avoid serf pkg-config errors by avoiding --with-serf=path
