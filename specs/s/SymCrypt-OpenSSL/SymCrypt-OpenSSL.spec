...
* Fri Jun 26 2026 Tobias Brick <tobiasb@microsoft.com> - 1.9.6-3
- feat(SymCrypt-OpenSSL): upgrade to 1.9.6

* Fri Jun 26 2026 Tobias Brick <tobiasb@microsoft.com> - 1.9.6-2
- feat(SymCrypt-OpenSSL): adapt the Azure Linux 3.0 spec to build on 4.0
