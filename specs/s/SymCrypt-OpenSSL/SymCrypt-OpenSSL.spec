...
* Fri Sep 18 2026 Tobias Brick <tobiasb@microsoft.com> - 1.11.2-8
- feat(SymCrypt-OpenSSL): register as OpenSSL FIPS provider

* Fri Sep 18 2026 Maxwell Moyer-McKee <mamckee@microsoft.com> - 1.11.2-7
- feat: Update SymCrypt-OpenSSL to 1.11.2

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.11.2-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.11.2-5
- build: mass rebuild auto-bumpable components

* Thu Aug 06 2026 Tobias Brick <tobiasb@microsoft.com> - 1.11.2-4
- fix(SymCrypt-OpenSSL): disable KeysInUse

* Fri Jul 17 2026 Maxwell Moyer-McKee <mamckee@microsoft.com> - 1.11.2-3
- feat: Update SymCrypt-OpenSSL to 1.11.0

* Fri Jun 26 2026 Tobias Brick <tobiasb@microsoft.com> - 1.11.2-2
