...
* Fri Sep 18 2026 Tobias Brick <tobiasb@microsoft.com> - 1.11.0-7
- feat(SymCrypt-OpenSSL): register as OpenSSL FIPS provider

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.11.0-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.11.0-5
- build: mass rebuild auto-bumpable components

* Thu Aug 06 2026 Tobias Brick <tobiasb@microsoft.com> - 1.11.0-4
