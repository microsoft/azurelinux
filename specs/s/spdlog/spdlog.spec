...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.15.3-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.15.3-5
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.15.3-4
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Wed Jul 30 2025 Vitaly <vitaly@easycoding.org> - 1.15.3-3
- Fixed FTBFS bug due to changes in catch2 3.9.0+ that run tests in random
  order.

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.15.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat May 10 2025 Vitaly <vitaly@easycoding.org> - 1.15.3-1
- Updated to version 1.15.3.

* Sat Mar 29 2025 Vitaly <vitaly@easycoding.org> - 1.15.2-1
- Updated to version 1.15.2.

* Sun Feb 09 2025 Vitaly <vitaly@easycoding.org> - 1.15.1-2
- Rebuilt due to fmt update.

* Sat Feb 01 2025 Vitaly <vitaly@easycoding.org> - 1.15.1-1
- Updated to version 1.15.1.

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.15.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 13 2025 Vitaly <vitaly@easycoding.org> - 1.15.0-4
- Rebuilt due to fmt library update.

* Sun Jan 12 2025 Vitaly <vitaly@easycoding.org> - 1.15.0-3
- Backported upstream fixes for fmt 11.1 build issues.

* Sun Jan 12 2025 Vitaly <vitaly@easycoding.org> - 1.15.0-2
- Rebuilt due to fmt library update.

* Tue Nov 19 2024 František Zatloukal <fzatlouk@redhat.com> - 1.15.0-1
- Updated to version 1.15.0.

* Sat Jul 20 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.14.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue Jul 16 2024 Vitaly <vitaly@easycoding.org> - 1.14.1-2
- Rebuilt due to fmt library update.

* Tue May 21 2024 Vitaly <vitaly@easycoding.org> - 1.14.1-1
