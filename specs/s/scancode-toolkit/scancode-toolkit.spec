...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 32.5.0-3
- Uncommitted changes

* Fri Feb 27 2026 Maxwell G <maxwell@gtmx.me> - 32.5.0-2
- Build packagedcode cache to prevent errors

* Thu Feb 26 2026 Maxwell G <maxwell@gtmx.me> - 32.5.0-1
- Update to 32.5.0. Fixes rhbz#2430278.
- Fix FTBFS (rhbz#2435094)

* Mon Feb 23 2026 Tomáš Hrnčiar <thrnciar@redhat.com> - 32.4.1-13
- Fix invalid extras in %%pyproject_buildrequires -x

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 32.4.1-12
