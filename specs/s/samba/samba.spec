...
* Mon Apr 06 2026 azldev <> - 0:4.23.5-3
- Latest state for samba

* Sun Jan 25 2026 Günther Deschner <gd@samba.org> - 0:4.23.5-1
- Update to Samba 4.23.5

* Wed Jan 14 2026 Andreas Schneider <asn@redhat.com> - 0:4.23.4-4
- Add hint that we bundle ngtcp2 if not provided by the system

* Wed Jan 14 2026 Andreas Schneider <asn@redhat.com> - 0:4.23.4-3
- Remove unneeded dependency to samba-common-libs

* Wed Jan 14 2026 Andreas Schneider <asn@redhat.com> - 0:4.23.4-2
- Do not redeclare cmocka functions

* Fri Dec 12 2025 Günther Deschner <gd@samba.org> - 0:4.23.4-1
- Update to Samba 4.23.4
- resolves: #2421764

* Fri Nov 07 2025 Günther Deschner <gd@samba.org> - 0:4.23.3-1
- Update to Samba 4.23.3
- resolves: #2413362

* Fri Oct 17 2025 Günther Deschner <gd@samba.org> - 0:4.23.2-1
- Update to Samba 4.23.2
...
* Mon Sep 29 2025 Günther Deschner <gd@samba.org> - 0:4.23.1-1
- Update to Samba 4.23.1
- resolves: #2399755

* Tue Sep 23 2025 Alexander Bokovoy <abokovoy@redhat.com> - 0:4.23.0-13
- Fix DLZ crash on unconfigured Samba AD system and rebuild against Python
  3.14.0rc3
- Resolves: rhbz#2396621
- Resolves: rhbz#2397242

* Mon Sep 15 2025 Andreas Schneider <asn@redhat.com> - 0:4.23.0-12
- Build with systemd-userdb support

* Mon Sep 15 2025 Andreas Schneider <asn@redhat.com> - 0:4.23.0-11
- Fix building ctdb with PCP 7.0.0

* Mon Sep 15 2025 Andreas Schneider <asn@redhat.com> - 0:4.23.0-10
- Remove `smb3 unix extensions = yes` from smb.conf

* Mon Sep 15 2025 Andreas Schneider <asn@redhat.com> - 0:4.23.0-9
- Update to version 4.23.0
- resolves: rhbz#2394791

* Wed Sep 10 2025 Günther Deschner <gd@samba.org> - 0:4.23.0-0.8.rc4
- Update to Samba 4.23.0rc4
- resolves: #2393434

* Thu Sep 04 2025 Alexander Bokovoy <abokovoy@redhat.com> - 0:4.23.0-0.7.rc3
- Proper PCP fix that works for pre-7.0.0

* Thu Sep 04 2025 Alexander Bokovoy <abokovoy@redhat.com> - 0:4.23.0-0.6.rc3
- Support PCP 7.0.0 API
- resolves: rhbz#2392879

* Wed Sep 03 2025 Alexander Bokovoy <abokovoy@redhat.com> - 0:4.23.0-0.5.rc3
- Fix FreeIPA trust to AD
- resolves: rhbz#2392626

* Fri Aug 29 2025 Günther Deschner <gd@samba.org> - 0:4.23.0-0.4.rc3
- Update to Samba 4.23.0rc3
- resolves: #2387090

* Fri Aug 22 2025 Günther Deschner <gd@samba.org> - 0:4.23.0-0.3.rc2
- Update to Samba 4.23.0rc2
- resolves: #2387090

* Mon Aug 18 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 0:4.23.0-0.2.rc1
- Move trust_notify module to -dc subpackage

* Tue Aug 12 2025 Günther Deschner <gd@samba.org> - 0:4.23.0-0.1.rc1
- Update to Samba 4.23.0rc1
- resolves: #2387090

* Wed Aug 06 2025 František Zatloukal <fzatlouk@redhat.com> - 0:4.22.3-4
- Rebuilt for icu 77.1

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0:4.22.3-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 10 2025 Günther Deschner <gd@samba.org> - 0:4.22.3-2
- Fix get_kdc_ip_string handling for secondary KDCs
- resolves: bzso#15881

* Mon Jul 07 2025 Günther Deschner <gd@samba.org> - 0:4.22.3-1
- Update to Samba 4.22.3
- resolves: #2376873

* Mon Jun 23 2025 Andreas Schneider <asn@redhat.com> - 0:4.22.2-5
- smb.conf: Remove the '@' for NIX groups, we removed NIS support

* Tue Jun 10 2025 Pavel Filipenský <pfilipensky@samba.org> - 0:4.22.2-4
- Move libreplace-private-samba.so to samba-common-libs

* Tue Jun 10 2025 Pavel Filipenský <pfilipensky@samba.org> - 0:4.22.2-3
- Install /run/ctdb

* Fri Jun 06 2025 Python Maint <python-maint@redhat.com> - 0:4.22.2-2
- Rebuilt for Python 3.14

* Thu Jun 05 2025 Günther Deschner <gd@samba.org> - 0:4.22.2-1
- Update to Samba 4.22.2
- resolves: rhbz#2370468
- resolves: rhbz#2370455 - Security fix for CVE-2025-0620

* Wed Jun 04 2025 Python Maint <python-maint@redhat.com> - 0:4.22.1-2
- Rebuilt for Python 3.14

* Fri Apr 18 2025 Günther Deschner <gd@samba.org> - 0:4.22.1-1
- Update to Samba 4.22.1
- resolves: rhbz#2360776

* Thu Apr 10 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-21
- Turn on SMB 3.1.1 Unix Extensions in vendor smb.conf as well...

* Fri Mar 07 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-20
- Turn on SMB 3.1.1 Unix Extensions in default smb.conf

* Thu Mar 06 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-19
- Update to Samba 4.22.0
- resolves: rhbz#2350342

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.18.rc4
- Revert "Set samba-tools to noarch"

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.17.rc4
- Use spaces instead of tabs for krb5-printing scripts

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.16.rc4
- Set ctdb-etcd-mutex to noarch

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.15.rc4
- Set samba-gpupdate to noarch

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.14.rc4
- Set samba-tools to noarch

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.13.rc4
- Set samba-usershare to noarch

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.12.rc4
- Add missing /run/ctdb dir to files list

* Tue Mar 04 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.11.rc4
- Set version for bundled libreplace

* Mon Mar 03 2025 Andrea Bolognani <abologna@redhat.com> - 0:4.22.0-0.10.rc4
- Re-enable mold on riscv64

* Mon Mar 03 2025 David Abdurachmanov <davidlt@rivosinc.com> - 0:4.22.0-0.9.rc4
- Enable lmdb on riscv64

* Thu Feb 27 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-0.8.rc4
- Update to Samba 4.22.0rc4
- resolves: rhbz#2348758

* Thu Feb 20 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-0.7.rc3
- Update to Samba 4.22.0rc3
- resolves: rhbz#2346803

* Tue Feb 18 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.6.rc2
- Fix libldb built with '--with includelibs'

* Fri Feb 14 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.5.rc2
- Fix the '--with includelibs' build

* Fri Feb 14 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.4.rc2
- Add LICENSE file of libldb

* Fri Feb 14 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.22.0-0.3.rc2
- Make %%bcond switches easier to understand

* Thu Feb 13 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-0.2.rc2
- Update to Samba 4.22.0rc2
- resolves: rhbz#2345547

* Sat Feb 08 2025 Günther Deschner <gd@samba.org> - 0:4.22.0-0.1.rc1
- Update to version 4.22.0rc1
- resolves: rhbz#2344189

* Sat Feb 01 2025 Björn Esser <besser82@fedoraproject.org> - 0:4.21.3-7
- Add explicit BR: libxcrypt-devel

* Wed Jan 22 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.3-6
- Fix building with gcc 15

* Wed Jan 22 2025 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.3-5
- Fix stack use after return in new crypt module

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0:4.21.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Jan 07 2025 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.3-3
- Remove 'Requires: python3-crypt-r' also from samba-tools

* Tue Jan 07 2025 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.3-2
- Use upstream Patch instead of python3-crypt-r

* Tue Jan 07 2025 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.3-1
- Update to version 4.21.3
- resolves: rhbz#2335911

* Sun Dec 08 2024 Pete Walter <pwalter@fedoraproject.org> - 0:4.21.2-6
- Rebuild for ICU 76

* Tue Nov 26 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.2-2
- Add python3-crypt-r as requirement for samba-tool

* Mon Nov 25 2024 Günther Deschner <gd@samba.org> - 0:4.21.2-1
- Update to version 4.21.2
- resolves: rhbz#2328717

* Wed Nov 13 2024 Anoop C S <anoopcs@samba.org> - 0:4.21.1-10
- Remove unused macro samba_requires_eq

* Fri Oct 25 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.1-9
- Add always to samba-devel: Requires: samba-dc-libs

* Tue Oct 22 2024 Richard W.M. Jones <rjones@redhat.com> - 0:4.21.1-8
...
* Tue Oct 22 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.1-7
- Fix samba 4.20 -> 4.21 upgrade for the removed python3-samba-devel

* Thu Oct 17 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.1-6
- Revert "Re-enable linking with mold on i686"

* Wed Oct 16 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.1-5
- Fix even more rpminspect warnings

* Tue Oct 15 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.1-4
- Fix some more rpminspect warnings

* Tue Oct 15 2024 Andreas Schneider <asn@redhat.com> - 0:4.21.1-3
- Fix several rpminspect warnings

* Mon Oct 14 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.1-1
- Update to version 4.21.1
- resolves: rhbz#2318518

* Tue Oct 01 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.0-14
- Don't use RTLD_DEEPBIND by default in libldb
- resolves: rhbz#2278016

* Fri Sep 27 2024 Pavel Filipenský <pfilipensky@samba.org> - 0:4.21.0-13
- Build with ceph again for ppc64le

* Wed Sep 25 2024 Yaakov Selkowitz <yselkowi@redhat.com> - 0:4.21.0-12
- Always include libsamba-policy and libsamba-net-private-samba

* Tue Sep 24 2024 Yaakov Selkowitz <yselkowi@redhat.com> - 0:4.21.0-11
- Fix ELN build

* Mon Sep 23 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.0-10
- Add cert directories to samba-common

* Fri Sep 13 2024 Alexander Bokovoy <abokovoy@redhat.com> - 0:4.21.0-9
- Fix Samba integration with FreeIPA
- resolves: rhbz#2309199

* Mon Sep 02 2024 Günther Deschner <gd@samba.org> - 0:4.21.0-8
- Update required tdb version
- related: rhbz#2309153

* Mon Sep 02 2024 Günther Deschner <gd@samba.org> - 0:4.21.0-7
- Update to version 4.21.0
- resolves: rhbz#2309153

* Wed Aug 28 2024 Günther Deschner <gd@samba.org> - 0:4.21.0-0.6.rc4
- Update to version 4.21.0rc4
- resolves: rhbz#2300469

* Wed Aug 21 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.0-0.5.rc3
- Fix ldb requires and provides
- related: rhbz#230046

* Wed Aug 21 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.0-0.4.rc3
- Fix manpages for libldb

* Wed Aug 21 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.0-0.3.rc3
- Update to version 4.21.0rc3
- related: rhbz#230046

* Wed Aug 21 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.21.0-0.2.rc2
- Remove also python-ldb-devel-common
- related: rhbz#230046

* Tue Aug 20 2024 Günther Deschner <gd@samba.org> - 0:4.21.0-0.1.rc2
- Update to Samba 4.21.0rc2
- Package libldb a public library
- resolves: #2300469

* Sat Aug 17 2024 Peter Robinson <pbrobinson@gmail.com> - 0:4.20.4-1
- Update to version 4.20.4

* Mon Aug 05 2024 Christoph Erhardt <fedora@sicherha.de> - 0:4.20.2-5
- Re-enable linking with mold on i686

* Sat Jul 20 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0:4.20.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Mon Jul 01 2024 Andreas Schneider <asn@cryptomilk.org> - 0:4.20.2-3
- Move README.md and WHATSNEW.txt to samba-common

* Tue Jun 25 2024 Günther Deschner <gd@samba.org> - 0:4.20.2-2
- resolves: #2293108 - Move LICENSE file to samba-common

* Wed Jun 19 2024 Günther Deschner <gd@samba.org> - 0:4.20.2-1
- resolves: #2293100 - Update to version 4.20.2

* Mon Jun 10 2024 Python Maint <python-maint@redhat.com> - 0:4.20.1-4
