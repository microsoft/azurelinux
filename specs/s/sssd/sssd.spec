...
Patch4: fix-platform-m4-version-overwrite.patch
%description
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.13.1-3
- Uncommitted changes

* Wed Jul 08 2026 Sumit Bose <sbose@redhat.com> - 2.13.1-2
...
* Tue Jun 09 2026 Packit <hello@packit.dev> - 2.13.1-1
- Update to 2.13.1 upstream release

* Tue Apr 28 2026 Packit <hello@packit.dev> - 2.13.0-1
- Update to 2.13.0 upstream release

* Tue Apr 28 2026 Pavel Březina <pbrezina@redhat.com> - 2.12.0-5
- spec: add default value for samba_package_version

* Wed Mar 11 2026 Pavel Březina <pbrezina@redhat.com> - 2.12.0-4
- Add support for Plasma Login Manager as a supported PAM service

* Thu Jan 22 2026 Alexander Bokovoy <abokovoy@redhat.com> - 2.12.0-3
- Rebuild against Samba 4.24.0-RC1

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.12.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Jan 15 2026 Packit <hello@packit.dev> - 2.12.0-1
- Update to 2.12.0 upstream release

* Mon Oct 20 2025 Alexey Tikhonov <atikhono@redhat.com> - 2.11.1-4
- Resolves: https://bugzilla.redhat.com/show_bug.cgi?id=2402728

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.11.1-3
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.11.1-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.11.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jun 06 2025 Python Maint <python-maint@redhat.com> - 2.11.0-2
