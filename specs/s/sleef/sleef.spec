...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.9.0-7
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.9.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sun Jan 11 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.9.0-5
- Skip a test that fails on x86_64 with GCC 16
