...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.14.0-12
- Uncommitted changes

* Thu Jan 22 2026 Jerry James <loganjerry@gmail.com> - 1.14.0-11
- Fix FTBFS with mpmath 1.4 (rhbz#2432011)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.14.0-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Jan 14 2026 Jerry James <loganjerry@gmail.com> - 1.14.0-9
- Reflow the description text

* Thu Oct 16 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 1.14.0-8
- Support llvmlite >= 0.45
