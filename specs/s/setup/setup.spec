...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.15.0-29
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.15.0-28
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 30 2025 Lukas Javorsky <ljavorsk@redhat.com> - 2.15.0-27
- Revert "Removed uidgid pair 27:27 for MySQL/MariaDB"

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.15.0-26
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed May 14 2025 Martin Osvald <mosvald@redhat.com> - 2.15.0-25
- protocols: update to latest IANA

* Mon May 12 2025 Mattias Ellert <mattias.ellert@physics.uu.se> - 2.15.0-24
- Reserve 194:194 for xrootd (xrootd-server)

* Thu Mar 20 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 2.15.0-23
- Insist that the root and nobody groups have the expected GIDs

* Thu Mar 20 2025 Daan De Meyer <daan.j.demeyer@gmail.com> - 2.15.0-22
- Add root and nobody groups

* Sat Mar 15 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.15.0-18
- uidgid: drop various unused users and groups

* Sat Mar 15 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.15.0-17
- uidgid: adjust comments

* Fri Mar 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.15.0-16
- Create passwd,group files from sysusers

* Fri Mar 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.15.0-15
- uidgid: make rtkit user dynamic

* Mon Mar 10 2025 Martin Osvald <mosvald@redhat.com> - 2.15.0-14
- Removed uidgid pair 27:27 for MySQL/MariaDB

* Wed Mar 05 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.15.0-13
- profile: do not add /usr/sbin to the path

* Mon Feb 10 2025 Björn Esser <besser82@fedoraproject.org> - 2.15.0-12
- Drop pre-allocation of users and groups, during %%%%post

* Wed Jan 22 2025 Miroslav Lichvar <mlichvar@redhat.com> - 2.15.0-11
- Add clock group for systemd

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.15.0-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Dec 27 2024 Björn Esser <besser82@fedoraproject.org> - 2.15.0-9
- Ensure pre-allocated users, groups, and tmpfiles are created in %%%%post

* Fri Dec 27 2024 Björn Esser <besser82@fedoraproject.org> - 2.15.0-8
- Cleanup spec file and drop old sources

* Fri Dec 27 2024 Panu Matilainen <pmatilai@redhat.com> - 2.15.0-7
- Fix deprecation warnings on install/update

* Tue Sep 24 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.15.0-6
