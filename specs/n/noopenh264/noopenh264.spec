...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.6.0-5
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Sep 09 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 2.6.0-3
- Fix conflicts between i686 noopenh264 and x86_64 openh264
