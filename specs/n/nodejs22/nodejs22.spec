...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1:22.22.2-4
- Uncommitted changes

* Mon May 04 2026 Andrei Radchenko <aradchen@redhat.com> - 1:22.22.2-3
- test plan: diverge from f44
- bin packages were introduced in f44 onwards
- provision step should be set automatically by testing farm
