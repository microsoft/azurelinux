...
- Merge #24 `packaging: syncing changes back to the template`

* Tue May 20 2025 tjuhasz <tjuhasz@redhat.com> - 1:22.15.1-3
- Debundle c-ares

* Tue May 20 2025 tjuhasz <tjuhasz@redhat.com> - 1:22.15.1-2
- Remove printing tests that arent present
...
- Merge #17 `Changed library link from nodejs to node`

* Mon Apr 14 2025 Andrei Radchenko <aradchen@redhat.com> - 1:22.14.0-7
- Enable testing in CI

* Mon Apr 14 2025 tjuhasz <tjuhasz@redhat.com> - 1:22.14.0-6
- Added specific ignores for nodejs22 Verify tests

* Thu Apr 10 2025 Jan Staněk <jstanek@redhat.com> - 1:22.14.0-5
- Add the test-runner into the template as well

* Tue Mar 25 2025 tjuhasz <tjuhasz@redhat.com> - 1:22.14.0-4
- Basic unit tests run during build

* Mon Feb 24 2025 tjuhasz <tjuhasz@redhat.com> - 1:22.14.0-3
- Add rpminspect config to disable disttag check

* Wed Feb 19 2025 Jan Staněk <jstanek@redhat.com> - 1:22.14.0-2
...
* Thu Jan 23 2025 Jan Staněk <jstanek@redhat.com> - 1:22.13.1-1
...
* Tue Dec 03 2024 Jan Staněk <jstanek@redhat.com> - 1:22.11.0-3
- Fix npm hashbang replacement

* Tue Nov 19 2024 Jan Staněk <jstanek@redhat.com> - 1:22.11.0-2
- Import riscv64 build fix from upstream

* Wed Oct 30 2024 Jan Staněk <jstanek@redhat.com> - 1:22.11.0-1
- Update to version 22.11.0 (LTS) (rhbz#2313003)

* Fri Sep 13 2024 Jan Staněk <jstanek@redhat.com> - 1:22.8.0-1
- Update to version 22.8.0

* Thu Sep 12 2024 Jan Staněk <jstanek@redhat.com> - 1:22.6.0-3
- check: only check npm configuration on default stream

* Wed Sep 11 2024 Jan Staněk <jstanek@redhat.com> - 1:22.6.0-2
- Fix npm invocation in %%check section

* Tue Sep 10 2024 Jan Staněk <jstanek@redhat.com> - 1:22.6.0-1
- Update to version 22.6.0

* Mon Aug 19 2024 Jan Staněk <jstanek@redhat.com> - 1:22.4.1-3
- Disable npm update-notifier

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1:22.4.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Wed Jul 10 2024 Jan Staněk <jstanek@redhat.com> - 1:22.4.1-1
- wip: Update to version 22.4.1

* Wed Jul 10 2024 Jan Staněk <jstanek@redhat.com> - 1:22.3.0-2
- Compile without OpenSSL Engine API

* Fri Jun 14 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.3.0-1
- Update to 22.3.0

* Wed May 22 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-9
- Fix missing %%nodejs_pkg_major

* Wed May 22 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-8
- Re-enable bundling without bootstrap mode

* Tue May 21 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-7
- Temporarily re-enable bundling of cjs-module-lexer and undici

* Tue May 21 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-6
- Move the default check to the top

* Tue May 21 2024 Stephen Gallagher <sgallagh@redhat.com>
- Refactor bundling of undici and cjs-module-lexer

* Tue May 21 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-4
- Make Node.js 22 the default for RHEL 11

* Tue May 21 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-3
- Revert "Temporarily add Node.js 20 as default for F41 and RHEL 11+"

* Fri May 17 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-2
- Use correct macro for built-in modules

* Thu May 16 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.2.0-1
- Update to 22.2.0

* Fri May 10 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.1.0-2
- Drop -fno-delete-null-pointer-checks

* Fri May 03 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.1.0-1
- Update to 22.1.0

* Wed May 01 2024 Stephen Gallagher <sgallagh@redhat.com> - 1:22.0.0-2
- Node.js 22.0.0
