...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4:7.92-12
- Uncommitted changes
...
* Mon May 04 2026 Pavol Žáčik <pzacik@redhat.com> - 4:7.92-9
- Add patch to fix OpenSSL 4.0 compatibility

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4:7.92-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Aug 12 2025 František Hrdina <fhrdina@redhat.com> - 4:7.92-7
- Update of fmf plans
