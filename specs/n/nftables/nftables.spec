...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:1.1.3-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 1:1.1.3-2
...
* Fri Jul 05 2024 Phil Sutter <psutter@redhat.com> - 1:1.0.9-6
- Verify tarball GPG signature

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 1:1.0.9-5
- Rebuilt for Python 3.13

* Wed May 08 2024 Phil Sutter <psutter@redhat.com> - 1:1.0.9-4
- Own the whole %%{_docdir}/nftables, not just files therein
