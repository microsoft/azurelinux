...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.66.0-5
- feat(render): convert static changelogs to interleaved releases for n*
  components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 1.66.0-4
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.66.0-3
