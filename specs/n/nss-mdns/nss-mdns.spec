...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.15.1-30
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.15.1-29
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.15.1-28
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.1-27
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Feb 25 2025 Petr Menšík <pemensik@redhat.com> - 0.15.1-26
- Actually convert license to SPDX

* Mon Jan 20 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 0.15.1-25
- Conditionalize avahi dependency

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.1-24
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sat Dec 21 2024 Petr Menšík <pemensik@redhat.com> - 0.15.1-23
- Rawhide is already contained in fedora releases

* Sat Dec 21 2024 Petr Menšík <pemensik@redhat.com> - 0.15.1-22
- Correct auto-enabled package rawhide

* Sat Dec 21 2024 Petr Menšík <pemensik@redhat.com> - 0.15.1-21
- Do not hide authselect errors

* Sat Dec 21 2024 Petr Menšík <pemensik@redhat.com> - 0.15.1-20
- Change License tag, install into _libdir

* Mon Sep 02 2024 Miroslav Suchý <msuchy@redhat.com> - 0.15.1-13
- convert license to SPDX

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.1-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Thu Jan 25 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.1-11
