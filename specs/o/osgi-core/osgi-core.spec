...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 8.0.0-41
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 8.0.0-40
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 8.0.0-39
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 8.0.0-38
- Rebuilt for java-25-openjdk as preffered jdk

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.0-37
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-36
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-35
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-34
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-33
- Remove javadoc subpackage

* Fri Feb 14 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-32
- Remove bogus dependency

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 8.0.0-31
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Dec 30 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-27
- Use %%autosetup -C

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 8.0.0-26
