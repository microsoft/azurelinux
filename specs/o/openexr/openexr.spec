...
%build
%cmake
unzip -o %{SOURCE1} -d %{__cmake_builddir}/src/test/bin/
%cmake_build
...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.2.4-12
- feat(render): convert static changelogs to interleaved releases for o*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.2.4-11
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.2.4-6
