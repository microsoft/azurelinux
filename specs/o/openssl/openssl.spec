...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1:3.5.4-9
- feat(render): convert static changelogs to interleaved releases for o*
  components

* Tue May 12 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1:3.5.4-8
- refactor: adjust azurelinux macro (major version only)

* Tue May 12 2026 Tobias Brick <tobiasb@microsoft.com> - 1:3.5.4-7
- fix(openssl): pin to Fedora f43 commit with CVE fixes

* Tue Apr 21 2026 Pavol Žáčik <pzacik@redhat.com> - 1:3.5.4-6
- Backport security patches from 3.5.6

* Wed May 06 2026 Tobias Brick <tobiasb@microsoft.com> - 1:3.5.4-5
- openssl: remove fips.so on AZL4 (not supported for public preview)

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1:3.5.4-4
