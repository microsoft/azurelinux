...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.2.0-13
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.0-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Jan 13 2026 Jerry James <loganjerry@gmail.com> - 1.2.0-11
- Reflow the description text

* Mon Oct 13 2025 Richard W.M. Jones <rjones@redhat.com> - 1.2.0-10
- OCaml 5.4.0 rebuild
