...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.0.36-6
- feat(render): convert static changelogs to interleaved releases for o*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.0.36-5
...
* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.35-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue May  7 2024 Pavel Cahyna <pcahyna@redhat.com> - 2.0.35-1
- Switch to https
- Update to 2.0.35 (rhbz#2278007)
