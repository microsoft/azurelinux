...
Int32, Int64 and Nativeint modules from the OCaml standard library, with some
...
better GC behavior than e.g. the MLGMP library.  Computations on small
integers use a special, faster path (coded in assembly for some platforms and
functions) eschewing calls to GMP, while computations on large integers use
the low-level MPN functions from GMP.
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.14-12
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.14-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Jan 13 2026 Jerry James <loganjerry@gmail.com> - 1.14-10
- Reflow the description text

* Mon Oct 13 2025 Richard W.M. Jones <rjones@redhat.com> - 1.14-9
- OCaml 5.4.0 rebuild

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.14-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jul 11 2025 Jerry James <loganjerry@gmail.com> - 1.14-7
- Rebuild to fix OCaml dependencies

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.14-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Jan 15 2025 Jerry James <loganjerry@gmail.com> - 1.14-5
- Move configuration steps to %%conf

* Thu Jan 09 2025 Jerry James <loganjerry@gmail.com> - 1.14-4
- OCaml 5.3.0 rebuild for Fedora 42

* Fri Dec 27 2024 Jerry James <loganjerry@gmail.com> - 1.14-3
