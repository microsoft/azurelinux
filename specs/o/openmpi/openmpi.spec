...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 5.0.9-5
- Uncommitted changes

* Thu Mar 05 2026 Orion Poplawski <orion@nwra.com> - 5.0.9-4
- Add patches to fix building with gcc 16 (FTBFS rhbz#2434889)

* Wed Jan 28 2026 Miroslav Suchý <msuchy@redhat.com> - 5.0.9-3
- migrate license to SPDX

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 5.0.9-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Oct 31 2025 Orion Poplawski <orion@nwra.com> - 5.0.9-1
- Update to 5.0.9

* Wed Oct 22 2025 Terje Røsten <terjeros@gmail.com> - 5.0.8-7
- Rebuild for orangefs 2.10.1

* Thu Jul 31 2025 Orion Poplawski <orion@nwra.com> - 5.0.8-6
- Disable ucx on ppx64le because it is broken -
  https://github.com/openucx/ucx/issues/10780

* Thu Jul 31 2025 Orion Poplawski <orion@nwra.com> - 5.0.8-5
- Drop old python2 support

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 5.0.8-4
- Rebuilt for java-25-openjdk as preffered jdk

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.0.8-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jun 06 2025 Python Maint <python-maint@redhat.com> - 5.0.8-2
- Rebuilt for Python 3.14

* Thu Jun 05 2025 Orion Poplawski <orion@nwra.com> - 5.0.8-1
- Update to 5.0.8

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 5.0.6-7
- Rebuilt for Python 3.14

* Fri Apr 04 2025 Cristian Le <git@lecris.dev> - 5.0.6-6
- Rebuild for PMIX 5.0.7

* Sat Mar 01 2025 Orion Poplawski <orion@nwra.com> - 5.0.6-5
- Add patch to handle new OpenJDK location
