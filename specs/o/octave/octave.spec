...
libjvm=%{_jvmdir}/msopenjdk-25/lib/server
...
%if %{with java}
 --with-java-includedir=%{_jvmdir}/msopenjdk-25/include \
...
* Thu Sep 17 2026 Nan Liu <liunan@microsoft.com> - 6:10.2.0-5
- feat(java): migrate to Microsoft OpenJDK 25

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6:10.2.0-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6:10.2.0-3
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6:10.2.0-2
