...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.4-2
- Uncommitted changes

* Wed Jun 10 2026 Marian Koncek <mkoncek@redhat.com> - 2.4-1
- Update to upstream version 2.4

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.2-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Sep 08 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 2.2-8
- Remove maven-enforcer-plugin dependency
