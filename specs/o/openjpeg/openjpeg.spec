...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.5.4-4
- feat(render): convert static changelogs to interleaved releases for o*
  components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 2.5.4-3
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.5.4-2
