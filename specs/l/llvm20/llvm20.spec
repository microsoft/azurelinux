...
Patch2202: 0001-Clang-Add-azurelinux-to-fallback-triples.patch
%description
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 20.1.8-10
- Uncommitted changes

* Fri Apr 17 2026 Tulio Magno Quites Machado Filho <tuliom@redhat.com> - 20.1.8-9
- Fix a clangd use-after-free

* Sat Apr 11 2026 Tom Stellard <tstellar@redhat.com> - 20.1.8-7
- Backport patch from LLVM 22 to fix test on s390x

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 20.1.8-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Sep 25 2025 Jesus Checa Hidalgo <jchecahi@redhat.com> - 20.1.8-4
- Add gating tests for llvm20

* Sun Sep 07 2025 Tom Stellard <tstellar@redhat.com> - 20.1.8-3
- Add rpminspect.yaml from rpms/llvm

* Wed Sep 03 2025 Tom Stellard <tstellar@redhat.com> - 20.1.8-2
