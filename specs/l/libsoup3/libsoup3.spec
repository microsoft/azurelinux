...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.6.6-10
- Uncommitted changes
...
* Mon Mar 02 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 3.6.6-5
- Fix mingw localizations appearing in main package

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 3.6.6-4
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 3.6.6-3
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 3.6.6-2
