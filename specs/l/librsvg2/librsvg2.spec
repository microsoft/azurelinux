...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.61.0-10
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.61.0-9
- build: mass rebuild auto-bumpable components
...
* Mon Jan 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.61.0-5
- Update License and write it one-term-per-line

* Mon Jan 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.61.0-4
- Report and skip a test that fails with image 0.25.9

* Wed Dec 10 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.61.0-3
- Ensure correct fonts are installed for HTML docs

* Thu Sep 04 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 2.61.0-2
- Remove pixbuf loader and thumbnailer

* Mon Aug 25 2025 Fabio Valentini <decathorpe@gmail.com> - 2.61.0-1
- Update to 2.61.0

* Thu Aug 07 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 2.60.0-4
- Fix RHEL build

* Fri Aug 01 2025 Marek Kasik <mkasik@redhat.com> - 2.60.0-3
- Update test reference images to fix build

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.60.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Mar 27 2025 Fabio Valentini <decathorpe@gmail.com> - 2.60.0-1
- Update to 2.60.0 and enable AVIF support on Fedora

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.59.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Thu Oct 31 2024 nmontero <nmontero@redhat.com> - 2.59.2-1
- Update to 2.59.2

* Fri Oct 04 2024 Kleis Auke Wolthuizen <fedora@kleisauke.nl> - 2.59.1-1
- Update to 2.59.1
- Migrate build to Meson

* Wed Sep 25 2024 Fabio Valentini <decathorpe@gmail.com> - 2.57.1-9
- Bump nalgebra to 0.33, markup5ever to 0.14, xml5ever to 0.20

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.57.1-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue Jun 04 2024 Fabio Valentini <decathorpe@gmail.com> - 2.57.1-7
- Skip one broken reference test and re-enable tests on s390x

* Fri May 24 2024 Fabio Valentini <decathorpe@gmail.com> - 2.57.1-6
- Rebuild with Rust 1.78 to fix incomplete debuginfo and backtraces

* Wed Apr 10 2024 Josh Stone <jistone@redhat.com> - 2.57.1-5
- Upgrade dependency lopdf to 0.32; fixes rhbz#2274029
