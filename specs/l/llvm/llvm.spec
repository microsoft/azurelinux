...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 21.1.8-10
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 21.1.8-9
- build: mass rebuild auto-bumpable components

* Tue Jun 02 2026 Tobias Brick <tobiasb@microsoft.com> - 21.1.8-8
- chore(llvm-clang): add azurelinux-specific triple to clang default
  fallback list
