...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.10.1-2
...
* Mon Jul 29 2024 Stefan Berger <stefanb@linux.ibm.com> - 0.9.6-8
- Apply patch for fixing build without engine.h
- Apply patch for returning proper error code upon RSA decryption failure

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 0.9.6-7
