...
- Merge #9 `Draft: Subpackage minimal set of daemons into -minimal`

* Thu Feb 27 2025 Paul Wouters <paul.wouters@aiven.io> - 5.2-1
- Update to libreswan-5.2

* Mon Feb 03 2025 Daiki Ueno <dueno@redhat.com> - 5.1-5
- Fix FTBFS with GCC 15

* Sat Feb 01 2025 Björn Esser <besser82@fedoraproject.org> - 5.1-4
- Add explicit BR: libxcrypt-devel

* Mon Jan 20 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sun Jan 12 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 5.1-2
- Rebuilt for the bin-sbin merge (2nd attempt)

* Tue Oct 08 2024 Paul Wouters <paul.wouters@aiven.io> - 5.1-1
- Update to libreswan 5.1

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.15-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue Jul 09 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 4.15-3
- Fix build with %%_sbindir==%%_bindir and add compat sbin Provides
...
* Tue Mar 12 2024 Paul Wouters <paul.wouters@aiven.io> - 4.14-1
