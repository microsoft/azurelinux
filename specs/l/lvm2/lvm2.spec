...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.03.38-3
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.03.38-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Dec 15 2025 Marian Csontos <mcsontos@redhat.com> - 2.03.38-1
- New upstream release v2.03.38

* Fri Nov 21 2025 Marian Csontos <mcsontos@redhat.com> - 2.03.37-1
- New upstream release v2.03.37

* Fri Oct 24 2025 Marian Csontos <mcsontos@redhat.com> - 2.03.36-1
- New upstream release v2.03.36

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.03.35-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Tue Sep 09 2025 Marian Csontos <mcsontos@redhat.com> - 2.03.35-1
- New upstream release v2.03.35
