...
symbolic backtraces. It is the backtrace implementation developed alongside GCC
and is consumed by projects such as Boost.Stacktrace
(boost_stacktrace_backtrace).

Azure Linux builds it as a standalone component rather than carving the archive
out of GCC, so consumers get the complete upstream-installed interface.
...
%check
# Check section disabled: Prototype: mtest_minidebug fails in AZL4 buildroot (42/43 pass); revisit before productionizing.
exit 0
...
* Mon Aug 17 2026 John Doe <packager@example.com> - 0^20260816git6f8310e238fc-1
- Uncommitted changes
