...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.21.7-14
- Uncommitted changes

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 0.21.7-13
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 0.21.7-12
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 0.21.7-11
- Onboard to Packit for stable Fedora branches

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.21.7-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Nov 03 2025 Debarshi Ray <rishi@fedoraproject.org> - 0.21.7-7
- Update License tag and package missing license texts

* Mon Nov 03 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 0.21.7-6
