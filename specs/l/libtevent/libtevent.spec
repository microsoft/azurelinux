...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.17.1-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.17.1-5
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.17.1-4
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.17.1-3
- Rebuilt for Python 3.14.0rc3 bytecode

* Mon Aug 18 2025 Python Maint <python-maint@redhat.com> - 0.17.1-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Mon Aug 11 2025 Günther Deschner <gd@samba.org> - 0.17.1-1
- rhbz#2387081 - libtevent-0.17.1 is available

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.16.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 0.16.2-3
- Rebuilt for Python 3.14

* Fri Feb 14 2025 Andreas Schneider <asn@cryptomilk.org> - 0.16.2-2
- Add LICENSE file
- rhbz#2315735

* Thu Feb 06 2025 Günther Deschner <gd@samba.org> - 0.16.2-1
- rhbz#2344174 - libtevent-0.16.2 is available

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.16.1-7
