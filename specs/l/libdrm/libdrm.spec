...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.4.131-3
- feat(render): convert static changelogs to interleaved releases for l*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.4.131-2
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Jan 23 2026 Packit <hello@packit.dev> - 2.4.131-1
- Update to version 2.4.131
- Resolves: rhbz#2415436
...
* Thu Dec 05 2024 José Expósito <jexposit@redhat.com> - 2.4.124-1
- Update to 2.4.124

* Tue Aug 27 2024 José Expósito <jexposit@redhat.com> - 2.4.123-1
- Update to 2.4.123

* Tue Jul 23 2024 Peter Robinson <pbrobinson@fedoraproject.org> - 2.4.122-1
- Update to 2.4.122
- Build Intel on all arches

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.121-2
