...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.4.8-8
- feat(render): convert static changelogs to interleaved releases for l*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.4.8-7
...
* Wed Jun  4 2025 Tom Callaway <spot@fedoraproject.org> - 5.4.8-1
- update to 5.4.8

* Mon Mar  3 2025 Tom Callaway <spot@fedoraproject.org> - 5.4.7-3
- apply more complete upstream fix for bug3 (thanks to Xose Vazquez Perez)

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.4.7-2
