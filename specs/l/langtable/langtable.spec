...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.0.71-2
- Uncommitted changes

* Mon Jun 08 2026 Mike FABIAN <mfabian@redhat.com> - 0.0.71-1
- Update to 0.0.71
- Add xdq, sus, mrh, hrx, brh, ary, en_SE.UTF-8
- Get new translations and translation changes from CLDR
- setup.py: use open() instead of deprecated codecs.open(), declare minimum
  Python version >= 3.8
...
* Mon Feb 02 2026 Mike FABIAN <mfabian@redhat.com> - 0.0.70-1
- Update to 0.0.70
- Add a few dz keyboards (Resolves: https://github.com/mike-
  fabian/langtable/issues/25)
- Add more translations from CLDR
- Get translation changes from CLDR
- Add GS, ady, bqi, isv, kbd, kek, lzz, mww, oka, pi, pms, suz, Suni,
  si_ID.UTF-8 zgh_MA.UTF-8
- Add mdf_RU.UTF-8 to RU

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.0.69-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.0.69-4
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.0.69-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.0.69-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 17 2025 Mike FABIAN <mfabian@redhat.com> - 0.0.69-1
- Update to 0.0.69
- Add Georgian console fonts
- Add Adlm script to SN
- Add dra, Tutg, ath, cmc, Cham, tai
- Remove License classifier (license tag with SPDX license expression is
  already there)
- Remove 0001-Georgian-add-georgian-console-fonts.patch (included upstream)
- Stop using deprecated %%py3_build/%%py3_install macros Resolves:
  rhbz#2377304

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 0.0.68-5
- Rebuilt for Python 3.14

* Mon Jan 27 2025 Adam Williamson <awilliam@redhat.com> - 0.0.68-4
- Backport PR #24 for Georgian console font support

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.0.68-3
