...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.9.3-2
- Uncommitted changes

* Mon Aug 03 2026 Packit <hello@packit.dev> - 1.9.3-1
- Update to 1.9.3 upstream release

* Sun Jun 28 2026 Packit <hello@packit.dev> - 1.9.2-1
- Update to 1.9.2 upstream release

* Sun May 24 2026 Packit <hello@packit.dev> - 1.9.1-1
- Update to 1.9.1 upstream release

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 1.9.0-1
- Update to 1.9.0

* Tue Mar 03 2026 Jan Grulich <jgrulich@redhat.com> - 1.9~rc-1
- Update to 1.9.rc

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 1.9~beta-5
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.9~beta-4
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 1.9~beta-3
- Onboard to Packit for stable Fedora branches

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 1.9~beta-2
- Newer tag: f44-build-side-127992

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 1.9~beta-1
- Update to 1.9.beta

* Mon Jan 19 2026 Jan Horak <jhorak@redhat.com> - 1.9~alpha-1
- Update to 1.9.alpha

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Dec 18 2025 Jeremy Bícha <jbicha@debian.org> - 1.8.2-2
- Have libadwaita-devel Suggest instead of Recommend libadwaita-demo
