...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 5.9.0-2
- Uncommitted changes

* Wed Jan 21 2026 Packit <hello@packit.dev> - 5.9.0-1
- Update to 5.9.0 upstream release
- Resolves: rhbz#2430833

* Tue Jan 20 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 5.8.2-3
- Run autoreconf to fix build with GCC 16

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 5.8.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Nov 17 2025 Packit <hello@packit.dev> - 5.8.2-1
- Update to 5.8.2 upstream release
- Resolves: rhbz#2415413

* Mon Oct 27 2025 Packit <hello@packit.dev> - 5.8.1-1
- Update to 5.8.1 upstream release
- Resolves: rhbz#2406502

* Mon Oct 13 2025 Packit <hello@packit.dev> - 5.8.0-1
- Update to 5.8.0 upstream release
- Resolves: rhbz#2403515
