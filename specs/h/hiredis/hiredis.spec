...
%changelog
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.0-8
...
* Mon Sep 02 2024 Miroslav Suchý <msuchy@redhat.com> - 1.2.0-5
- convert license to SPDX

* Sun Aug 25 2024 Orion Poplawski <orion@nwra.com> - 1.2.0-4
- Add patch to allow tests to use valkey-server directly

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Sun May 26 2024 Kevin Fenzi <kevin@scrye.com> - 1.2.0-2
- Enable SSL during install ( thanks Tom Briden <tom.briden@eckoh.com> )
