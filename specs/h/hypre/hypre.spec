...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.32.0-10
- Uncommitted changes

* Sat Jan 24 2026 Antonio Trande <sagitter@fedoraproject.org> - 2.32.0-9
- Add texlive-xltabular BR

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.32.0-8
