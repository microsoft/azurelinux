...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.12.0-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.12.0-5
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.12.0-4
- fix(hwloc): skip Fedora-only oneapi-level-zero-devel BuildRequires
