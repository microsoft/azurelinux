...
* Mon Sep 14 2026 Nan Liu <liunan@microsoft.com> - 1.14.6-10
- fix(java): use Microsoft OpenJDK 25 across consumers

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.14.6-9
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.14.6-8
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.14.6-7
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.14.6-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jul 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 1.14.6-5
- Define %%_hdf5_plugin_dir for the location of (serial) plugins

* Mon Jul 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 1.14.6-4
- Use %%_rpmmacrodir

* Thu Feb 13 2025 Orion Poplawski <orion@nwra.com> - 1.14.6-3
- t_multi_dset/t_pmulti_dset is still flaky on ppc64le

* Wed Feb 12 2025 Orion Poplawski <orion@nwra.com> - 1.14.6-2
- Provide a more relaxed version that other packages depend on

* Sun Feb 09 2025 Orion Poplawski <orion@nwra.com> - 1.14.6-1
- Update to 1.14.6

* Sun Feb 09 2025 Orion Poplawski <orion@nwra.com> - 1.14.5-10
- hdf5 now only checks that the major and minor versions match, so reduce
  the _hdf5_version macro to just that

* Sat Feb 08 2025 Orion Poplawski <orion@nwra.com> - 1.14.5-9
- Use --with-fmoddir to set Fortran module dir (rhbz#2183289)
