...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.84.1-2
- Uncommitted changes

* Sat Aug 01 2026 Packit <hello@packit.dev> - 0.84.1-1
- Update to 0.84.1 upstream release

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 0.84.0-1
- Update to 0.84.0

* Tue Mar 03 2026 Jan Grulich <jgrulich@redhat.com> - 0.83.91-1
- Update to 0.83.91

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 0.83.90-4
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 0.83.90-3
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 0.83.90-2
- Onboard to Packit for stable Fedora branches

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 0.83.90-1
- Update to 0.83.90

* Mon Jan 19 2026 Jan Horak <jhorak@redhat.com> - 0.82.3-1
- Update to 0.82.3

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.82.2-2
