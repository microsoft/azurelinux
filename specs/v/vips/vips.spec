...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 8.17.3-2
...
* Fri Aug 12 2011 Adam Goode <adam@spicenitz.org> - 7.24.7-1
- Merge branch 'master' into f14

* Tue Oct 05 2010 Jesse Keating <jkeating@redhat.com> - 7.22.2-3
- Rebuilt for gcc bug 634757

* Fri Sep 17 2010 Rex Dieter <rdieter@fedoraproject.org> - 7.22.2-2
- rebuild (ImageMagick)

* Fri Aug 06 2010 Adam Goode <adam@spicenitz.org> - 7.22.2-1
- Update to 7.22.2

* Thu Jul 29 2010 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 7.22.1-3
- dist-git conversion

* Tue Jul 27 2010 Adam Goode <agoode@fedoraproject.org> - 7.22.1-2
- Add COPYING to doc subpackage

* Tue Jul 27 2010 Adam Goode <agoode@fedoraproject.org> - 7.22.1-1
- New upstream release More revision of VIPS library New threading system
  New command-line program, vipsthumbnail Improved interpolators German
  translation PFM (portable float map) image format read and write Much
  lower VM use with many small images open Rewritten flood-fill

* Thu Jul 22 2010 dmalcolm <dmalcolm@fedoraproject.org> - 7.20.7-4
- Rebuilt for
  https://fedoraproject.org/wiki/Features/Python_2.7/MassRebuild

* Wed Jun 16 2010 Adam Goode <agoode@fedoraproject.org> - 7.20.7-3
- Don't require gtk-doc anymore (resolves #604421)

* Sun Mar 07 2010 Adam Goode <agoode@fedoraproject.org> - 7.20.7-2
- Rebuild for imagemagick soname change - Remove some old RPM stuff

* Tue Feb 02 2010 Adam Goode <agoode@fedoraproject.org> - 7.20.7-1
- New upstream release C++ and Python bindings now have support for
  deprecated functions Bugfixes for YCbCr JPEG TIFF files

* Wed Jan 06 2010 Adam Goode <agoode@fedoraproject.org> - 7.20.6-1
- New upstream release About half of the VIPS library has been revised Now
  using gtk-doc Better image file support MATLAB file read supported New
  interpolation system Support for Radiance files

* Wed Jan 06 2010 Adam Goode <agoode@fedoraproject.org> - 7.18.2-3
- Change some %%define into %%global

* Wed Nov 25 2009 Bill Nottingham <notting@fedoraproject.org> - 7.18.2-2
- Fix typo that causes a failure to update the common directory. (releng
  #2781)

* Fri Sep 04 2009 Miloš Jakubíček <mjakubicek@fedoraproject.org> - 7.18.2-1
- Update to 7.18.2 to sync with fixed nip2 FTBFS.

* Mon Jul 27 2009 Jesse Keating <jkeating@fedoraproject.org> - 7.16.4-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_12_Mass_Rebuild

* Wed Mar 11 2009 Adam Goode <agoode@fedoraproject.org> - 7.16.4-3
- Rebuild for ImageMagick soname change

* Thu Feb 26 2009 Jesse Keating <jkeating@fedoraproject.org> - 7.16.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_11_Mass_Rebuild

* Mon Dec 29 2008 Adam Goode <agoode@fedoraproject.org> - 7.16.4-1
- New release

* Mon Dec 22 2008 Adam Goode <agoode@fedoraproject.org> - 7.16.3-1
- New release - Update description

* Sat Nov 29 2008 Ignacio Vazquez-Abrams <ivazquez@fedoraproject.org> - 7.14.5-3
- Rebuild for Python 2.6

* Sun Nov 23 2008 Adam Goode <agoode@fedoraproject.org> - 7.14.5-2
- Update summaries

* Sat Aug 30 2008 Adam Goode <agoode@fedoraproject.org> - 7.14.5-1
- New release

* Sat Jun 21 2008 Adam Goode <agoode@fedoraproject.org> - 7.14.4-1
- New release

* Sat Mar 15 2008 Adam Goode <agoode@fedoraproject.org> - 7.14.1-1
- New release

* Tue Mar 11 2008 Adam Goode <agoode@fedoraproject.org> - 7.14.0-1
- New release - Remove GCC 4.3 patch (upstream)

* Sat Feb 09 2008 Adam Goode <agoode@fedoraproject.org> - 7.12.5-5
- Fix GCC 4.3 build

* Sat Feb 09 2008 Adam Goode <agoode@fedoraproject.org> - 7.12.5-4
- GCC 4.3 mass rebuild

* Wed Oct 24 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.5-3
- Eliminate build differences in version.h to work on multiarch

* Tue Oct 16 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.5-2
- Rebuild for OpenEXR update

* Sat Sep 22 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.5-1
- New upstream release

* Fri Aug 17 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.4-4
- Add Conflicts for doc - Update doc package description

* Fri Aug 17 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.4-3
- license, new upstream, stricter versioned requires

* Fri Aug 17 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.4-2
- licensing update

* Tue Jul 31 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.4-1
- new release

* Wed Jul 25 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.2-1
- new version

* Sun May 06 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.0-3
- fix changelog date

* Sat May 05 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.0-2
- fixup build deps

* Fri May 04 2007 Adam Goode <agoode@fedoraproject.org> - 7.12.0-1
- new release

* Fri Sep 01 2006 Adam Goode <agoode@fedoraproject.org> - 7.10.21-2
- rebuilt

* Fri Sep 01 2006 Adam Goode <agoode@fedoraproject.org> - 7.10.21-1
- new upstream

* Sun Aug 27 2006 Ville Skyttä <scop@fedoraproject.org> - 7.10.20-7
- http://fedoraproject.org/wiki/Extras/Schedule/FC6MassRebuild

* Fri Jul 28 2006 Adam Goode <agoode@fedoraproject.org> - 7.10.20-6
- fix patch for automake

* Thu Jul 27 2006 Adam Goode <agoode@fedoraproject.org> - 7.10.20-5
- auto-import vips-7.10.20-2 on branch devel from vips-7.10.20-2.src.rpm

* Fri Aug 12 2011 Adam Goode <adam@spicenitz.org> - 7.24.7-4
- Clean up Requires and BuildRequires

* Fri Aug 12 2011 Adam Goode <adam@spicenitz.org> - 7.24.7-3
- Clean up Requires/BuildRequires

* Fri Aug 12 2011 Adam Goode <adam@spicenitz.org> - 7.24.7-2
- Update gitignore

* Thu Aug 11 2011 Adam Goode <adam@spicenitz.org> - 7.24.7-1
- New version

* Tue Feb 15 2011 Adam Goode <adam@spicenitz.org> - 7.24.2-1
- 7.24.2

* Tue Feb 08 2011 Dennis Gilmore <dennis@ausil.us> - 7.22.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Wed Sep 29 2010 Jesse Keating <jkeating@redhat.com> - 7.22.2-3
- Rebuilt for gcc bug 634757

* Sun Sep 19 2010 Tom "spot" Callaway <tcallawa@redhat.com> - 7.22.2-2
- rebuild for new ImageMagick
...
* Sun Aug 27 2006 Ville Skyttä <scop@fedoraproject.org> - 7.10.20-3
- http://fedoraproject.org/wiki/Extras/Schedule/FC6MassRebuild

* Fri Jul 28 2006 Adam Goode <agoode@fedoraproject.org> - 7.10.20-2
- fix patch for automake

* Thu Jul 27 2006 Adam Goode <agoode@fedoraproject.org> - 7.10.20-1
- auto-import vips-7.10.20-2 on branch devel from vips-7.10.20-2.src.rpm
