...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.1.1^20251205git3ded00c-2
- Uncommitted changes

* Tue May 26 2026 Davide Cavalca <dcavalca@fedoraproject.org> - 1.1.1^20251205git3ded00c-1
- Update to git snapshot 3ded00c

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.1^20240915git0b1b233-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.1^20240915git0b1b233-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Apr 10 2025 Davide Cavalca <dcavalca@fedoraproject.org> - 1.1.1^20240915git0b1b233-5
- Update URL; Fixes: RHBZ#2358689

* Wed Apr 02 2025 Davide Cavalca <dcavalca@fedoraproject.org> - 1.1.1^20240915git0b1b233-4
- Take ownership of /var/lib/lockdown and add compat sysusers macros

* Tue Feb 11 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 1.1.1^20240915git0b1b233-3
- Add sysusers.d config file to allow rpm to create users/groups
  automatically

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.1^20240915git0b1b233-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sun Sep 29 2024 Davide Cavalca <dcavalca@fedoraproject.org> - 1.1.1^20240915git0b1b233-1
- Update to git snapshot 0b1b233
