...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.9.1-35
- test: add initial lock files

* Thu Sep 04 2025 Jiri Vanek <jvanek@redhat.com> - 2.9.1-34
- manual bodhi update for jdk25 needed on selected pkgs

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 2.9.1-33
- Rebuilt for java-25-openjdk as preffered jdk

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.1-32
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.9.1-31
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.9.1-30
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.9.1-29
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.9.1-28
- Remove javadoc subpackage

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.1-27
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.9.1-25
