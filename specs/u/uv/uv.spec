...
* Mon Apr 06 2026 azldev <> - 0.10.4-2
- Latest state for uv
...
* Thu Oct 16 2025 Gordon Messmer <gordon.messmer@gmail.com> - 0.8.20-181
- Use rpm's native resource tunable to limit parallelism.

* Mon Sep 29 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Sun Sep 28 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.8.17
...
* Tue Sep 02 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Rebuilt with rust-tracing-subscriber-0.3.20
- Fixes CVE-2025-58160: fixes RHBZ#2392055, fixes RHBZ#2392012, fixes
  RHBZ#2391975

* Sat Aug 16 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Wed Aug 13 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.8.9 (close RHBZ#2387762)

* Sat Aug 09 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.8.8 (close RHBZ#2387194)

* Sat Aug 09 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.8.6

* Wed Aug 06 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.8.5 (close RHBZ#2386647)

* Thu Jul 31 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Sat Jul 19 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.22

* Wed Jul 16 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.21 (close RHBZ#2379944)

* Thu Jul 10 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.20 (close RHBZ#2379147)

* Tue Jul 08 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Skip one test on s390x for now

* Tue Jul 08 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Follow upstream in using the jemalloc allocator

* Mon Jul 07 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Sat Jun 28 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Thu Jun 26 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Wed Jun 25 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Allow which 8

* Fri Jun 20 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- No longer allow nix 0.29

* Wed Jun 18 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- No longer allow goblin 0.9

* Fri Jun 13 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.13 (close RHBZ#2372605)

* Tue Jun 10 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Unpin reqwest since we will coordinate updates to avoid regressions

* Mon Jun 09 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Sat May 31 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.9 (close RHBZ#2369514)

* Thu May 29 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Skip python_list::python_list_downloads on less-common architectures

* Wed May 28 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- No longer need to skip several `help::*` tests

* Wed May 28 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Enable integration tests in Fedora

* Sun May 25 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.8 (close RHBZ#2368123)

* Tue May 20 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.6 (close RHBZ#2367417)

* Sat May 17 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.5 (close RHBZ#2362372)

* Sat May 17 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.4

* Fri May 16 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.3

* Tue May 13 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.7.2
...
* Mon May 05 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.17

* Fri Apr 25 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update ron to 0.10

* Tue Apr 22 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.16 (close RHBZ#2361555)

* Mon Apr 14 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Stop allowing etcetera 0.8

* Mon Apr 14 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Remove a test skip that was a workaround for url 2.5.2

* Fri Apr 11 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Patch bundled pubgrub/version-ranges fork for ron 0.9.0 final

* Fri Apr 11 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Rebuilt with rust-idna 1.x

* Thu Apr 10 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.14 (close RHBZ#2358763)

* Tue Apr 08 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.13 (close RHBZ#2358064)

* Fri Apr 04 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Thu Apr 03 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.10

* Sat Mar 22 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Stop patching the forked async-zip for zip 0.6; use zip 2

* Fri Mar 21 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.9 (close RHBZ#2353965)

* Wed Mar 19 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.8 (close RHBZ#2353281)

* Tue Mar 18 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.7 (close RHBZ#2353121)

* Wed Mar 12 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.6 (close RHBZ#2351456)

* Mon Mar 10 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Drop patch that allowed mailparse 0.15.x (we now have 0.16.x)

* Mon Mar 10 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.5 (close RHBZ#2350517)

* Tue Mar 04 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.4 (close RHBZ#2349718)

* Sun Mar 02 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Make the CI test for disabling Python auto-installation more robust

* Fri Feb 28 2025 Lumir Balhar <lbalhar@redhat.com>
- [test] Add some basic smoke tests

* Thu Feb 27 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Backport vendoring of r-shquote unquote implementation

* Tue Feb 25 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.3 (close RHBZ#2347458)

* Thu Feb 20 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.2 (close RHBZ#2345851)

* Thu Feb 20 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.1

* Tue Feb 18 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.6.0

* Thu Feb 13 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.31 (close RHBZ#2345448)

* Wed Feb 12 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Sun Feb 09 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Rebuilt with rust-astral-tokio-tar 0.5.1

* Fri Feb 07 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.29 (close RHBZ#2344126)

* Wed Feb 05 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.28 (close RHBZ#2343881)

* Tue Feb 04 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.1.27 (close RHBZ#2343669)

* Fri Jan 31 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.26 (close RHBZ#2343108)

* Wed Jan 29 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.25 (close RHBZ#2342713)

* Fri Jan 24 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.24 (close RHBZ#2341672)

* Fri Jan 24 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.23

* Tue Jan 21 2025 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Thu Jan 09 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.16 (close RHBZ#2336058)

* Wed Jan 08 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.15

* Thu Jan 02 2025 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.14 (close RHBZ#2335339)

* Sun Dec 29 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.13 (close RHBZ#2334581)

* Fri Dec 27 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.12 (close RHBZ#2334267)

* Mon Dec 23 2024 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Fri Dec 20 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Stop allowing older versions of the procfs and which crates

* Wed Dec 18 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Make the backoff crate dependency Windows-only

* Mon Dec 09 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Follow upstream in using zlib-rs instead of zlib-ng

* Sun Dec 08 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.7 (close RHBZ#2330950)

* Wed Dec 04 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.6 (close RHBZ#2330247)

* Sun Dec 01 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- No longer patch to allow thiserror 1.x

* Thu Nov 28 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Revert "Backport a path-escaping fix for the batch activation script"

* Wed Nov 27 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.5 (close RHBZ#2329188)

* Wed Nov 27 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Backport a path-escaping fix for the batch activation script

* Thu Nov 21 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.4 (close RHBZ#2327512)

* Thu Nov 21 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.3

* Tue Nov 19 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Stop loosening the mailparse dependency version bound

* Mon Nov 18 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.2 (close RHBZ#2323792)

* Sat Nov 16 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.1

* Sat Nov 16 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.5.0

* Thu Nov 14 2024 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Tue Nov 12 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Backport commit to unbundle reqwest-middleware/reqwest-retry

* Mon Nov 11 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.30

* Sun Nov 10 2024 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Thu Oct 31 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.29

* Tue Oct 29 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.28

* Mon Oct 28 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.27

* Fri Oct 25 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.26 (close RHBZ#2321691)

* Mon Oct 21 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.25

* Fri Oct 18 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.24 (close RHBZ#2319248)

* Fri Oct 18 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.23

* Thu Oct 17 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.22

* Thu Oct 17 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.21

* Fri Oct 11 2024 Benjamin A. Beasley <code@musicinmybrain.net>
...
* Thu Oct 10 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.17
...
* Wed Sep 25 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.16

* Sun Sep 22 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.15 (close RHBZ#2314073)

* Fri Sep 13 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.10

* Wed Sep 11 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.9 (close RHBZ#2311362)

* Wed Sep 11 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.8

* Sun Sep 08 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.7

* Fri Sep 06 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.6 (close RHBZ#2310414)

* Thu Sep 05 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.5

* Wed Sep 04 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.4 (close RHBZ#2309685)

* Sun Sep 01 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.2

* Sat Aug 31 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.1

* Thu Aug 29 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.4.0

* Wed Aug 28 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.3.5

* Tue Aug 27 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Increase per-process memory allowance when building

* Tue Aug 27 2024 Benjamin A. Beasley <code@musicinmybrain.net>
- Update to 0.3.4

* Mon Aug 26 2024 Benjamin A. Beasley <code@musicinmybrain.net>
