...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.41.5-2
- Uncommitted changes

* Tue Jun 16 2026 Karel Zak <kzak@redhat.com> - 2.41.5-1
- upgrade to upstream release v2.41.5

* Wed May 20 2026 Karel Zak <kzak@redhat.com> - 2.41.4-8
- backport lastlog2 fixes from upstream
- fix pam_lastlog2 libpam linking (rhbz#2453457)
- wait on busy SQLite connections (rhbz#2419509)

* Wed Apr 01 2026 Karel Zak <kzak@redhat.com> - 2.41.4-7
- upgrade to upstream release v2.41.4

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.41.3-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Jan 12 2026 Nuo Cheng <zhanhb88@gmail.com> - 2.41.3-11
- Update util-linux-su.pamd

* Mon Jan 12 2026 Karel Zak <kzak@redhat.com> - 2.41.3-10
...
* Mon Dec 15 2025 Karel Zak <kzak@redhat.com> - 2.41.3-8
- add completition bits blkpr lsfd

* Mon Dec 15 2025 Karel Zak <kzak@redhat.com> - 2.41.3-7
- upgrade to upstream release v2.41.3

* Tue Dec 02 2025 Karel Zak <kzak@fedoraproject.org> - 2.41.2-9
