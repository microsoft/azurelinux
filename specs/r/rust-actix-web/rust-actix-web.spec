...
%package     -n %{name}+experimental-introspection-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+experimental-introspection-devel %{_description}

This package contains library source intended for building other packages which
use the "experimental-introspection" feature of the "%{crate}" crate.

%files       -n %{name}+experimental-introspection-devel
%ghost %{crate_instdir}/Cargo.toml
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.13.0-2
- Uncommitted changes

* Tue Mar 24 2026 Fabio Valentini <decathorpe@gmail.com> - 4.13.0-1
- Update to version 4.13.0; Fixes RHBZ#2440572
