...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.5.8-2
- Uncommitted changes

* Tue May 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.5.8-1
- Update to version 2.5.8; Fixes RHBZ#2427242

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.5.7-2
