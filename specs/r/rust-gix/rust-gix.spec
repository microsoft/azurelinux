...
%package     -n %{name}+blocking-http-transport-curl-openssl-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+blocking-http-transport-curl-openssl-devel %{_description}

This package contains library source intended for building other packages which
use the "blocking-http-transport-curl-openssl" feature of the "%{crate}" crate.

%files       -n %{name}+blocking-http-transport-curl-openssl-devel
%ghost %{crate_instdir}/Cargo.toml
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.85.0-2
- Uncommitted changes

* Mon Jul 06 2026 blinxen <h-k-81@hotmail.com> - 0.85.0-1
- Update to version 0.85.0 (rhbz#2481323)

* Sun May 17 2026 blinxen <h-k-81@hotmail.com> - 0.83.0-1
- Update to version 0.83.0

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.75.0-2
