...
* Mon Aug 17 2026 Autumn Nash <autumnnash@microsoft.com> - 0.9.1-2
- feat(zip-prereqs): bump aes/const-
  oid/digest/hmac/md-5/pbkdf2/sha1/sha2/streebog + compat packages,
  proptest

* Mon Jun 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.9.1-1
- Update to version 0.9.1; Fixes RHBZ#2457288

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.8.4-8
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.8.4-6
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.8.4-5
