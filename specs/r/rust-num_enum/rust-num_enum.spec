...
# * Omit renamed_num_enum integration test, which relies on files that are not
#   shipped with the crate.
# * Omit trybuild tests, which are brittle across Rust compiler versions
Patch:          num_enum-fix-metadata.diff
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.7.6-2
- Uncommitted changes

* Mon May 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.7.6-1
- Update to version 0.7.6; Fixes RHBZ#2184166

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.11-7
