...
# * omit doctests that require data files not included in published crates
# * skipping is not enough; these use include_bytes!() and wouldn’t compile
Patch10:        tiff-0.11.3-doctests-workspace.patch
...
# * one lib test must be skipped for the same reason
%cargo_test -- --lib -- --exact --skip decoder::tests::equivalence_of_tag_readers
%cargo_test -- --doc
%endif

%changelog
## START: Generated by rpmautospec
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.11.3-2
- Uncommitted changes

* Fri Apr 17 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.3-1
- Update to version 0.11.3; Fixes RHBZ#2427269
