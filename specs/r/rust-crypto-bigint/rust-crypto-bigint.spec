...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.7.5-2
- Uncommitted changes

* Tue Aug 04 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.7.5-1
- Update to version 0.7.5; Fixes RHBZ#2339697

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.5-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.5.5-7
