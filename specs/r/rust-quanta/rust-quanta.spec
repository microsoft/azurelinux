...
# * Remove criterion dependency (benchmark only)
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.12.6-5
- Uncommitted changes

* Thu Apr 16 2026 Cristian Le <git@lecris.dev> - 0.12.6-4
- Rebuild for prost-0.14
- Remove the tomcli patching
