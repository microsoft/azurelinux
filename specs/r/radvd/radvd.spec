...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.21-2
- Uncommitted changes

* Wed Jun 24 2026 Martin Osvald <mosvald@redhat.com> - 2.21-1
- New version v2.21

* Thu Jan 29 2026 Martin Osvald <mosvald@redhat.com> - 2.20-8
- radvd.spec: Fix URL and add source code verification

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.20-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.20-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jul 22 2025 František Hrdina <fhrdina@redhat.com> - 2.20-5
- Update of fmf plans and gating.yaml

* Thu Feb 27 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 2.20-4
- Avoid libbsd dependency

* Wed Feb 26 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.20-3
- Drop call to %%sysusers_create_compat

* Wed Jan 22 2025 Petr Dancak <pdancak@redhat.com> - 2.20-1
- Update to 2.20 (#2335043)
- Added requirement for libbsd-devel, because strlcpy is used

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.19-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.19-14
