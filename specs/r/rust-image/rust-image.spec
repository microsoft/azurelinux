...
Patch3: image-drop-avif-features.patch
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.25.9-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.25.9-5
- build: mass rebuild auto-bumpable components

* Thu Jul 30 2026 Thien Trung Vuong <tvuong@microsoft.com> - 0.25.9-4
- fix(rust-image): drop avif/avif-native features to remove rav1e and dav1d
  deps

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.25.9-3
