...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 8.0.2-5
- feat(render): convert static changelogs to interleaved releases for r*
  components

* Tue May 12 2026 reuben olinsky <reubeno@users.noreply.github.com> - 8.0.2-4
- refactor(rubygem-activestorage): drop ffmpeg/ffprobe BRs, Suggests, and
  tests
