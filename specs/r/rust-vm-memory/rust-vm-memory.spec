...
%package     -n %{name}+rawfd-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+rawfd-devel %{_description}

This package contains library source intended for building other packages which
use the "rawfd" feature of the "%{crate}" crate.

%files       -n %{name}+rawfd-devel
%ghost %{crate_instdir}/Cargo.toml
...
* Mon May 18 2026 Sergio Lopez <slp@redhat.com> - 0.17.1-1
