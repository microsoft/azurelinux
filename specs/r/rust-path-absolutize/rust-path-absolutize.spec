...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.0.1-2
- Uncommitted changes

* Mon Aug 03 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.0.1-1
- Update to version 4.0.1; Fixes RHBZ#2499398

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.1-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.1-7
