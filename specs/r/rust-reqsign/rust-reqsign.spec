...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.20.2-2
- Uncommitted changes

* Sat Jul 11 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.20.2-1
- Update to version 0.20.2; Fixes RHBZ#2499036

* Tue Jun 09 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.20.1-1
- Update to version 0.20.1; Fixes RHBZ#2483695

* Mon Mar 30 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.20.0-2
- Enable the volcengine feature, and restore the full reature

* Tue Mar 24 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.20.0-1
- Update to version 0.20.0; Fixes RHBZ#2432770

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.18.1-7
