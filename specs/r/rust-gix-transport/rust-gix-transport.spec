...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.57.2-2
- Uncommitted changes

* Mon Jul 06 2026 blinxen <h-k-81@hotmail.com> - 0.57.2-1
- Update to version 0.57.2 (rhbz#2481378)

* Sun May 17 2026 blinxen <h-k-81@hotmail.com> - 0.57.0-1
- Update to version 0.57.0

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.50.0-2
