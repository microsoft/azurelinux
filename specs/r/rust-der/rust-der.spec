...
* Fri Sep 18 2026 Unknown User <please-configure-git-user@example.com> - 0.8.0-3
- Uncommitted changes

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.8.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 29 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.8.0-1
- Update to version 0.8.0; Fixes RHBZ#2439740

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.7.10-4
