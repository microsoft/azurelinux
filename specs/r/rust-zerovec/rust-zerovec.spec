...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.11.8-2
- Uncommitted changes

* Sat Aug 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.8-1
- Update to version 0.11.8; Fixes RHBZ#2515915

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.11.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sun Apr 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.6-1
- Update to version 0.11.6; Fixes RHBZ#2453890
