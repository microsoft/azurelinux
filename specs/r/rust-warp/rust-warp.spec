...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.3.7-8
- Uncommitted changes

* Wed Jun 10 2026 Fabio Valentini <decathorpe@gmail.com> - 0.3.7-7
- Drop example-only handlebars dev-dependency

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.3.7-6
