...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.27.0-4
- feat(render): convert static changelogs to interleaved releases for r*
  components

* Mon May 04 2026 Chris Co <chrco@microsoft.com> - 5.27.0-3
- feat(rubygem-minitest-mock): import new component from Fedora f43
