...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.11.0-7
- Uncommitted changes

* Sat Jul 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.0-6
- Update dev-dependency astral_async_zip to 0.0.20

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.11.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.0-4
- Exclude release-plz.toml from the crate

* Wed Jun 03 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.0-3
...
* Tue Mar 31 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.11.0-1
- Update to version 0.11.0; Fixes RHBZ#2453415
