...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1:8.0.2-5
- feat(render): convert static changelogs to interleaved releases for r*
  components

* Mon May 11 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1:8.0.2-4
- rubygem-{actionpack,actiontext,selenium-webdriver}: drop chromium
  BuildRequires

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1:8.0.2-3
