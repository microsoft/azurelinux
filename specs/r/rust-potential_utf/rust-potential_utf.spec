...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.1.6-2
- Uncommitted changes

* Tue Aug 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.1.6-1
- Update to version 0.1.6; Fixes RHBZ#2515906

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.1.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sun Apr 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.1.5-1
- Update to version 0.6.3; Fixes RHBZ#2453953
