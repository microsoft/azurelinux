...
* Fri Sep 18 2026 Unknown User <please-configure-git-user@example.com> - 0.1.7-3
- Uncommitted changes

* Fri Jul 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.1.7-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sun Apr 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.1.7-1
- Update to version 0.1.7; Fixes RHBZ#2453885
