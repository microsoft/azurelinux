...
%define profiler %{clang_lib}/%{_target_platform}/libclang_rt.profile.a
test -r "%{profiler}"

# llvm < 21 does not provide a builtins library for s390x.
%if "%{_arch}" != "s390x" || 0%{?clang_major_version} >= 21
%define optimized_builtins %{clang_lib}/%{_target_platform}/libclang_rt.builtins.a
...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.94.1-5
