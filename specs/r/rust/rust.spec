...
%build
%define compiler_rt_libdir $(dirname "$(find %{clang_lib} -type f -name libclang_rt.profile.a -print -quit)")
%{export_rust_env}
...
%configure --disable-option-checking \
  ...
  --release-description="%{dist_name} %{version}-%{release}"
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.94.1-7
- build: mass rebuild auto-bumpable components

* Mon Aug 10 2026 Tobias Brick <tobiasb@microsoft.com> - 1.94.1-6
- fix(rust): brand rustc release-description as Azure Linux

* Tue Jul 28 2026 Rachel Menge <rachelmenge@microsoft.com> - 1.94.1-5
- fix(rust): discover bootstrap compiler-rt runtime path

* Wed May 13 2026 Rachel Menge <rachelmenge@microsoft.com> - 1.94.1-4
- fix(rust): use target platform for compiler-rt runtimes

* Sat May 09 2026 Thien Trung Vuong <tvuong@microsoft.com> - 1.94.1-3
- build: disable mingw subpackages via spec overlays

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.94.1-2
