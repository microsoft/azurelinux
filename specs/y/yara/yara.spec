...
* Thu Sep 24 2026 Dan Streetman <ddstreet@ieee.org> - 4.5.7-3
- chore(various): remove all source tarball customization

* Fri Sep 18 2026 Dan Streetman <ddstreet@ieee.org> - 4.5.7-2
- chore: update 'lock' files

* Wed Jun 03 2026 Michal Ambroz <rebus@seznam.cz> - 4.5.7-1
- bump yara to 4.5.7

* Thu May 07 2026 Michal Ambroz <rebus@seznam.cz> - 4.5.6-1
- yara bump to 4.5.6

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.5.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sun Nov 16 2025 Michal Ambroz <rebus@seznam.cz> - 4.5.5-1
- bump to 4.5.5

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.5.4-8
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.5.4-7
- build: mass rebuild auto-bumpable components
