...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.1.0-41
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.0-40
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 09 2026 Cristian Le <git@lecris.dev> - 2.1.0-39
- Allow to build with CMake 4.0 (rhbz#2381648)
