...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 6.10.0-7
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.10.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.10.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 6.10.0-4
- Rebuilt for java-25-openjdk as preffered jdk

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.10.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 17 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.10.0-2
- Update tests for version 6.10.0

* Thu Jul 17 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.10.0-1
- Update to upstream version 6.10.0

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-16
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-15
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-14
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-13
- Remove javadoc subpackage

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.8.1-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-11
- Switch upstream URL to https

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-9
- Update javapackages test plan to f42

* Tue Sep 03 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.8.1-8
- Use %%autosetup -C
