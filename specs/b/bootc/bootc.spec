...
* Fri Sep 25 2026 IzanVil <soyoquienmas@outlook.com> - 1.13.0-5
- fix(bootc): require bubblewrap for bootc install

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.13.0-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.13.0-3
- build: mass rebuild auto-bumpable components
