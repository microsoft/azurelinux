...
* Mon Sep 14 2026 Nan Liu <liunan@microsoft.com> - 4.0.26-6
- fix(java): use Microsoft OpenJDK 25 across consumers

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.0.26-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.0.26-4
- build: mass rebuild auto-bumpable components
