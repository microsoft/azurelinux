...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.17.7-4
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.17.7-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.17.7-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Sep 23 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.7-1
- Update to upstream version 1.17.7
