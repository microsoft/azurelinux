...
sed -i 's|/usr/lib/jvm/jre-25-openjdk|/usr/lib/jvm/msopenjdk-25|' %{buildroot}%{_bindir}/ecj
%files -f .mfiles
%license about.html
%{_bindir}/ecj
%{_mandir}/man1/ecj*
...
* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:4.23-12
