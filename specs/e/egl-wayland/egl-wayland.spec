...
* Fri Sep 18 2026 Unknown User <please-configure-git-user@example.com> - 1.1.21-4
- Uncommitted changes

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.21-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.21-2
