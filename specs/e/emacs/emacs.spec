...
%{load:%{_sourcedir}/emacs.azl.macros}
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1:30.2-11
- Uncommitted changes

* Tue Aug 25 2026 Peter Oliver <git@mavit.org.uk> - 1:30.2-10
- Fix CVE-2026-77219: Integer overflow in PBM/PPM/PGM image loader
  (rhbz#2523273)

* Fri Aug 07 2026 Peter Oliver <git@mavit.org.uk> - 1:30.2-9
- Remember to include patch.

* Fri Aug 07 2026 Peter Oliver <git@mavit.org.uk> - 1:30.2-8
