...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.12.0-3
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.12.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Aug 20 2025 Vitaly <vitaly@easycoding.org> - 3.12.0-1
- Updated to version 3.12.0. Fixes RHBZ#2359066.
