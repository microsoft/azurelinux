...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1:0.11b-62
- test: add initial lock files

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 1:0.11b-61
- Rebuilt for java-25-openjdk as preffered jdk

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.11b-60
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Jul 16 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-59
- Regenerate tarball from git repo

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-58
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-57
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-56
- Switch to javapackages tests from CentOS Stream GitLab

* Wed Mar 05 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-55
- Fix javadoc obsoletes version

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-54
- Remove javadoc subpackage

* Tue Feb 18 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-53
- Use %%jar macro

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:0.11b-52
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-51
- Switch upstream URL to https

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 1:0.11b-46
