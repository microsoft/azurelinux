...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 5.13.3-6
- Uncommitted changes

* Fri Jan 23 2026 Marian Koncek <mkoncek@redhat.com> - 5.13.3-5
- Add missing univocity-parsers runtime launcher dependency

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 5.13.3-4
