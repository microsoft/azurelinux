...
%{load:%{_sourcedir}/json-c.azl.macros}
...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.18-11
- feat(render): convert static changelogs to interleaved releases for j*
  components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 0.18-10
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.18-9
