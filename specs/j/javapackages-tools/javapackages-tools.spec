...
%package -n maven-local-msopenjdk25
Summary:        Macros and scripts for Maven packaging with Microsoft OpenJDK 25
Requires:       msopenjdk-25
Requires:       %{name} = %{version}-%{release}
Requires:       javapackages-local-msopenjdk25 = %{version}-%{release}
Requires:       xmvn-minimal
Requires:       xmvn-toolchain-msopenjdk25
Requires:       mvn(org.fedoraproject.xmvn:xmvn-mojo)
Requires:       mvn(org.apache.maven.plugins:maven-compiler-plugin)
Requires:       mvn(org.apache.maven.plugins:maven-jar-plugin)
Requires:       mvn(org.apache.maven.plugins:maven-resources-plugin)
...
%description -n maven-local-msopenjdk25
This package provides macros and scripts to support packaging Maven artifacts
with Microsoft OpenJDK 25.

%package -n javapackages-local-msopenjdk25
Summary:        Non-essential Java packaging support for Microsoft OpenJDK 25
Requires:       javapackages-common = %{version}-%{release}
Requires:       xmvn-tools
Requires:       msopenjdk-25
Requires:       xmvn-generator
Requires:       (ant-msopenjdk25 if ant)

%description -n javapackages-local-msopenjdk25
This package provides non-essential macros and scripts to support Java packaging
with Microsoft OpenJDK 25.
%prep
%autosetup -p1 -C
...
%configure --pyinterpreter=%{python_interpreter} \
    ...
    --jvm=msopenjdk25=%{_jvmdir}/msopenjdk-25
./build
...
%files -n javapackages-local-msopenjdk25 -f files-local-msopenjdk25

%files -n maven-local-msopenjdk25
...
* Thu Sep 10 2026 Nan Liu <liunan@microsoft.com> - 6.4.1-8
- feat(java): add Microsoft OpenJDK 25 bindings

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6.4.1-7
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6.4.1-6
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.4.1-5
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 6.4.1-4
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 6.4.1-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.4.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jul 04 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.1-1
- Update to upstream version 6.4.1

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 6.4.0-8
- Rebuilt for Python 3.14

* Fri Apr 04 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.0-7
- Add OpenJDK 25 bindings

* Mon Mar 24 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.0-6
- Use tests from CentOS Stream GitLab

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.4.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sun Nov 24 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.0-4
- Drop JRE 21 fallback patch

* Sun Nov 24 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.0-3
- Drop JRE 21 fallback patch

* Sat Nov 23 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.0-2
- Add maven-local dependency on xmvn-toolchain

* Fri Nov 22 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.4.0-1
- Update to upstream version 6.4.0

* Wed Nov 20 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.4-4
- Revert "Ensure that maven-openjdk21 is used with maven-local-openjdk21"

* Mon Nov 18 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.4-3
- Ensure that maven-openjdk21 is used with maven-local-openjdk21

* Wed Oct 30 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.4-2
- jp-local-openjdk21 should conditionally require ant-openjdk21

* Thu Oct 10 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.4-1
- Update to upstream version 6.3.4
- Resolves: rhbz#2317773

* Mon Oct 07 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.3-1
- Update to upstream version 6.3.3
- Resolves: rhbz#2317032

* Fri Oct 04 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.2-1
- Update to upstream version 6.3.2
- Resolves: rhbz#2316487

* Mon Sep 30 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.1-1
- Update to upstream version 6.3.1
- Resolves: rhbz#2315591

* Fri Sep 27 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.0-2
- Fall back to JRE 21 until all packages explicitly set JAVA_HOME

* Fri Sep 27 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.3.0-1
- Update to upstream version 6.3.0
- Resolves: rhbz#2315221

* Tue Sep 24 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.2.0-30
- Disable osgi requires

* Tue Sep 24 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.2.0-29
- Use asciidoctor instead of asciidoc

* Fri Sep 06 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.2.0-28
- Remove maven-local toolchains for Java 8, 11, 17

* Tue Aug 27 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.2.0-27
- Enable XMvn dependency generator

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 6.2.0-14
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 6.2.0-13
- Rebuilt for Python 3.13

* Fri May 31 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 6.2.0-12
- Fix incompatibility with RPM 4.20
- Resolves: rhbz#2283795

* Thu May 23 2024 Marian Koncek <mkoncek@redhat.com> - 6.2.0-11
- Drop generated Requires on JRE
- Change: https://fedoraproject.org/wiki/Changes/Drop_Mandatory_Requires_on_JRE
