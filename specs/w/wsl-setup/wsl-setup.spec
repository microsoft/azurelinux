...
%post
# Generate the distribution config with the Azure Linux name and icon
%{_bindir}/wsl-setup --name "AzureLinux-4.0-BETA" --icon %{_datadir}/pixmaps/azurelinux-logo.ico
...
* Mon Aug 24 2026 Muhammad Falak R Wani <falakreyaz@gmail.com> - 1.0.1-15
- feat(wsl-setup): use Azure Linux name and branding for WSL registration

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.0.1-14
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.0.1-13
- build: mass rebuild auto-bumpable components
