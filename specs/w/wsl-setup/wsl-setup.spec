...
* Wed Jan 21 2026 Jeremy Bertozzi <jeremy.bertozzi@gmail.com> - 1.0.1-16
...
* Tue Oct 21 2025 Troy Dawson <tdawson@redhat.com> - 1.0.1-14
- Fix ghost file permissions

* Tue Oct 14 2025 Li Tian <litian@redhat.com> - 1.0.1-13
- wsl-oobe.sh: Ask for re-input of username when error

* Tue Oct 14 2025 Li Tian <litian@redhat.com> - 1.0.1-12
- wsl-setup: fix --help|-h option error prompt
- -help|-h ought not to fall into error prompt.

* Tue Sep 23 2025 Li Tian <litian@redhat.com> - 1.0.1-11
- tmpfiles: not forcefully create symlink /tmp/.X11-unix
