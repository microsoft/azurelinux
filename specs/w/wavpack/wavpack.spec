...
%{load:%{_sourcedir}/wavpack.azl.macros}
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.8.1-7
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.8.1-6
- build: mass rebuild auto-bumpable components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 5.8.1-5
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.8.1-4
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.8.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 09 2025 psklenar@redhat.com <psklenar@redhat.com> - 5.8.1-2
- fedora CI plans move to gitlab for centos-stream test space
  https://issues.redhat.com/browse/RHELMISC-13073

* Mon Feb 10 2025 Sérgio M. Basto <sergio@serjux.com> - 5.8.1-1
- Update wavpack to 5.8.1 (#2338095)

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.7.0-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Oct 25 2024 Peter Lemenkov <lemenkov@gmail.com> - 5.7.0-10
- Remove CMake requirement for C++ compiler

* Tue Oct 22 2024 Peter Lemenkov <lemenkov@gmail.com> - 5.7.0-9
- Merge mingw32/64 package

* Tue Oct 22 2024 Peter Lemenkov <lemenkov@gmail.com> - 5.7.0-8
- Use common description block (prepare for Mingw merge)

* Tue Oct 22 2024 Peter Lemenkov <lemenkov@gmail.com> - 5.7.0-7
- Switch to cmake

* Tue Oct 22 2024 Peter Lemenkov <lemenkov@gmail.com> - 5.7.0-6
- No need to specify this dep

* Tue Oct 22 2024 Peter Lemenkov <lemenkov@gmail.com> - 5.7.0-5
- Cosmetic cleanups
