...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 15.0.1-3
- Uncommitted changes

* Wed May 27 2026 Neal Gompa <ngompa@fedoraproject.org> - 15.0.1-2
- Modernize spec and split out RDP/VNC backends and deprecated plugins
- Resolves: rhbz#2424275

* Mon Apr 27 2026 Erico Nunes <ernunes@redhat.com> - 15.0.1-1
- Update to 15.0.1

* Mon Apr 27 2026 Erico Nunes <ernunes@redhat.com> - 15.0.0-3
- Update summary and description

* Mon Apr 27 2026 Erico Nunes <ernunes@redhat.com> - 15.0.0-2
- Convert to %%autorelease and %%autochangelog

* Thu Feb 19 2026 Erico Nunes <ernunes@redhat.com> - 15.0.0-1
- Update to 15.0.0

* Wed Jan 28 2026 Aleksei Bavshin <alebastr@fedoraproject.org> - 14.0.2-4
...
* Thu Jul 18 2024 Septatrix <24257556+Septatrix@users.noreply.github.com> - 13.0.3-1
...
* Tue Apr 12 2022 Dave Olsthoorn <dave@bewaar.me> - 9.0.0-1
- Update to 9.0.0
...
* Wed Feb 19 2020 Pokorra, Gerd <pokorra@uni-siegen.de> - 8.0.0-3
- add requires mesa-dri-drivers

* Fri Feb 07 2020 Simone Caronni <negativo17@gmail.com> - 8.0.0-2
- Rebuild for updated FreeRDP

* Tue Jan 28 2020 gerd <gp@zimt.uni-siegen.de> - 8.0.0-1
- update to 8.0.0

* Mon Jan 20 2020 gerd <gp@zimt.uni-siegen.de> - 7.0.93-3
- increment the release

* Mon Jan 20 2020 gerd <gp@zimt.uni-siegen.de> - 7.0.93-2
- do the standard build

* Mon Jan 20 2020 gerd <gp@zimt.uni-siegen.de> - 7.0.93-1
- update to RC1 for weston 8.0

* Fri Sep 27 2019 gerd <gp@zimt.uni-siegen.de> - 7.0.0-5
- increment release number

* Fri Sep 27 2019 gerd <gp@zimt.uni-siegen.de> - 7.0.0-4
- Add and remove the group 'weston-launch' with the package in the post
  section

* Sun Sep 15 2019 Gerd Pokorra <gerd@fedoraproject.org> - 7.0.0-3
- Update weston.spec

* Sun Sep 15 2019 Gerd Pokorra <gerd@fedoraproject.org> - 7.0.0-2
- Update weston.spec

* Thu Sep 12 2019 gerd <gp@zimt.uni-siegen.de> - 7.0.0-1
- update to 7.0.0
...
* Mon Aug 13 2018 Kalev Lember <klember@redhat.com> - 4.0.93-2
- Fix files list
...
* Sat Jul 14 2018 Fedora Release Engineering <releng@fedoraproject.org> - 4.0.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Mon Jul 09 2018 Igor Gnatenko <ignatenko@redhat.com> - 4.0.0-2
- add BuildRequires: gcc

* Mon Apr 09 2018 Kalev Lember <klember@redhat.com> - 4.0.0-1
- Update to 4.0.0

* Tue Apr 03 2018 Kalev Lember <klember@redhat.com> - 3.0.93-3
- Build with FreeRDP 1.2

* Tue Apr 03 2018 Kalev Lember <klember@redhat.com> - 3.0.93-2
...
* Wed Jul 19 2017 Kalev Lember <klember@redhat.com> - 2.0.0-3
- Add an apiver define

* Thu Jul 13 2017 Adam Jackson <ajax@redhat.com> - 2.0.0-2
- Stop BuildRequiring cairo-gl. We install none of the additional demo
  clients it builds, and it's going away from the cairo package soon.

* Wed Jun 21 2017 Kalev Lember <klember@redhat.com> - 2.0.0-1
- Update to 2.0.0

* Wed Jun 21 2017 Kalev Lember <klember@redhat.com> - 1.12.0-12
- Use standard whitespace

* Tue Mar 21 2017 Simone Caronni <negativo17@gmail.com> - 1.12.0-11
- Lower the freerdp1.2 build requirements

* Tue Mar 21 2017 Simone Caronni <negativo17@gmail.com> - 1.12.0-10
- Update build requirements

* Tue Mar 21 2017 Simone Caronni <negativo17@gmail.com> - 1.12.0-9
- Build requirement compat-freerdp12 has been renamed to freerdp1.2

* Tue Mar 07 2017 Simone Caronni <negativo17@gmail.com> - 1.12.0-8
- libdrm-devel already provides intel libraries

* Tue Mar 07 2017 Simone Caronni <negativo17@gmail.com> - 1.12.0-7
- Fix typo

* Tue Mar 07 2017 Simone Caronni <negativo17@gmail.com> - 1.12.0-6
- Enable RDP again through FreeRDP 1.2 compatibility package

* Sat Mar 04 2017 Rex Dieter <rdieter@math.unl.edu> - 1.12.0-5
- %%build: --disable-silent-rules fix FTBFS: disable broken rpd support
  (#1424540) fix rpaths

* Sat Feb 11 2017 Fedora Release Engineering <releng@fedoraproject.org> - 1.12.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_Mass_Rebuild

* Wed Feb 01 2017 Sandro Mani <manisandro@gmail.com> - 1.12.0-3
- Rebuild (libwebp)

* Wed Sep 21 2016 Kalev Lember <klember@redhat.com> - 1.12.0-2
- Drop outdated BR versions
...
* Wed Aug 31 2016 Kalev Lember <klember@redhat.com> - 1.11.92-2
...
- Update to 1.11.91 and add a -libs subpackage for new libraries.
...
* Sat Apr 23 2016 Adam Williamson <awilliam@redhat.com> - 1.10.0-3
...
* Mon Dec 28 2015 Igor Gnatenko <i.gnatenko.brain@gmail.com> - 1.9.0-5
- Rebuilt for libwebp soname bump

* Fri Nov 20 2015 Kalev Lember <klember@redhat.com> - 1.9.0-4
- Rebuilt for freerdp soname bump

* Tue Sep 22 2015 Kalev Lember <klember@redhat.com> - 1.9.0-3
- Use make_install macro

* Tue Sep 22 2015 Kalev Lember <klember@redhat.com> - 1.9.0-2
- Remove old spec file conditionals
...
* Wed Sep 16 2015 Kalev Lember <klember@redhat.com> - 1.8.92-2
- Drop git snapshot handling

* Wed Sep 02 2015 Kalev Lember <klember@redhat.com> - 1.8.92-1
- Update to 1.8.92

* Wed Sep 02 2015 Kalev Lember <klember@redhat.com> - 1.8.91-3
...
* Fri Jun 19 2015 Dennis Gilmore <dennis@ausil.us> - 1.7.92-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_23_Mass_Rebuild

* Tue May 26 2015 Adam Jackson <ajax@redhat.com> - 1.7.92-2
- sources
...
* Tue Mar 10 2015 Peter Hutterer <peter.hutterer@who-t.net> - 1.7.0-2
- Rebuild for libinput soname bump

* Tue Feb 17 2015 Richard Hughes <richard@hughsie.com> - 1.7.0-1
- Update to 1.7.0

* Sun Jan 18 2015 Peter Hutterer <peter.hutterer@who-t.net> - 1.6.0-8
- Update to and require libinput 0.8

* Fri Jan 16 2015 Peter Hutterer <peter.hutterer@who-t.net> - 1.6.0-7
- Drop obsolete patch line

* Sat Dec 20 2014 Kevin Fenzi <kevin@scrye.com> - 1.6.0-6
- Rebuild for new freerdp

* Sun Sep 21 2014 Kalev Lember <kalevlember@gmail.com> - 1.6.0-5
- Install weston-launch as setuid root

* Sun Sep 21 2014 Kalev Lember <kalevlember@gmail.com> - 1.6.0-4
- Drop unneeded defattr lines

* Sun Sep 21 2014 Kalev Lember <kalevlember@gmail.com> - 1.6.0-3
...
* Fri Sep 12 2014 Peter Hutterer <peter.hutterer@who-t.net> - 1.5.91-2
- Rebuild for libinput soname bump

* Fri Aug 22 2014 Kevin Fenzi <kevin@scrye.com> - 1.5.91-1
- Update to 1.5.91

* Mon Aug 18 2014 Peter Robinson <pbrobinson@fedoraproject.org> - 1.5.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_22_Mass_Rebuild

* Sat Jul 19 2014 Kevin Fenzi <kevin@scrye.com> - 1.5.0-5
- Rebuild for new libfreerdp

* Sun Jun 15 2014 Lubomir Rintel <lkundrak@v3.sk> - 1.5.0-4
- Enable DBus support so that logind integration actually works

* Sun Jun 08 2014 Dennis Gilmore <dennis@ausil.us> - 1.5.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_Mass_Rebuild

* Tue May 27 2014 Dan Horák <dan@danny.cz> - 1.5.0-2
- libunwind available only on selected arches

* Wed May 21 2014 Richard Hughes <richard@hughsie.com> - 1.5.0-1
- Weston 1.5.0

* Tue May 13 2014 Richard Hughes <richard@hughsie.com> - 1.4.93-1
- Weston 1.4.93

* Mon Jan 27 2014 Adam Jackson <ajax@redhat.com> - 1.4.0-2
- Rebuild for new sonames in libxcb 1.10

* Fri Jan 24 2014 Richard Hughes <richard@hughsie.com> - 1.4.0-1
- Weston 1.4.0

* Mon Jan 20 2014 Richard Hughes <richard@hughsie.com> - 1.3.93-1
- Weston 1.3.93

* Tue Dec 17 2013 Richard Hughes <richard@hughsie.com> - 1.3.91-2
- Fix filelists

* Tue Dec 17 2013 Richard Hughes <richard@hughsie.com> - 1.3.91-1
- Weston 1.3.91
...
* Sun Aug 04 2013 Dennis Gilmore <dennis@ausil.us> - 1.2.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_20_Mass_Rebuild

* Mon Jul 15 2013 Richard Hughes <richard@hughsie.com> - 1.2.0-1
- Weston 1.2.0

* Wed May 15 2013 Richard Hughes <richard@hughsie.com> - 1.1.90-1
...
* Fri Feb 15 2013 Dennis Gilmore <dennis@ausil.us> - 1.0.3-3
...
* Tue Sep 18 2012 Thorsten Leemhuis <fedora@leemhuis.info> - 0.95.0-7
- add libXcursor-devel as BR

* Mon Sep 17 2012 Thorsten Leemhuis <fedora@leemhuis.info> - 0.95.0-6
- rebuild

* Mon Sep 17 2012 Thorsten Leemhuis <fedora@leemhuis.info> - 0.95.0-5
- update sources

* Mon Sep 17 2012 Thorsten Leemhuis <fedora@leemhuis.info> - 0.95.0-4
- update sources
...
- Update to 0.95.0
- enable xwayland
- make it easier to switch between a release and a git snapshot in spec
  file

* Sun Jul 22 2012 Dennis Gilmore <dennis@ausil.us> - 0.89-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_18_Mass_Rebuild

* Tue Jun 05 2012 Adam Jackson <ajax@redhat.com> - 0.89-2
- Rebuild for new libudev
- Conditional buildreq for libudev-devel

* Wed Apr 25 2012 Richard Hughes <richard@hughsie.com> - 0.89-1
