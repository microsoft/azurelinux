...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.17.1-2
- Uncommitted changes

* Mon Jul 06 2026 hydai <hydai@hyd.ai> - 0.17.1-1
- Release 0.17.1

* Thu Jun 25 2026 František Zatloukal <fzatlouk@redhat.com> - 0.17.0-2
- Rebuilt for fmt/spdlog

* Tue Jun 02 2026 hydai <hydai@hyd.ai> - 0.17.0-1
- Release 0.17.0
- Bump C API library version (capi_version) to 0.1.1
- Drop Patch0: Poller context refactor merged upstream in 0.17.0
  (WasmEdge/WasmEdge#4509)

* Thu Jan 29 2026 hydai <hydai@hyd.ai> - 0.16.1-1
- Release 0.16.1

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.0-5
