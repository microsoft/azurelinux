...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.6.6-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.6.6-3
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.6.6-2
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Mon Feb 23 2026 Petr Písař <ppisar@redhat.com> - 5.6.6-1
- 5.6.6 bump

* Mon Oct 13 2025 Petr Písař <ppisar@redhat.com> - 5.6.5-1
- 5.6.5 bump

* Tue Aug 12 2025 Petr Písař <ppisar@redhat.com> - 5.6.4-1
- 5.6.4 bump

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.6.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 09 2025 Petr Písař <ppisar@redhat.com> - 5.6.2-1
- 5.6.2 bump

* Sat Feb 01 2025 Björn Esser <besser82@fedoraproject.org> - 5.5.20-6
- Add explicit BR: libxcrypt-devel

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.5.20-5
