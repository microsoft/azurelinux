...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.18-54
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.18-53
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.18-52
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Wed Aug 13 2025 František Hrdina <fhrdina@redhat.com> - 3.18-51
- Update of fmf plans

* Wed Jul 30 2025 Peter Robinson <pbrobinson@gmail.com> - 3.18-50
- Own pkgconfig dirs to avoid unnecessary deps

* Wed Jul 30 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-49
- Run restorecon on /usr/sbin

* Wed Jul 30 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-48
- Create /usr/local/bin in %%pretrans scriptlet

* Wed Jul 30 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-47
- Allow merging of symlinks which point to same target in one more place

* Wed Jul 30 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-46
- Fix symlinking of files in /usr/sbin

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.18-45
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed May 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-44
- Also merge symlinks to /etc/alternatives

* Wed May 07 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-43
- When merging sbin, also accept symlinks to /usr/bin/foo

* Tue May 06 2025 Stephen Gallagher <sgallagh@redhat.com> - 3.18-41
- Create /usr/lib/swidtag

* Tue Apr 15 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-40
- Reword message about not being able to merge sbin

* Mon Mar 31 2025 David Abdurachmanov <davidlt@rivosinc.com> - 3.18-39
- Add lp64d symlink to parent directory on riscv64

* Thu Feb 06 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-38
- Obsolete basesystem package

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.18-36
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Jan 15 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-35
- Add forgotten %%verify(not mode) for /usr/local/sbin

* Wed Jan 15 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-34
- Do not verify mode of /usr/sbin

* Wed Jan 15 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-33
- Add more missing names for /usr/sbin symlinks
- Hopefully resolves issue with a missing symlink for /sbin/zfcpconf.sh
  required by dracut.

* Tue Jan 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-32
- Remove some leftover debug messages

* Tue Jan 14 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-31
- Add a few missing names for /usr/sbin symlinks on s390x

* Sun Jan 12 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-30
- Merge /usr/sbin and /usr/bin (2nd attempt)

* Sun Sep 15 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-29
- Make sure that the generator is only active on merged systems

* Sun Sep 15 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-28
- Make srpm-macros noarch

* Sat Sep 14 2024 Martin Osvald <mosvald@redhat.com> - 3.18-27
- Remove redundant license tags

* Tue Sep 10 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-26
- Create rpm Requires generator

* Tue Jul 23 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-25
- Add virtual Provides:filesystem(merged-sbin)

* Tue Jul 23 2024 Martin Osvald <mosvald@redhat.com> - 3.18-24
- Add ownership of /etc/default

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.18-23
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Wed Jul 17 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-22
- Disable sbin-merge changes

* Wed Jul 17 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-21
- Restore /usr/local/bin directory

* Sat Jul 13 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-20
- Move sbin filenames out to a file

* Sat Jul 13 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-18
- Create compat symlinks for more files

* Thu Jul 11 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-17
- Also create compat symlink for rndc-confgen

* Tue Jul 09 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-16
- Symlink /usr/sbin to /usr/bin if possible

* Wed Jun 19 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-15
- Symlink bin filenames to sbin for compatibility

* Wed Jun 19 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-14
- Merge /usr/sbin and /usr/bin

* Wed Jun 19 2024 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.18-13
