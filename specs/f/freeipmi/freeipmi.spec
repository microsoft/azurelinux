...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.6.15-6
- chore(lockfiles): update existing autochangelog packages to new lockfile
  format

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.6.15-5
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.6.15-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Feb 24 2025 Pavel Cahyna <pcahyna@redhat.com> - 1.6.15-3
- Add patch to fix FTBFS with GCC 15 / C23 (fedora#2340176)

* Mon Feb 17 2025 Pavel Cahyna <pcahyna@redhat.com> - 1.6.15-2
- Use https for Source

* Mon Feb 17 2025 Pavel Cahyna <pcahyna@redhat.com> - 1.6.15-1
- Update to 1.6.15 (fedora#2338311)

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.6.14-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.6.14-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Wed Apr 10 2024 Pavel Cahyna <pcahyna@redhat.com> - 1.6.14-2
