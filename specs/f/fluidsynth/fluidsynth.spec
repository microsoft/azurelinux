...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.5.2-4
- feat(render): convert static changelogs to interleaved releases for f*
  components

* Mon May 04 2026 Chris Co <chrco@microsoft.com> - 2.5.2-3
- fix(pkg): pin fluidsynth to pre-mass-rebuild commit
