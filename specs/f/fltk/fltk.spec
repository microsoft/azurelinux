...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.3.11-6
- feat(render): convert static changelogs to interleaved releases for f*
  components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 1.3.11-5
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.3.11-4
