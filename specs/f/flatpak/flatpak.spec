...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.18.1-3
- Uncommitted changes

* Mon Aug 24 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 1.18.1-2
- Add patches to fix Epiphany crashes

* Wed Aug 12 2026 David King <amigadave@amigadave.com> - 1.18.1-1
- Update to 1.18.1

* Mon Jun 08 2026 David King <amigadave@amigadave.com> - 1.18.0-1
- Update to 1.18.0 (#2466936)

* Wed May 06 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 1.17.7-1
- Update to 1.17.7

* Fri Apr 10 2026 Michael Catanzaro <mcatanzaro@gnome.org> - 1.17.6-1
- Update to 1.17.6

* Thu Apr 09 2026 Petr Schindler <pschindl@redhat.com> - 1.17.5-1
- Update to 1.17.5

* Wed Apr 08 2026 David King <amigadave@amigadave.com> - 1.17.4-1
- Update to 1.17.4 (#2456353)

* Fri Mar 20 2026 Milan Crha <mcrha@redhat.com> - 1.17.3-2
- Add patch to fix a crash in flatpak_context_make_sandboxed()

* Fri Mar 20 2026 Milan Crha <mcrha@redhat.com> - 1.17.3-1
- Update to 1.17.3

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.17.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Dec 18 2025 David King <dking@redhat.com> - 1.17.2-1
- Update to 1.17.2 (#2422342)

* Fri Nov 14 2025 Debarshi Ray <rishi@fedoraproject.org> - 1.17.0-1
- Update to 1.17.0 (#2412030)

* Thu Nov 13 2025 Tom spot Callaway <spotaws@amazon.com> - 1.16.1-13
- rebuild for new fuse3 (one more time)

* Wed Nov 12 2025 Debarshi Ray <rishi@fedoraproject.org> - 1.16.1-12
- Add empty /etc/flatpak/installations.d

* Wed Nov 12 2025 Debarshi Ray <rishi@fedoraproject.org> - 1.16.1-11
- Add empty /usr/share/flatpak/remotes.d

* Wed Nov 12 2025 Adam Williamson <awilliam@redhat.com> - 1.16.1-10
- Rebuild (again) for fuse3

* Wed Nov 12 2025 Debarshi Ray <rishi@fedoraproject.org> - 1.16.1-9
- Recommend version 2 of the permission store

* Tue Nov 04 2025 Tom spot Callaway <spotaws@amazon.com> - 1.16.1-6
- rebuild for new fuse3

* Thu Oct 09 2025 Christian Glombek <lorbus@fedoraproject.org> - 1.16.1-5
- Build with -Ddbus_config_dir=/usr/share/dbus-1/system.d
