...
* Tue Sep 15 2026 Chris Co <chrco@microsoft.com> - 4.9.0-7
- feat(facter): add Fedora 43 fact collection

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.9.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Mar 04 2025 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.9.0-5
- Raise thor upper limit to < 2 (fixes rhbz#2347030)

* Fri Jan 31 2025 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.9.0-4
- Add packit configuration

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.9.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Dec 02 2024 Mamoru TASAKA <mtasaka@fedoraproject.org> - 4.9.0-2
- Add rubygem(base64) dependency explicitly for ruby3.4

* Sat Sep 28 2024 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.9.0-1
- Update to 4.9.0 (fixes rhbz#2311289)

* Mon Aug 12 2024 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.8.0-1
- Update to 4.8.0 (fixes rhbz#2274554)

* Wed Jul 24 2024 Miroslav Suchý <msuchy@redhat.com> - 4.6.0-4
- convert ASL 2.0 license to SPDX

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.6.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Thu Mar 21 2024 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.6.0-2
- Add tests and gating

* Thu Mar 21 2024 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.6.0-1
- Update to 4.6.0 (fixes rhbz#2259042)

* Thu Mar 21 2024 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.5.1-4
- Add a README with instructions to update

* Wed Jan 24 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.5.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 4.5.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Tue Nov 14 2023 Ewoud Kohl van Wijngaarden <ewoud@kohlvanwijngaarden.nl> - 4.5.1-1
- Update to 4.5.1 (fixes rhbz#2185063)

* Wed Jul 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 4.3.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Fri Mar 03 2023 Igor Raits <igor.raits@gmail.com> - 4.3.0-2
- Add BR: rubygem-sys-filesystem

* Fri Mar 03 2023 Igor Raits <igor.raits@gmail.com> - 4.3.0-1
- Update to 4.3.0

* Thu Jan 19 2023 Fedora Release Engineering <releng@fedoraproject.org> - 4.2.14-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Tue Jan 17 2023 Adam Tkac <vonsch@gmail.com> - 4.2.14-1
- Update to 4.2.14

* Sun Jan 09 2022 Igor Raits <igor.raits@gmail.com> - 4.2.6-1
- Update to 4.2.6
...
* Tue Nov 07 2017 James Hogarth <james.hogarth@gmail.com> - 3.9.3-2
- missed the updated asc in sources
...
* Fri Feb 13 2015 Orion Poplawski <orion@cora.nwra.com> - 2.4.1-2
- Actually upload the 2.4.1 source
...
* Mon Nov 05 2012 Michael Stahnke <stahnma@puppetlabs.com> - 1.6.14-2
- Update to 1.6.14
...
- Update to 1.5.7 - Update #508037 patch from upstream ticket
...
- Update to 1.5.5 - Drop upstreamed libperms patch

* Tue Mar 03 2009 Todd Zullinger <tmz@fedoraproject.org> - 1.5.4-1
- Update to 1.5.4 - Use upstream install script
...
- New version - Simplify spec file checking for Fedora and RHEL versions
