...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.6.0-2
- Uncommitted changes

* Sat Mar 28 2026 Neal Gompa <ngompa@fedoraproject.org> - 4.6.0-1
- Update to 4.6.0 upstream release
- Resolves: rhbz#2452666

* Wed Feb 18 2026 Neal Gompa <ngompa@fedoraproject.org> - 4.5.0-1
- Update to 4.5.0 upstream release
- Resolves: rhbz#2440316

* Sun Feb 15 2026 Neal Gompa <ngompa@fedoraproject.org> - 4.4.0-1
- Update to 4.4.0 upstream release
- Resolves: rhbz#2414846

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.2.0-3
