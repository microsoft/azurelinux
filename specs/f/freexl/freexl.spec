...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.0.0-21
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.0-20
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 02 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.0.0-19
- Build API docs as HTML instead of PDF

* Wed Oct 15 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.0.0-18
