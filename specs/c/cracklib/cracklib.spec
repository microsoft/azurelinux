...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.10.3-2
- Uncommitted changes

* Thu May 28 2026 Paul Wouters <paul.wouters@aiven.io> - 2.10.3-1
- Update to 2.10.3
- convert to autochangelog
- remove patches merged upstream

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.11-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.9.11-9
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
