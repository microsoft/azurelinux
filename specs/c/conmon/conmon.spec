...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2:2.2.1-3
- Uncommitted changes

* Wed Mar 04 2026 Lokesh Mandvekar <lsm5@redhat.com> - 2:2.2.1-2
- TMT: fix plan ref

* Thu Feb 12 2026 Packit <hello@packit.dev> - 2:2.2.1-1
- Update to 2.2.1 upstream release

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2:2.2.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2:2.2.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
