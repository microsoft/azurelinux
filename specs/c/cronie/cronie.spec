...
touch $RPM_BUILD_ROOT%{_sysconfdir}/cron.allow
%post
...
%attr(0700,root,root) %dir %{_sysconfdir}/cron.d
%if %{with pam}
%attr(0644,root,root) %config(noreplace) %{_sysconfdir}/pam.d/crond
%endif
%config(noreplace) %{_sysconfdir}/sysconfig/crond
%attr(0640,root,root) %config(noreplace,missingok) %{_sysconfdir}/cron.deny
...
%attr(0640,root,root) %config(noreplace,missingok) %{_sysconfdir}/cron.allow
%files anacron
%{_bindir}/anacron
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.7.2-17
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.7.2-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.7.2-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Dec 17 2025 Ondřej Pohořelský <opohorel@redhat.com> - 1.7.2-14
- Use systemd_tmpfiles to create files in /var directory

* Mon Dec 08 2025 Ondřej Pohořelský <opohorel@redhat.com> - 1.7.2-13
