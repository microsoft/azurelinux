...
* Wed Jul 22 2026 Ondrej Kozina <okozina@redhat.com> - 2.8.7-1
- Update to cryptsetup 2.8.7.

* Wed Jan 28 2026 Kristina Hanicova <khanicov@redhat.com> - 2.8.4-1
- Update to cryptsetup 2.8.4.

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.8.3-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.8.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Dec 19 2025 Kristina Hanicova <khanicov@redhat.com> - 2.8.3-3
- Remove previous version (2.8.1) from sources.

* Fri Dec 19 2025 Kristina Hanicova <khanicov@redhat.com> - 2.8.3-2
- Update sources.

* Fri Dec 19 2025 Kristina Hanicova <khanicov@redhat.com> - 2.8.3-1
- Update to cryptsetup 2.8.3.
