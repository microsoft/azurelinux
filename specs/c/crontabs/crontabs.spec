...
%license COPYING
%attr(0600,root,root) %config(noreplace) /etc/crontab
%attr(0644,root,root) %config(noreplace) /etc/sysconfig/run-parts
%{_bindir}/run-parts
%attr(0700,root,root) %dir /etc/cron.hourly
%attr(0700,root,root) %dir /etc/cron.daily
%attr(0700,root,root) %dir /etc/cron.weekly
%attr(0700,root,root) %dir /etc/cron.monthly
%{_mandir}/man4/*

%changelog
## START: Generated by rpmautospec
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.11^20190603git9e74f2d-12
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.11^20190603git9e74f2d-11
- build: mass rebuild auto-bumpable components

* Fri Aug 07 2026 Tobias Brick <tobiasb@microsoft.com> - 1.11^20190603git9e74f2d-10
- fix(cron): restrict cron path permissions for CIS Level 1

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.11^20190603git9e74f2d-9
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.11^20190603git9e74f2d-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jul 04 2025 Lukáš Zaoral <lzaoral@redhat.com> - 1.11^20190603git9e74f2d-7
- tests: migrate from STI to TMT

* Fri Jul 04 2025 Lukáš Zaoral <lzaoral@redhat.com> - 1.11^20190603git9e74f2d-6
- tests/test-of-functionality-of-crontabs: fix the test

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.11^20190603git9e74f2d-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.11^20190603git9e74f2d-4
