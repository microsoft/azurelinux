...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.5.0-3
- Uncommitted changes

* Wed Jul 01 2026 Andreas Schneider <asn@redhat.com> - 0.5.0-2
- Fix cepces-certmonger postinstall script

* Tue Jun 30 2026 Andreas Schneider <asn@redhat.com> - 0.5.0-1
- Update to version 0.5.0

* Thu Mar 26 2026 Andreas Schneider <asn@redhat.com> - 0.4.1-1
- Update to version 0.4.1

* Tue Mar 24 2026 Andreas Schneider <asn@redhat.com> - 0.4.0-1
- Update to version 0.4.0

* Thu Jan 22 2026 Andreas Schneider <asn@redhat.com> - 0.3.17-1
- Update to version 0.3.17

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.3.16-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.3.16-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
