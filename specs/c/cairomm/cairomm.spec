...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.14.5-16
- Uncommitted changes

* Thu Jan 29 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.14.5-15
- Depend on gpgverify rather than gnupg2 for source file verification

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.14.5-14
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.14.5-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
