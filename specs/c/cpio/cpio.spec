...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.15-12
- feat(render): convert static changelogs to interleaved releases for c*
  components

* Wed May 13 2026 Pawel Winogrodzki <pawelwi@microsoft.com> - 2.15-11
- star: remove component and drop cpio's now-unused `BuildRequires: rmt`

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.15-10
