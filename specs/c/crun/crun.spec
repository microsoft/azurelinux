...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.29.1-2
- Uncommitted changes

* Thu Aug 13 2026 Packit <hello@packit.dev> - 1.29.1-1
- Update to 1.29.1 upstream release

* Fri Aug 07 2026 Packit <hello@packit.dev> - 1.29-1
- Update to 1.29 upstream release

* Wed May 27 2026 Packit <hello@packit.dev> - 1.28-1
- Update to 1.28 upstream release

* Tue Apr 21 2026 Packit <hello@packit.dev> - 1.27.1-1
- Update to 1.27.1 upstream release

* Wed Mar 25 2026 Packit <hello@packit.dev> - 1.27-1
- Update to 1.27 upstream release

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.26-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.26-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
