...
Patch: 0001-fix-azurelinux-remove-some-config-excluded-only-from.patch
Patch: 0002-fix-azurelinux-remove-custom-azurelinux-group-config.patch
Patch: 0003-fix-azurelinux-set-azurelinux-default-username-to-az.patch
Patch: 0004-fix-azurelinux-include-azurelinux-in-distro-group-wi.patch
Patch: 0005-fix-azurelinux-Set-specific-list-of-network-renderer.patch
Patch: 0006-fix-azurelinux-use-libexec-path-for-ds-identify-6874.patch
Patch: 0007-fix-azurelinux-remove-overridden-package_command-met.patch
Patch: 0008-fix-azurelinux-remove-use_lib_exec-property-override.patch
Patch: 0009-fix-azurelinux-update-systemd-cloud-init-.service-te.patch
Patch: 0010-fix-azurelinux-update-hosts.azurelinux.tmpl-6874.patch
Patch: 0011-fix-azurelinux-update-test_util-with-Azure-Linux-4-o.patch
%description
...
%install
%py3_install -- --init-system=systemd --distro=azurelinux
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 25.2-14
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 25.2-13
- build: mass rebuild auto-bumpable components

* Thu May 07 2026 Dan Streetman <ddstreet@ieee.org> - 25.2-12
- fix(cloud-init): update to support Azure Linux 4.0
