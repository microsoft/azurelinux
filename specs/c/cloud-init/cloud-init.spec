...
# AZL4 uses systemd-networkd, not NetworkManager — remove NM ordering references
sed -i '/^After=NetworkManager\.service$/d' systemd/cloud-init-network.service.tmpl
sed -i '/^After=NetworkManager-wait-online\.service$/d' systemd/cloud-init-network.service.tmpl
...
* Fri May 08 2026 Jonathan Brenes <jonathan.brenes@microsoft.com> - 25.2-12
- Remove NetworkManager.service and NetworkManager-wait-online.service references from cloud-init-network.service (AZL4 uses systemd-networkd)
