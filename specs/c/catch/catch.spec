...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.13.0-2
- Uncommitted changes

* Mon Feb 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.13.0-1
- Update to 3.13.0 (close RHBZ#2440120)

* Mon Feb 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.10.0-10
- Move %%cmake invocation from %%build to %%conf

* Mon Feb 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.10.0-9
- Don’t package CODE_OF_CONDUCT.md, which really relates to upstream dev

* Mon Feb 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.10.0-4
- Update description text from upstream

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.10.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.10.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Aug 25 2025 Tom Hughes <tom@compton.nu> - 3.10.0-1
- Update to 3.10.0 upstream release

* Fri Aug 08 2025 Tom Hughes <tom@compton.nu> - 3.9.1-1
- Update to 3.9.1 upstream release

* Fri Jul 25 2025 Tom Hughes <tom@compton.nu> - 3.9.0-1
- Update to 3.9.0 upstream release

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.8.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Apr 09 2025 Tom Hughes <tom@compton.nu> - 3.8.1-1
- Update to 3.8.1 upstream release

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.8.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 06 2025 Tom Hughes <tom@compton.nu> - 3.8.0-1
- Update to 3.8.0 upstream release

* Tue Sep 17 2024 Tom Hughes <tom@compton.nu> - 3.7.1-1
- Update to 3.7.1 upstream release

* Thu Aug 15 2024 Tom Hughes <tom@compton.nu> - 3.7.0-1
- Update to 3.7.0 upstream release

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Mon May 06 2024 Tom Hughes <tom@compton.nu> - 3.6.0-1
- Update to 3.6.0 upstream release

* Thu Apr 11 2024 Tom Hughes <tom@compton.nu> - 3.5.4-1
- Update to 3.5.4 upstream release

* Sat Mar  2 2024 Tom Hughes <tom@compton.nu> - 3.5.3-1
- Update to 3.5.3 upstream release

* Tue Jan 23 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Wed Jan 17 2024 Tom Hughes <tom@compton.nu> - 3.5.2-1
- Update to 3.5.2 upstream release

* Mon Jan  1 2024 Tom Hughes <tom@compton.nu> - 3.5.1-1
- Update to 3.5.1 upstream release

* Tue Dec 12 2023 Tom Hughes <tom@compton.nu> - 3.5.0-1
