...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.5.3-28
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.5.3-27
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.5.3-26
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 3.5.3-25
- Rebuilt for java-25-openjdk as preffered jdk

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.3-24
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-23
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-22
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-21
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-20
- Remove javadoc subpackage

* Wed Feb 19 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-19
- Adjust dependency scopes

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.3-18
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Dec 30 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-15
- Use %%autosetup -C

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-14
- Update javapackages test plan to f42

* Fri Aug 23 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 3.5.3-13
- Set Java compiler source/target via javaVersion property

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.3-8
