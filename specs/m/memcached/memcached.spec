...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0:1.6.39-3
...
* Wed Aug 03 2011 Paul Lindner <lindner@inuus.com> - 0:1.4.6-1
- upgrade to 1.4.6

* Mon Feb 14 2011 Paul Lindner <lindner@inuus.com> - 0:1.4.5-7
- fix for f15

* Tue Feb 08 2011 Dennis Gilmore <dennis@ausil.us> - 0:1.4.5-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_15_Mass_Rebuild

* Sun Nov 28 2010 Paul Lindner <lindner@inuus.com> - 0:1.4.5-5
- Add fixes for /var/run running on tmpfs, fixes bugzilla 656621

* Wed Sep 08 2010 Paul Lindner <lindner@inuus.com> - 0:1.4.5-4
- Apply patch from memcached issue #60, solves Bugzilla 631051

* Thu Jul 29 2010 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 0:1.4.5-3
- dist-git conversion

* Thu May 27 2010 jorton <jorton@fedoraproject.org> - 0:1.4.5-2
- LSB compliance fixes for init script - don't run the test suite as root -
  ensure a constant timestamp on the sysconfig file

* Mon Apr 05 2010 Paul Lindner <plindner@fedoraproject.org> - 0:1.4.5-1
- Upgrade to upstream memcached-1.4.5
  (http://code.google.com/p/memcached/wiki/ReleaseNotes145)

* Wed Jan 20 2010 Paul Lindner <plindner@fedoraproject.org> - 0:1.4.4-6
- Remove SELinux policies fixes Bugzilla 557073

* Sat Nov 28 2009 Paul Lindner <plindner@fedoraproject.org> - 0:1.4.4-5
- memcached-1.4.4-1 - upgrade to memcached-1.4.4, fix deps issue (542001)

* Wed Nov 25 2009 Bill Nottingham <notting@fedoraproject.org>
- Fix typo that causes a failure to update the common directory. (releng
  #2781)

* Tue Nov 24 2009 Paul Lindner <plindner@fedoraproject.org>
- bump version for new build

* Mon Nov 16 2009 Paul Lindner <plindner@fedoraproject.org>
- Add explicit require on memcached for memcached-devel (resolves 537046)
  enable-threads option no longer needed Update web site address

* Wed Nov 11 2009 Paul Lindner <plindner@fedoraproject.org> - 1.4.3-1
- update to 1.4.3

* Mon Oct 12 2009 Paul Lindner <plindner@fedoraproject.org> - 1.4.2-1
- Upgrade to memcached-1.4.2

* Sun Aug 30 2009 Paul Lindner <plindner@fedoraproject.org> - 1.4.1-1
- update for 1.4.1

* Wed Jul 22 2009 Paul Lindner <plindner@fedoraproject.org> - 1.4.0-1
- Resolves Bug #513202, upgrade to memcached 1.4.0, also adds new
  memcached-devel rpm

* Thu Apr 30 2009 Paul Lindner <plindner@fedoraproject.org> - 1.2.8-1
- Upgrade to memcached-1.2.85 ia4ee04e517a5cad110f29e4490e4ab
  memcached-1.2.8.tar.gz - Addresses CVE-2009-1255

* Thu Feb 26 2009 Jesse Keating <jkeating@fedoraproject.org> - 1.2.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_11_Mass_Rebuild

* Tue Jul 29 2008 Paul Lindner <plindner@fedoraproject.org> - 1.2.6-1
- Upgrade to memcached-1.2.6

* Sun Jun 29 2008 Paul Lindner <plindner@fedoraproject.org> - 1.2.5-2
- Bump version to account for new libevent dependencies in rawhide

* Tue Mar 04 2008 Paul Lindner <plindner@fedoraproject.org> - 1.2.5-1
- Upgrade to memcached-1.2.5

* Tue Feb 19 2008 Jesse Keating <jkeating@fedoraproject.org> - 1.2.4-4
- Autorebuild for GCC 4.3

* Sun Jan 27 2008 Paul Lindner <plindner@fedoraproject.org> - 1.2.4-3
- Adjust libevent dependencies

* Sat Dec 22 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.4-2
- Apply fix from Bug 284561 - Security Enhancements for memcached run as
  user memcached add new selinux policies

* Sat Dec 22 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.4-1
- Update to new upstream memcached 1.2.4 revision

* Mon Aug 06 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-15
- fixes for crash on x86_64 and startup script problems, patch properly

* Mon Aug 06 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-14
- fixes for crash on x86_64 and startup script problems, patch properly

* Mon Aug 06 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-13
- fixes for crash on x86_64 and startup script problems

* Fri Jul 13 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-12
- Correct problem with removing daemonize.t, hopefully this passes on ppc64

* Fri Jul 13 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-11
- Remove test that only fails on fedora build systems

* Tue Jul 10 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-10
- Initial import of memcached 1.2.3

* Wed Feb 16 2011 Joe Orton <jorton@redhat.com> - 0:1.4.5-9
- fix build

* Wed Feb 16 2011 Joe Orton <jorton@redhat.com> - 0:1.4.5-8
- fix build
...
* Mon Aug 06 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-6
- fixes for crash on x86_64 and startup script problems, patch properly

* Mon Aug 06 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-5
- fixes for crash on x86_64 and startup script problems, patch properly

* Mon Aug 06 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-4
- fixes for crash on x86_64 and startup script problems

* Fri Jul 13 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-3
- Correct problem with removing daemonize.t, hopefully this passes on ppc64

* Fri Jul 13 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-2
- Remove test that only fails on fedora build systems

* Tue Jul 10 2007 Paul Lindner <plindner@fedoraproject.org> - 1.2.3-1
- Initial import of memcached 1.2.3
