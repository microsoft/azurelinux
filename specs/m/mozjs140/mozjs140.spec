...
* Thu Sep 24 2026 Dan Streetman <ddstreet@ieee.org> - 140.13.0-5
- chore(various): remove all source tarball customization

* Fri Sep 18 2026 Dan Streetman <ddstreet@ieee.org> - 140.13.0-4
- chore: update 'lock' files

* Sun Aug 02 2026 František Zatloukal <fzatlouk@redhat.com> - 140.13.0-3
- mozjs140-140.13.0 (RHBZ#2395444)

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 140.6.0-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Mon Jun 08 2026 František Zatloukal <fzatlouk@redhat.com> - 140.6.0-6
- Adjust known_failures for icu 78.3

* Mon Jun 08 2026 František Zatloukal <fzatlouk@redhat.com> - 140.6.0-5
- Rebuilt for icu 78.3

* Fri Feb 06 2026 Miro Hrončok <miro@hroncok.cz> - 140.6.0-4
- Bump the Release number after the reverts

* Thu Jan 22 2026 Adam Williamson <awilliam@redhat.com> - 140.6.0-1
- Revert "Revert mozjs140-140.6.0 and mozjs140-140.2.0"

* Tue Jan 20 2026 Adam Williamson <awilliam@redhat.com> - 140.1.0-1
- Revert mozjs140-140.6.0 and mozjs140-140.2.0

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 140.6.0-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 23 2025 Georg Sauthoff <mail@gms.tf> - 140.6.0-6
- update project URL

* Wed Sep 09 2026 Andrew Phelps <anphel@microsoft.com> - 140.6.0-5
- fix(mozjs140): remove packed Windows test fixture

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 140.6.0-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 140.6.0-3
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 140.6.0-2
