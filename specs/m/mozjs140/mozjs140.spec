...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 140.13.0-4
- Uncommitted changes
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 140.6.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 23 2025 Georg Sauthoff <mail@gms.tf> - 140.6.0-2
- update project URL
