...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.8.6-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.8.6-5
- build: mass rebuild auto-bumpable components
...
* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Jun 07 2025 Mike FABIAN <mfabian@redhat.com> - 1.8.6-1
- Update to 1.8.6
- Add m17n-input-test program (by David Mandelberg <david@mandelberg.org>)
- input.c (regularize_action): Do not update the element of action_list if
  the element is a symbol that is defined as a variable (By K. Handa
  <handa@gnu.org>).
- Increment buffer index correctly in read_mtext_element () (Resolves:
  https://savannah.nongnu.org/bugs/index.php?67107) (by David Mandelberg
...
- Fix build on Fedora rawhide (Fedora 42) (Now included in upstream
  tarball, remove patch)
- configure.ac: fix incorrect bashism (thanks to Eli Schwartz
  <eschwartz93@gmail.com>)

* Wed Jan 22 2025 Mike FABIAN <mfabian@redhat.com> - 1.8.4-8
- Fix build on rawhide (F42)

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.4-7
