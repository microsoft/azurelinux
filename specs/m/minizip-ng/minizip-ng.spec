...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 4.0.10-4
- chore(lockfiles): update existing autochangelog packages to new lockfile
  format

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 4.0.10-3
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.0.10-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon May 05 2025 Packit <hello@packit.dev> - 4.0.10-1
- Update to 4.0.10 upstream release
- Resolves: rhbz#2364006

* Thu Apr 24 2025 Xavier Bachelot <xavier@bachelot.org> - 4.0.9-2
- Allow to build without openssl-devel-engine

* Sat Apr 05 2025 Packit <hello@packit.dev> - 4.0.9-1
- Update to 4.0.9 upstream release
- Resolves: rhbz#2336439

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.0.8-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 13 2025 Lukas Javorsky <ljavorsk@redhat.com> - 4.0.8-2
- Enable Packit Bot for minizip-ng

* Thu Jan 09 2025 Lukas Javorsky <ljavorsk@redhat.com> - 4.0.8-1
- Rebase to version 4.0.8
