...
* Tue Sep 08 2026 Elaheh Dehghani <edehghani@microsoft.com> - 2604.0.0-2
- add cuda-compat,ibarr,ibsim-ofed,ibsim,mlnx-ethtool,mlnx-iproute2,mlnx-
  tools-ofed,multiperf,nvidia-driver,nvidia-kmod-common,nvidia-
  modprobe,nvidia-open,nvidia-persistenced,ofed-scripts,openmpi-
  ofed,perftest-ofed,rshim-ofed,ucx-ofed

* Thu Jan 01 1970 azldev <> - 2604.0.0-1
- Initial sources
