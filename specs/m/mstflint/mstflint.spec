...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.36.0-3
- Uncommitted changes

* Sat Aug 08 2026 Michal Schmidt <mschmidt@redhat.com> - 4.36.0-2
- fix segfault on ConnectX-3

* Thu Aug 06 2026 Michal Schmidt <mschmidt@redhat.com> - 4.36.0-1
- update to 4.36.0

* Thu Aug 06 2026 Michal Schmidt <mschmidt@redhat.com> - 4.35.0-6
- add rpminspect.yaml to waive badfuncs for mstmtserver

* Thu Aug 06 2026 Michal Schmidt <mschmidt@redhat.com> - 4.35.0-5
- enable s390x build

* Thu Aug 06 2026 Michal Schmidt <mschmidt@redhat.com> - 4.35.0-4
- disable i686 build

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.35.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 12 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 4.35.0-2
- Rebuilt for openssl 4.0

* Tue May 12 2026 Kamal Heib <kheib@redhat.com> - 4.35.0-1
- Update to upstream release 4.35.0

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.34.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Dec 04 2025 Kamal Heib <kheib@redhat.com> - 4.34.0-1
- Update to upstream release 4.34.0

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.32.0^20250517git48a1454-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat May 17 2025 Michal Schmidt <mschmidt@redhat.com> - 4.32.0^20250517git48a1454-1
- Update to post-4.32.0 git snapshot

* Thu Apr 24 2025 Davide Cavalca <dcavalca@fedoraproject.org> - 4.31.0^20250321gitbebc0df-5
- Ensure the release is set correctly

* Thu Apr 24 2025 Davide Cavalca <dcavalca@fb.com> - 4.31.0^20250321gitbebc0df-1
- Explicitly set the date for the forge macros

* Fri Apr 04 2025 Michal Schmidt <mschmidt@redhat.com> - 4.31.0^gitbebc0df-4
- reenable fw-mgr

* Sun Mar 23 2025 Michal Schmidt <mschmidt@redhat.com> - 4.31.0^gitbebc0df-3
- fix debuginfo processing for libresource_dump_sdk.so

* Fri Mar 21 2025 Michal Schmidt <mschmidt@redhat.com> - 4.31.0^gitbebc0df-2
- Upload the snapshot tarball

* Fri Mar 21 2025 Michal Schmidt <mschmidt@redhat.com> - 4.31.0^gitbebc0df-1
