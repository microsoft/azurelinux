...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.0.8-2
- Uncommitted changes

* Wed Jul 01 2026 Packit <hello@packit.dev> - 1.0.8-1
- Update to 1.0.8 upstream release

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 1.0.7-8
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.0.7-7
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 1.0.7-6
- Onboard to Packit for stable Fedora branches

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.7-5
