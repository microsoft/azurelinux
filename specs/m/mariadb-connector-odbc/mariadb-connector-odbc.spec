...
Version:        3.2.8
Release: %autorelease %{?with_debug:-e debug}
...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.2.8-6
- feat(render): convert static changelogs to interleaved releases for m*
  components

* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.2.8-5
- chore(lockfiles): update existing autochangelog packages to new lockfile
  format

* Fri May 01 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.2.8-4
- fix(mariadb-connector-odbc): set manual release calculation
