...
# moby-engine granted permanent exception to Fedora Updates Policy
# https://docs.fedoraproject.org/en-US/fesco/Updates_Policy/#_exceptions
# https://pagure.io/fesco/issue/3602
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 29.7.1-2
- Uncommitted changes

* Fri Jul 31 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.7.1-1
- Update to release v29.7.1
- Regression fix

* Fri Jul 31 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.7.0~rc.1-1
- Update to release v29.7.0
- Upstream fixes and enhancements
- Resolve CVE-2026-17106 (GHSA-hfg8-hc9c-6c3h)

* Fri Jul 17 2026 Alejandro Sáez <asm@redhat.com> - 29.6.2-2
...
* Wed Jun 03 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.5.3-1
- Update to release v29.5.3
- Resolves: rhbz#2484561
- Upstream fixes

* Wed May 20 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.5.2-1
- Update to release v29.5.2
- Resolves: rhbz#246552
- Upstream fix

* Mon May 18 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.5.1-1
- Update to release v29.5.1
- Resolves: rhbz#2467552
- Resolves: CVE-2026-41567, CVE-2026-41568, CVE-2026-42306
- Upstream fix

* Fri May 15 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.5.0-1
- Update to release v29.5.0
- Resolves: rhbz#2467552
- Resolves CVE-2026-32288
- Resolves CVE-2026-31431
- Upstream new features, fixes, and enhancements

* Fri May 01 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.4.2-1
- Update to release v29.4.2
- Resolves: rhbz#2459826
- Upstream fixes
- This release includes hardening for CVE-2026-31431
- Temporary skip for branch protection test

* Mon Apr 20 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.4.1-1
- Update to release v29.4.1
- Resolves: 2459826
- Upstream fixes
- Built with golang 1.26 (rawhide and f44 only at this time)

* Tue Apr 07 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.4.0-1
- Update to release v29.4.0
- Resolves: rhbz#2455894
- Resolves  CVE-2026-34986: rhbz#2455665
- Upstream new features and fixes

* Wed Mar 25 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.3.1-1
- Update to release v29.3.1
- Resolves: rhbz#2451425
- Upstream notes that this release resolves: CVE-2026-34040,
  CVE-2026-33997, CVE-2026-33748, CVE-2026-33747
- Upstream fixes

* Fri Mar 06 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 29.3.0-1
- Update to release v29.3.0
- Resolves: rhbz#2444867
- Upstream enhancements and fixes

* Thu Feb 26 2026 Maxwell G <maxwell@gtmx.me> - 29.2.1-4
- Ship docker-init -> tini-static symlink

* Thu Feb 26 2026 Gordon Messmer <gordon.messmer@gmail.com> - 29.2.1-3
- Add rootless-extras subpackage
