...
%changelog
* Fri Mar 3 2026 Tomas Halman <thalman@redhat.com> - 2.4.19.2-1
- Resolves: rhbz#2437328 - mod_auth_openidc in f43 is older than in f42
- Resolves: rhbz#2390264 - mod_auth_openidc-2.4.19.2 is available

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.4.16.11-2
...
* Fri Feb 14 2025 Tomas Halman <thalman@redhat.com> - 2.4.16.7-1
  Rebase to version 2.4.16.7
- Resolves: rhbz#2342888 - mod_auth_openidc-2.4.16.7 is available
...
* Tue Dec 10 2024 Tomas Halman <thalman@redhat.com> - 2.4.16.6-1
  Rebase to version 2.4.16.6
- Resolves: rhbz#2331115 - mod_auth_openidc-2.4.16.6 is available

* Thu Nov 7 2024 Tomas Halman <thalman@redhat.com> - 2.4.16.5-1
  Rebase to version 2.4.16.5
- Resolves: rhbz#2315801 - mod_auth_openidc-2.4.16.5 is available

* Tue Oct 22 2024 Richard W.M. Jones <rjones@redhat.com> - 2.4.16.3-2
- Rebuild for Jansson 2.14
  (https://lists.fedoraproject.org/archives/list/devel@lists.fedoraproject.org/thread/3PYINSQGKQ4BB25NQUI2A2UCGGLAG5ND/)

* Tue Sep 17 2024 Tomas Halman <thalman@redhat.com> - 2.4.16.3-1
  Rebase to version 2.4.16.3
- Resolves: rhbz#2272582 - mod_auth_openidc-2.4.16.3 is available
