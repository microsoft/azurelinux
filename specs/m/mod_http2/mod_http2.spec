...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.0.39-2
- Uncommitted changes

* Wed May 06 2026 Luboš Uhliarik <luhliari@redhat.com> - 2.0.39-1
- update to 2.0.39

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.37-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Dec 10 2025 Joe Orton <jorton@redhat.com> - 2.0.37-1
- update to 2.0.37 (rhbz#2417958)

* Wed Dec 10 2025 Joe Orton <jorton@redhat.com> - 2.0.36-2
- fix autosetup to not require git [skip changelog]

* Wed Dec 10 2025 Joe Orton <jorton@redhat.com> - 2.0.36-1
- update to 2.0.36, switch to autorelease/autosetup/autochangelog

* Mon Oct 06 2025 Luboš Uhliarik <luhliari@redhat.com> - 2.0.35-1
- new version 2.0.35
