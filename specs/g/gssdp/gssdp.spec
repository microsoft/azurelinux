...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.6.4-8
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.6.4-7
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.6.4-6
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Sun Nov 30 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 1.6.4-5
- Ensure correct fonts are installed for HTML docs

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.6.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 30 2025 Carlos Garnacho <cgarnach@redhat.com> - 1.6.4-1
- Update to 1.6.4
