...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 50.1-2
- Uncommitted changes

* Fri Jun 12 2026 Petr Schindler <pschindl@redhat.com> - 50.1-1
- Update to 50.1
...
* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 50~beta-8
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 50~beta-7
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 50~beta-6
- Onboard to Packit for stable Fedora branches

* Wed Feb 18 2026 Jan Grulich <jgrulich@redhat.com> - 50~beta-5
- Rebase the native keybindings patch

* Wed Feb 18 2026 Olivier Fourdan <ofourdan@redhat.com> - 50~beta-4
- Start accessibility settings

* Wed Feb 18 2026 Olivier Fourdan <ofourdan@redhat.com> - 50~beta-3
- Do not allow VT switching by default

* Wed Feb 18 2026 Olivier Fourdan <ofourdan@redhat.com> - 50~beta-2
- Do not build the input-selector

* Thu Feb 05 2026 Jan Horak <jhorak@redhat.com> - 50~beta-1
- Update to 50~beta

* Wed Feb 04 2026 Olivier Fourdan <ofourdan@redhat.com> - 50~alpha-2
- Add new packages

* Wed Feb 04 2026 Jan Horak <jhorak@redhat.com> - 50~alpha-1
- Update to 50~alpha
