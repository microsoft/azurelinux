...
# Fix problem where NVIDIA systems with systemd 258+ suspend again shortly after resuming
# This is the only functional commit from the PR (the other two are for tests
# and do not apply cleanly to 49.1 so I skipped them)
Patch:          0001-plugins-power-do-not-unidle-for-inactive-session.patch
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 49.1-5
- Uncommitted changes

* Mon Mar 09 2026 Adam Williamson <awilliam@redhat.com> - 49.1-4
- Backport MR #462 to fix re-suspend bug on NVIDIA driver
