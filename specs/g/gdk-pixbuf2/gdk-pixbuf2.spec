...
Name:           gdk-pixbuf2
Version:        2.44.6^really%{real_version}
Release:        %autorelease
...
%prep
%autosetup -n gdk-pixbuf-%{real_version} -p1

# see https://bugzilla.redhat.com/show_bug.cgi?id=2452248
# https://bugzilla.redhat.com/show_bug.cgi?id=2459590
if [ "$(head meson.build | grep --count "version: '2.44.4'")" = "0" ]; then
	echo -e "\\033[1;31m !!! I mean it, do not update to other than 2.44.4 version\\033[0m" 1>&2;
	exit 1;
fi
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.44.6^really2.44.4-3
- Uncommitted changes

* Wed Aug 26 2026 Adrian Vovk <avovk@redhat.com> - 2.44.6^really2.44.4-2
- Fix CVE-2026-16768

* Wed Apr 22 2026 Milan Crha <mcrha@redhat.com> - 2.44.6^really2.44.4-1
- Revert update to 2.44.4
- The newer versions do not work with XPM images

* Thu Apr 16 2026 Petr Schindler <pschindl@redhat.com> - 2.44.6-1
- Update to 2.44.6
