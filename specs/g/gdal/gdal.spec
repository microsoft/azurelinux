...
%{load:%{_sourcedir}/gdal.azl.macros}
...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.11.5-3
- feat(render): convert static changelogs to interleaved releases for g*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.11.5-2
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Nov 07 2025 Sandro Mani <manisandro@gmail.com> - 3.11.5-1
- Update to 3.11.5

* Wed Oct 29 2025 Stephen Gallagher <sgallagh@redhat.com> - 3.11.4-6
