...
Patch: CVE-2026-0988-integer-overflow-in-g_buffered_input_stream_peek.patch
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.86.5-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.86.5-3
- build: mass rebuild auto-bumpable components

* Fri Jul 24 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.86.5-2
- chore(glib2): update to 2.86.5 (pin Fedora dist-git commit)

* Thu Apr 16 2026 Petr Schindler <pschindl@redhat.com> - 2.86.5-1
- Update to 2.86.5

* Thu Mar 19 2026 Milan Crha <mcrha@redhat.com> - 2.86.4-3
- Add patch for CVE-2026-0988 (Integer overflow in
  g_buffered_input_stream_peek() leads to segmentation fault)

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.86.4-2
