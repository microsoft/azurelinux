...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.88.1-2
- Uncommitted changes

* Sun Jun 28 2026 Packit <hello@packit.dev> - 2.88.1-1
- Update to 2.88.1 upstream release

* Wed Mar 18 2026 Milan Crha <mcrha@redhat.com> - 2.88.0-1
- Update to 2.88.0

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 2.86.0-5
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 2.86.0-4
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 2.86.0-3
- Onboard to Packit for stable Fedora branches

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.86.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 23 2025 Matthias Clasen <mclasen@redhat.com> - 2.86.0-1
- Update to 2.86.0
