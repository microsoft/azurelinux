...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.2.1.0-13
- Uncommitted changes

* Mon Jan 26 2026 Jens Petersen <petersen@redhat.com> - 0.2.1.0-12
- refresh to cabal-rpm-2.3.2

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.1.0-11
