...
Source0: https://github.com/microsoft/go/releases/download/v1.26.5-2/go1.26.5-20260709.6.src.tar.gz#/go1.26.5.src.tar.gz
...
Requires: SymCrypt >= 103.6.0-1
Requires: SymCrypt-OpenSSL >= 1.6.1-1
Patch10: 0005-Set-nodwarf5-in-go.env.patch
Patch11: 0006-Skip-openssl-incompatible-crypto-tests.patch
Patch12: 0007-Disable-msft-go-telemetry-by-default.patch
%description
%{summary}.
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.26.5-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.26.5-3
- build: mass rebuild auto-bumpable components

* Thu Aug 06 2026 Nan Liu <liunan@microsoft.com> - 1.26.5-2
- feat(golang): source Azure Linux golang from the Microsoft build of Go

* Wed Jul 08 2026 Packit <hello@packit.dev> - 1.26.5-1
- Update to 1.26.5 upstream release
- Resolves: rhbz#2497796

* Wed Jun 03 2026 Alejandro Sáez <asm@redhat.com> - 1.26.4-2
- Update provides

* Wed Jun 03 2026 Packit <hello@packit.dev> - 1.26.4-1
- Update to 1.26.4 upstream release
- Resolves: rhbz#2484128

* Mon May 11 2026 Alejandro Sáez <asm@redhat.com> - 1.26.3-2
- Remove 0006-Default-to-ld.bfd-on-ARM64.patch

* Thu May 07 2026 Packit <hello@packit.dev> - 1.26.3-1
- Update to 1.26.3 upstream release
- Resolves: rhbz#2467780

* Tue Apr 07 2026 Packit <hello@packit.dev> - 1.26.2-1
- Update to 1.26.2 upstream release
- Resolves: rhbz#2456320

* Fri Mar 06 2026 Packit <hello@packit.dev> - 1.26.1-1
- Update to 1.26.1 upstream release
- Resolves: rhbz#2445075

* Fri Feb 13 2026 Alejandro Sáez <asm@redhat.com> - 1.26.0-2
- Update to Go 1.26.0 release

* Tue Feb 10 2026 Packit <hello@packit.dev> - 1.26.0-1
- Update to 1.26.0 upstream release
- Resolves: rhbz#2438726

* Mon Feb 09 2026 Alejandro Sáez <asm@redhat.com> - 1.26~rc3-2
- Update .packit.yaml

* Wed Feb 04 2026 Packit <hello@packit.dev> - 1.26~rc3-1
- Update to 1.26rc3 upstream release

* Fri Jan 30 2026 Packit <hello@packit.dev> - 1.26~rc2-1
- Update to 1.26rc2 upstream release

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.26~rc1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 02 2026 Alejandro Sáez <asm@redhat.com> - 1.26~rc1-2
- Update Packit references

* Wed Dec 17 2025 Alejandro Sáez <asm@redhat.com> - 1.26~rc1-1
- Update to 1.26rc1
...
* Tue Dec 02 2025 David Abdurachmanov <davidlt@rivosinc.com> - 1.25.4-2
...
* Thu Sep 04 2025 Mikel Olasagasti Uranga <mikel@olasagasti.info> - 1.25.1-4
- Drop check for old Releases and recommend git-core

* Thu Sep 04 2025 Mikel Olasagasti Uranga <mikel@olasagasti.info> - 1.25.1-3
- Drop old check on RHEL6 and Fedora

* Thu Sep 04 2025 Mikel Olasagasti Uranga <mikel@olasagasti.info> - 1.25.1-2
- Remove unused patch
...
* Wed Aug 13 2025 Alejandro Sáez <asm@redhat.com> - 1.25.0-3
- Add Fedora 43

* Wed Aug 13 2025 Alejandro Sáez <asm@redhat.com> - 1.25.0-2
- Update to Go 1.25.0

* Tue Aug 12 2025 Packit <hello@packit.dev> - 1.25.0-1
