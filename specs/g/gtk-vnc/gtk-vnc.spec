...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.5.0-8
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.5.0-7
- build: mass rebuild auto-bumpable components

* Tue May 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.5.0-6
- fix(mingw): disable mingw on components that hard-code with_mingw

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 1.5.0-5
