...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.4.0.1-7
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.4.0.1-6
- build: mass rebuild auto-bumpable components

* Mon May 11 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.4.0.1-5
- fix(repoclosure): re-add gcr and gcr3 to the distro (sdk repo)

* Sat Dec 06 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 4.4.0.1-4
- Ensure correct fonts are installed for HTML docs

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.4.0.1-2
...
* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.3.90.3-2
