...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.26.10-4
- feat(render): convert static changelogs to interleaved releases for g*
  components

* Fri May 08 2026 Binu Jose Philip <binujp@gmail.com> - 1.26.10-3
- fix(gstreamer1-plugins-base): remove dependency on opus to drop it

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.26.10-2
