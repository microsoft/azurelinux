...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.2.6-2
- Uncommitted changes

* Tue Jan 27 2026 Jens Petersen <petersen@redhat.com> - 2.2.6-1
- https://hackage.haskell.org/package/async-2.2.6/changelog

* Mon Jan 26 2026 Jens Petersen <petersen@redhat.com> - 2.2.5-8
- refresh to cabal-rpm-2.3.2

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.5-7
