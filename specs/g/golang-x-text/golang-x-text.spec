...
* Mon Aug 24 2026 Mitch Zhu <mitchzhu@microsoft.com> - 0.38.0-2
- fix(golang): address Go 1.26 build failures

* Mon Jun 08 2026 Packit <hello@packit.dev> - 0.38.0-1
- Update to 0.38.0 upstream release
- Resolves: rhbz#2486381

* Thu May 28 2026 Alejandro Sáez <asm@redhat.com> - 0.37.0-4
- Enable packit for EPEL

* Thu May 28 2026 Packit <hello@packit.dev> - 0.37.0-3
- Update to 0.37.0 upstream release

* Thu May 28 2026 Alejandro Sáez <asm@redhat.com> - 0.37.0-2
- Update packit

* Fri May 08 2026 Packit <hello@packit.dev> - 0.37.0-1
- Update to 0.37.0 upstream release
- Resolves: rhbz#2402555

* Tue Feb 03 2026 Maxwell G <maxwell@gtmx.me> - 0.29.0-4
- Rebuild for https://fedoraproject.org/wiki/Changes/golang1.26

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.29.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Oct 10 2025 Alejandro Sáez <asm@redhat.com> - 0.29.0-2
- rebuild

* Mon Sep 08 2025 Packit <hello@packit.dev> - 0.29.0-1
- Update to 0.29.0 upstream release
- Resolves: rhbz#2393797

* Sat Sep 06 2025 Packit <hello@packit.dev> - 0.28.0-1
- Update to 0.28.0 upstream release
- Resolves: rhbz#2387181

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.27.0-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.27.0-5
- build: mass rebuild auto-bumpable components
