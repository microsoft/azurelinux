...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.0.6-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.0.6-5
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.0.6-4
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.6-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Apr 07 2025 Jens Petersen <petersen@redhat.com> - 1.0.6-2
- Rebuild

* Tue Mar 25 2025 Jens Petersen <petersen@redhat.com> - 1.0.6-1
- https://hackage.haskell.org/package/uuid-types-1.0.6/changelog

* Sun Feb 23 2025 Jens Petersen <petersen@redhat.com> - 1.0.5.1-3
- cabal-rpm-2.3.0

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.5.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sat Aug 03 2024 Jens Petersen <petersen@redhat.com> - 1.0.5.1-1
- https://hackage.haskell.org/package/uuid-types-1.0.5.1/changelog

* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.5-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue Jul 16 2024 Jens Petersen <petersen@redhat.com> - 1.0.5-12
...
* Sun Jul 23 2023 Jens Petersen <petersen@redhat.com> - 1.0.5-9
- revised .cabal file
...
* Fri Jun 17 2022 Jens Petersen <petersen@redhat.com> - 1.0.5-3
- rebuild

* Thu Jan 20 2022 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Thu Aug  5 2021 Jens Petersen <petersen@redhat.com> - 1.0.5-1
- update to 1.0.5
...
* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.3-16
- Second attempt - Rebuilt for
  https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Mon Jul 27 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.3-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Fri Jul 17 2020 Jens Petersen <petersen@redhat.com> - 1.0.3-14
- refresh to cabal-rpm-2.0.6

* Tue Jan 28 2020 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.3-13
...
* Sat Jul 28 2018 Jens Petersen <petersen@redhat.com> - 1.0.3-8
- revise .cabal
...
* Fri Jan 26 2018 Jens Petersen <petersen@redhat.com> - 1.0.3-5
- rebuild

* Thu Oct  5 2017 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 1.0.3-4
- Bump release to be newer than existing bundled version.

* Wed Oct  4 2017 Fedora Haskell SIG <haskell@lists.fedoraproject.org> - 1.0.3-1
