...
* Wed Sep 16 2020 Michal Schorm <mschorm@redhat.com> - 26.4.4-6
- Apply workaround for FTBFS on F33+

* Sat Aug 01 2020 Fedora Release Engineering <releng@fedoraproject.org> - 26.4.4-5
- Second attempt - Rebuilt for
  https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Mon Jul 27 2020 Fedora Release Engineering <releng@fedoraproject.org> - 26.4.4-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_33_Mass_Rebuild

* Mon Jun 08 2020 Michal Schorm <mschorm@redhat.com> - 26.4.4-3
- Merge branch 'master' into mariadb-10.5

* Fri Jun 05 2020 Michal Schorm <mschorm@redhat.com> - 26.4.4-2
- Merge branch 'master' into mariadb-10.5

* Thu Apr 09 2020 Michal Schorm <mschorm@redhat.com> - 26.4.4-1
- Rebase to 26.4.4
...
* Wed Nov 27 2019 Michal Schorm <mschorm@redhat.com> - 25.3.28-1
- Merge branch 'master' into mariadb-10.3

* Thu Aug 22 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-4
- Merge branch 'master' into mariadb-10.3

* Sat Jul 20 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-3
- Merge branch 'master' into mariadb-10.3

* Wed Jun 19 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-2
- Add workaround for issues on ARCH64 on Fedora>=30

* Wed Jun 12 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-1
- Rebase to 25.3.26

* Wed Jun 12 2019 Michal Schorm <mschorm@redhat.com> - 25.3.25-4
...
* Thu Jan 03 2019 Michal Schorm <mschorm@redhat.com> - 25.3.25-1
- Rebase to 25.3.25

* Mon Jul 16 2018 Honza Horak <hhorak@redhat.com> - 25.3.23-9
- Revert "Do not require asio on rhel"

* Fri Jul 13 2018 Honza Horak <hhorak@redhat.com> - 25.3.23-8
- Use python3-scons instead of python2 scons

* Fri Jul 13 2018 Honza Horak <hhorak@redhat.com> - 25.3.23-7
- Add explicit gcc-c++ BR

* Fri Jul 13 2018 Honza Horak <hhorak@redhat.com> - 25.3.23-6
- Really do not require asio on rhel

* Fri Jul 13 2018 Honza Horak <hhorak@redhat.com> - 25.3.23-5
- Do not require asio on rhel

* Fri Jul 13 2018 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.23-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_29_Mass_Rebuild

* Tue May 22 2018 Michal Schorm <mschorm@redhat.com> - 25.3.23-3
- Remove no longer needed macro

* Mon Feb 19 2018 Michal Schorm <mschorm@redhat.com> - 25.3.23-2
...
- Update to 25.3.23 Patch upstreamed

* Wed Feb 07 2018 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.22-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_28_Mass_Rebuild

* Fri Nov 24 2017 Honza Horak <hhorak@redhat.com> - 25.3.22-2
- Add upstream PR link for galera-python3.patch

* Fri Nov 24 2017 Honza Horak <hhorak@redhat.com> - 25.3.22-1
- Update to 25.3.22

* Wed Aug 02 2017 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.16-9
- Rebuilt for
  https://fedoraproject.org/wiki/Fedora_27_Binutils_Mass_Rebuild

* Wed Jul 26 2017 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.16-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_27_Mass_Rebuild

* Mon Jul 03 2017 Jonathan Wakely <jwakely@redhat.com> - 25.3.16-7
- Rebuilt for Boost 1.64

* Mon May 15 2017 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.16-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_27_Mass_Rebuild

* Sat Feb 18 2017 Jonathan Wakely <jwakely@redhat.com> - 25.3.16-5
- Use asio-devel instead of bundled asio library

* Fri Feb 10 2017 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.16-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_26_Mass_Rebuild

* Wed Jun 22 2016 Mike Bayer <mike_mp@zzzcomputing.com> - 25.3.16-3
- Generate the sources file yet again

* Wed Jun 22 2016 Mike Bayer <mike_mp@zzzcomputing.com> - 25.3.16-2
- Add a newline to sources

* Wed Jun 22 2016 Mike Bayer <mbayer@redhat.com> - 25.3.16-1
- Update to 25.3.16

* Wed Feb 03 2016 Dennis Gilmore <dennis@ausil.us> - 25.3.12-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_24_Mass_Rebuild

* Fri Jan 15 2016 Jonathan Wakely <jwakely@redhat.com> - 25.3.12-4
- Rebuilt for Boost 1.60

* Mon Oct 26 2015 Marcin Juszkiewicz <mjuszkiewicz@redhat.com> - 25.3.12-3
- Remove use of -mtune=native which breaks build on secondary architectures

* Fri Sep 25 2015 Richard W.M. Jones <rjones@redhat.com> - 25.3.12-2
...
* Wed Jul 29 2015 Dennis Gilmore <dennis@ausil.us> - 25.3.10-4
...
* Wed Jun 17 2015 Dennis Gilmore <dennis@ausil.us> - 25.3.5-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_23_Mass_Rebuild

* Mon Jan 26 2015 Petr Machata <pmachata@redhat.com> - 25.3.5-9
- Rebuild for boost 1.57.0

* Thu Nov 27 2014 Richard W.M. Jones <rjones@redhat.com> - 25.3.5-8
- Add aarch64 support.

* Sat Aug 16 2014 Peter Robinson <pbrobinson@fedoraproject.org> - 25.3.5-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_22_Mass_Rebuild

* Sat Jun 07 2014 Dennis Gilmore <dennis@ausil.us> - 25.3.5-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_Mass_Rebuild

* Fri May 23 2014 Petr Machata <pmachata@redhat.com> - 25.3.5-5
- Rebuild for boost 1.55.0

* Wed Apr 30 2014 Dan Horák <dan@danny.cz> - 25.3.5-4
- set ExclusiveArch

* Mon Apr 28 2014 Ryan O'Hara <rohara@redhat.com> - 25.3.5-3
- Initial import (#1083232)

* Sat Jul 20 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-2
- Workaround bug on F30 ppc64le

* Fri Jul 19 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-1
- Rebase to 25.3.26

* Fri Jul 19 2019 Michal Schorm <mschorm@redhat.com> - 25.3.25-1
- Use macro for setting up the compiler flags

* Fri Aug 02 2019 Michal Schorm <mschorm@redhat.com> - 25.3.26-2
- Fix for #1735233 and #1737108

* Thu Jul 25 2019 Fedora Release Engineering <releng@fedoraproject.org> - 25.3.26-1
...
* Thu May 28 2020 Jonathan Wakely <jwakely@redhat.com> - 26.4.3-1
- Rebuilt for Boost 1.73

* Mon Jun 08 2020 Michal Schorm <mschorm@redhat.com> - 26.4.4-3
- Merge branch 'mariadb-10.4'
...
- Tweak systemd macro usage Start building with GLIBCXX_ASSERTIONS again
...
* Wed Jun 17 2015 Dennis Gilmore <dennis@ausil.us> - 25.3.5-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_23_Mass_Rebuild

* Mon Jan 26 2015 Petr Machata <pmachata@redhat.com> - 25.3.5-7
- Rebuild for boost 1.57.0

* Thu Nov 27 2014 Richard W.M. Jones <rjones@redhat.com> - 25.3.5-6
- Add aarch64 support.

* Sat Aug 16 2014 Peter Robinson <pbrobinson@fedoraproject.org> - 25.3.5-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_22_Mass_Rebuild

* Sat Jun 07 2014 Dennis Gilmore <dennis@ausil.us> - 25.3.5-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_21_Mass_Rebuild

* Fri May 23 2014 Petr Machata <pmachata@redhat.com> - 25.3.5-3
- Rebuild for boost 1.55.0

* Wed Apr 30 2014 Dan Horák <dan@danny.cz> - 25.3.5-2
- set ExclusiveArch

* Mon Apr 28 2014 Ryan O'Hara <rohara@redhat.com> - 25.3.5-1
- Initial import (#1083232)
