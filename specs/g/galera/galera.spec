...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 26.4.27-2
- Uncommitted changes

* Tue Jun 02 2026 Pavol Sloboda <psloboda@redhat.com> - 26.4.27-1
- Rebase to 26.4.27

* Mon May 25 2026 Pavol Sloboda <psloboda@redhat.com> - 26.4.26-1
- Rebase to 26.4.26

* Wed May 13 2026 Pavol Sloboda <psloboda@redhat.com> - 26.4.25-5
- Release bump for openssl4 patch

* Wed May 13 2026 Pavol Sloboda <psloboda@redhat.com> - 26.4.25-4
- Added the mariadb galera centos-stream tests to ensure that galera is
  getting gated on Fedora as well

* Wed May 13 2026 Pavol Sloboda <psloboda@redhat.com> - 26.4.25-3
- Added a patch fixing the build with openssl4 by using the opaque
  implementation of the X509_name_st struct as X509_NAME

* Tue Apr 14 2026 Michal Schorm <mschorm@redhat.com> - 26.4.25-2
