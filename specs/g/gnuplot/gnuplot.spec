...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.0.3-7
- feat(render): convert static changelogs to interleaved releases for g*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.0.3-6
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Tue Aug 12 2025 Antonio Trande <sagitter@fedoraproject.org> - 6.0.3-4
- Include libcerf support on s390x (pagure issue #12873)
...
* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 6.0.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Tue Jun 25 2024 Pavel Cahyna <pcahyna@redhat.com> - 6.0.1-2
- Add --with-bitmap-terminals to configure flags, among others this enables
  the pbm terminal, see bz#2122652

* Mon Jun 10 2024 Yaakov Selkowitz <yselkowi@redhat.com> - 6.0.1-1
- Update to 6.0.1 (rhbz#2283856)

* Fri May 03 2024 Orion Poplawski <orion@nwra.com> - 6.0.0-1
- Update to 6.0.0

* Wed Jan 24 2024 Fedora Release Engineering <releng@fedoraproject.org> - 5.4.9-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jan 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 5.4.9-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild
