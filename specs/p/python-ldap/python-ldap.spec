...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.4.7-2
- Uncommitted changes

* Wed Jun 10 2026 Simon Pichugin <spichugi@redhat.com> - 3.4.7-1
- Update to 3.4.7 version

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.5-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 16 2025 Simon Pichugin <spichugi@redhat.com> - 3.4.5-1
- Update to 3.4.5 version

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.4.4-13
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 3.4.4-12
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.4-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 3.4.4-10
- Rebuilt for Python 3.14

* Tue Apr 01 2025 Miro Hrončok <miro@hroncok.cz> - 3.4.4-9
- Remove redundant and duplicated manual runtime Requires
- python3-setuptools is not needed

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.4-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Thu Oct 10 2024 Simon Pichugin <spichugi@redhat.com> - 3.4.4-7
- RHEL: Instead of not running the tests, skip tests requiring openldap-
  servers

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.4-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Thu Jun 27 2024 Yaakov Selkowitz <yselkowi@redhat.com> - 3.4.4-5
...
* Wed Nov 22 2023 Simon Pichugin <spichugi@redhat.com> - 3.4.4-1
- Update to 3.4.4 version

* Fri Jul 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.3-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Wed Jun 14 2023 Python Maint <python-maint@redhat.com> - 3.4.3-3
- Rebuilt for Python 3.12

* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Fri Sep 30 2022 Simon Pichugin <spichugi@redhat.com> - 3.4.3-1
- Update to 3.4.3

* Fri Jul 29 2022 Simon Pichugin <spichugi@redhat.com> - 3.4.2-1
- Update to 3.4.2
