...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.0.0-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.0.0-3
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.0.0-2
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Oct 30 2025 Jeremy Cline <jeremycline@linux.microsoft.com> - 5.0.0-1
- Update to v5.0.0
...
* Mon Nov 25 2024 Jeremy Cline <jeremycline@linux.microsoft.com> - 3.1.0-1
- Update to v3.1.0

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.0-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Sat Jun 08 2024 Python Maint <python-maint@redhat.com> - 3.0.0-7
- Rebuilt for Python 3.13

* Fri Jan 26 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Sun Jan 21 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Fri Jul 21 2023 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_39_Mass_Rebuild

* Thu Jun 29 2023 Python Maint <python-maint@redhat.com> - 3.0.0-3
- Rebuilt for Python 3.12

* Mon May 08 2023 Major Hayden <major@redhat.com> - 3.0.0-2
- S

* Thu Apr 06 2023 Major Hayden <major@redhat.com> - 3.0.0-1
- Update to 3.0.0 rhbz#2184352

* Fri Jan 20 2023 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_38_Mass_Rebuild

* Fri Oct 14 2022 Major Hayden <major@redhat.com> - 2.2.0-1
- Update to 2.2.0

* Fri Jul 22 2022 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_37_Mass_Rebuild

* Tue Jul 05 2022 Major Hayden <major@redhat.com> - 2.1.0-1
- Update to 2.1.0

* Thu Jun 23 2022 Major Hayden <major@redhat.com> - 2.1.0~b2-4
- Add import check

* Wed Jun 15 2022 Python Maint <python-maint@redhat.com> - 2.1.0~b2-3
- Rebuilt for Python 3.11

* Mon May 02 2022 Major Hayden <major@mhtx.net> - 2.1.0~b2-2
- Disable tests in EPEL 9

* Thu Apr 07 2022 Major Hayden <major@mhtx.net> - 2.1.0~b2-1
- Update to 2.1.0b2
...
* Wed Sep 08 2021 Major Hayden <major@mhtx.net> - 2.0.0-3
- Move obsoletes into subpackage

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Wed Jul 14 2021 Major Hayden <major@mhtx.net> - 2.0.0-1
- Update to 2.0.0

* Fri Jun 18 2021 Major Hayden <major@mhtx.net> - 1.0.1-1
- Initial import (#1971775)
