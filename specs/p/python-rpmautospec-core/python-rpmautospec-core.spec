...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.1.5-11
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.1.5-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 16 2025 Nils Philippsen <nils@redhat.com> - 0.1.5-9
- Remove option to check coverage in tests
