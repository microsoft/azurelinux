...
* Fri Sep 18 2026 Unknown User <please-configure-git-user@example.com> - 8.3-2
- Uncommitted changes

* Thu Aug 20 2026 Packit <hello@packit.dev> - 8.3-1
- Update to 8.3 upstream release
- Resolves: rhbz#2520218

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 8.2-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 8.2-4
- Rebuilt for Python 3.15

* Tue Mar 31 2026 Lumir Balhar <lbalhar@redhat.com> - 8.2-3
- Fix test failure with Python 3.15

* Tue Mar 31 2026 Lumir Balhar <lbalhar@redhat.com> - 8.2-2
- Remove needless complexity from %%check

* Mon Mar 09 2026 Michel Lind <salimma@fedoraproject.org> - 8.2-1
- Update to 8.2 upstream release
- Resolves: rhbz#2432319
- Enable Packit

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 8.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sun Nov 02 2025 Lumir Balhar <lbalhar@redhat.com> - 8.1-1
