...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.6.2-2
- Uncommitted changes

* Tue Aug 11 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.2-1
- Update to 4.6.2 (close RHBZ#2513712)

* Wed Jul 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.1-1
- Update to 4.6.1 (close RHBZ#2505230)

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.6.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 4.6.0-5
- Rebuilt for Python 3.15

* Wed May 20 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.0-4
- Use various long options

* Fri May 08 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.0-3
- Use long pyproject options

* Wed Apr 29 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.0-2
- Use %%pyproject_patch_dependency in lieu of sed

* Wed Apr 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 4.6.0-1
- Update to 4.6.0 (close RHBZ#2460403)
