...
%{load:%{_sourcedir}/p11-kit.azl.macros}
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.26.2-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.26.2-4
- build: mass rebuild auto-bumpable components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 0.26.2-3
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.26.2-2
