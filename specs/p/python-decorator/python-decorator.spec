...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.2.1-8
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.2.1-7
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5.2.1-6
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 5.2.1-5
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 5.2.1-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5.2.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 5.2.1-2
- Rebuilt for Python 3.14

* Wed Apr 30 2025 Nils Philippsen <nils@redhat.com> - 5.2.1-1
- Update to 5.2.1
...
* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 5.1.1-10
