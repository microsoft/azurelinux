...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.14.3-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.14.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Nov 14 2025 Lumir Balhar <lbalhar@redhat.com> - 3.14.3-1
- Update to 3.14.3 (rhbz#2408771)

* Fri Oct 10 2025 Troy Curtis Jr <troy@troycurtisjr.com> - 3.14.1-1
- Update to 3.14.1.
- Fixes rhbz#2357336
- Update the URL to point to the new rapidfuzz GitHub organization.
