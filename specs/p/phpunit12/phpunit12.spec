...
# remirepo/fedora spec file for phpunit12
#
...
%if 0%{?fedora} == 42 || 0%{?fedora} == 43 || 0%{?rhel} == 10
...
BuildRequires:  (php-composer(sebastian/diff) >= 7.0.1                with php-composer(sebastian/diff) < 8)
...
BuildRequires:  (php-composer(sebastian/global-state) >= 8.0.3        with php-composer(sebastian/global-state) < 9)
...
Requires:       (php-composer(sebastian/diff) >= 7.0.1                with php-composer(sebastian/diff) < 8)
...
Requires:       (php-composer(sebastian/global-state) >= 8.0.3        with php-composer(sebastian/global-state) < 9)
...
\Fedora\Autoloader\Dependencies::required([
    '%{php_home}/SebastianBergmann/CodeCoverage12/autoload.php',
    '%{php_home}/SebastianBergmann/FileIterator6/autoload.php',
    '%{php_home}/SebastianBergmann/Template5/autoload.php',
    '%{php_home}/SebastianBergmann/Timer8/autoload.php',
    '%{php_home}/SebastianBergmann/CliParser4/autoload.php',
    '%{php_home}/SebastianBergmann/Invoker6/autoload.php',
    '%{php_home}/SebastianBergmann/Diff7/autoload.php',
    '%{php_home}/SebastianBergmann/Comparator7/autoload.php',
    '%{php_home}/SebastianBergmann/Environment8/autoload.php',
    '%{php_home}/SebastianBergmann/Exporter7/autoload.php',
    '%{php_home}/SebastianBergmann/GlobalState8/autoload.php',
    '%{php_home}/SebastianBergmann/ObjectEnumerator7/autoload.php',
    '%{php_home}/SebastianBergmann/RecursionContext7/autoload.php',
    '%{php_home}/SebastianBergmann/Type6/autoload.php',
    '%{php_home}/SebastianBergmann/Version6/autoload.php',
...
- raise dependency on phpunit/php-file-iterator 6.0.2
- raise dependency on sebastian/diff 7.0.1

* Tue Jul 28 2026 Remi Collet <remi@remirepo.net> - 12.5.33-1
- update to 12.5.33
...
* Sun Apr 19 2026 Remi Collet <remi@remirepo.net> - 12.5.23-1
- update to 12.5.23

* Thu Apr 16 2026 Remi Collet <remi@remirepo.net> - 12.5.21-1
- update to 12.5.21
- raise dependency on phpunit/php-code-coverage 12.5.6
- raise dependency on sebastian/environment 8.1.0

* Wed Apr 15 2026 Remi Collet <remi@remirepo.net> - 12.5.20-1
- update to 12.5.20
- raise dependency on sebastian/comparator 7.1.6

* Mon Apr 13 2026 Remi Collet <remi@remirepo.net> - 12.5.19-1
- update to 12.5.19
...
* Wed Feb 18 2026 Remi Collet <remi@remirepo.net> - 12.5.13-1
- update to 12.5.13

* Tue Feb 17 2026 Remi Collet <remi@remirepo.net> - 12.5.12-1
- update to 12.5.12
...
- update to 12.3.11
- raise dependency on sebastian/cli-parser 4.1
