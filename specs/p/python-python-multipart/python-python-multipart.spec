...
BuildOption(install): --assert-license python_multipart multipart
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.0.32-2
- Uncommitted changes

* Fri Jun 05 2026 Packit <hello@packit.dev> - 0.0.32-1
- Update to 0.0.32 upstream release
- Resolves: rhbz#2484846

* Thu Jun 04 2026 Packit <hello@packit.dev> - 0.0.31-1
- Update to 0.0.31 upstream release
- Resolves: rhbz#2484715

* Mon Jun 01 2026 Packit <hello@packit.dev> - 0.0.30-1
- Update to 0.0.30 upstream release
- Resolves: rhbz#2483639

* Mon May 18 2026 Packit <hello@packit.dev> - 0.0.29-1
- Update to 0.0.29 upstream release
- Resolves: rhbz#2478325

* Mon May 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.0.28-2
- Use long pyproject options

* Mon May 11 2026 Packit <hello@packit.dev> - 0.0.28-1
- Update to 0.0.28 upstream release
- Resolves: rhbz#2468595

* Mon Apr 27 2026 Packit <hello@packit.dev> - 0.0.27-1
- Update to 0.0.27 upstream release
- Resolves: rhbz#2463212

* Sat Apr 11 2026 Packit <hello@packit.dev> - 0.0.25-1
- Update to 0.0.25 upstream release
- Resolves: rhbz#2457310

* Mon Apr 06 2026 Packit <hello@packit.dev> - 0.0.24-1
- Update to 0.0.24 upstream release
- Resolves: rhbz#2455236
