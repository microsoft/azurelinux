...
* Mon Apr 06 2026 azldev <> - 46.0.5-2
- Latest state for python-cryptography
...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 45.0.4-4
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 45.0.4-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 45.0.4-2
