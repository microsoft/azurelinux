...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.1.0-21
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.1.0-20
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.1.0-19
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1.1.0-18
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1.1.0-17
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.1.0-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 1.1.0-15
...
* Sat Jun 08 2024 Python Maint <python-maint@redhat.com> - 1.1.0-12
...
* Thu Jun 29 2023 Python Maint <python-maint@redhat.com> - 1.1.0-8
- Rebuilt for Python 3.12

* Mon May 08 2023 Major Hayden <major@redhat.com> - 1.1.0-7
- S
...
* Tue Jun 28 2022 Major Hayden <major@redhat.com> - 1.1.0-4
- Add import check

* Thu Jun 16 2022 Python Maint <python-maint@redhat.com> - 1.1.0-3
- Rebuilt for Python 3.11

* Mon Apr 25 2022 Major Hayden <major@mhtx.net> - 1.1.0-2
- Disable tests

* Tue Mar 01 2022 Major Hayden <major@mhtx.net> - 1.1.0-1
- Update to 1.1.0
...
* Mon Sep 27 2021 Major Hayden <major@mhtx.net> - 0.3.0-3
- Switch to rpmautospec

* Wed Sep 08 2021 Major Hayden <major@mhtx.net> - 0.3.0-2
- Move obsoletes into subpackage

* Tue Sep 07 2021 Major Hayden <major@mhtx.net> - 0.3.0-1
- Update to 0.3.0

* Fri Jul 23 2021 Major Hayden <major@mhtx.net> - 0.2.0-5
- Cleanup to bring in line with other Azure packages

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Wed Jul 14 2021 Major Hayden <major@mhtx.net> - 0.2.0-3
- Remove unneccessary __init__.py files to avoid file conflicts

* Wed Jul 07 2021 Major Hayden <major@mhtx.net> - 0.2.0-2
- Remove custom wheel builder

* Sun Jul 04 2021 Major Hayden <major@mhtx.net> - 0.2.0-1
- Initial import (#1971813)
