...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.37.1-33
- Uncommitted changes

* Thu Mar 12 2026 Miro Hrončok <miro@hroncok.cz> - 0.37.1-32
- Include SBOM in the .whl file in python-wheel0.37-wheel

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.37.1-31
