...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 7.1.0-7
- feat(render): convert static changelogs to interleaved releases for p*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 7.1.0-6
...
* Wed Feb 11 2026 William Cohen <wcohen@redhat.com> - 7.1.0-3
- Reworked selinx policy fixes.

* Mon Feb 9 2026 William Cohen <wcohen@redhat.com> - 7.1.0-2
- Selinux policy fix for services.
...
- Fix tmpfiles.d handling of some config dirs (BZ 2372945)
- Latest upstream release (BZ 2382655)

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 6.3.7-11
