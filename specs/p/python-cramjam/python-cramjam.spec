...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.12.1-2
- Uncommitted changes

* Tue Aug 25 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.12.1-1
- Update to 2.12.1 (close RHBZ#2523441)

* Sat Aug 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.12.0-1
- Update to 2.12.0 (close RHBZ#2457848)

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.11.0-14
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.11.0-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sat Jun 20 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.11.0-12
- Update to PyO3 0.29

* Sat Jun 20 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.11.0-11
- Port to PyO3 0.28
- Update `License` expression

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 2.11.0-10
- Rebuilt for Python 3.15

* Fri May 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.11.0-9
- Use various long options

* Mon May 11 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.11.0-7
