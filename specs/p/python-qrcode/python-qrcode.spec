...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 8.0-12
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 8.0-11
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 8.0-10
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 8.0-9
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 8.0-8
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 8.0-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 8.0-6
- Rebuilt for Python 3.14

* Thu May 08 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 8.0-5
- Use flit-core instead of poetry-core on RHEL

* Thu May 08 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 8.0-4
- Add png and all extras

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 8.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sat Nov 16 2024 Sandro Mani <manisandro@gmail.com> - 8.0-2
- Add pil extra subpackage

* Sat Nov 16 2024 Sandro Mani <manisandro@gmail.com> - 8.0-1
- Update to 8.0
