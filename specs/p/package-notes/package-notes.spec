...
* Tue Jun 09 2026 azldev <azldev@local> - 0.5-24
- Local changes (uncommitted)

* Tue Jun 09 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-23
- chore(package-notes): switch to manual release with a single changelog
  entry

* Mon Jun 08 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-22
- feat(package-notes): self-test that .note.package overlays applied

* Mon Jun 08 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-21
- revert(cpe): keep azurelinux project name in CPE, defer azure_linux
  rename

* Wed Jun 03 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-20
- fix(cpe): use microsoft:azure_linux project name in CPE everywhere

* Wed Jun 03 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-19
- fix(package-notes): truncate moduleVersion fields at first non-digit

* Tue Jun 02 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-18
- feat(package-notes): embed 4-part moduleVersion in .note.package ELF
  metadata

* Fri May 29 2026 Andrew Phelps <anphel@microsoft.com> - 0.5-17
- switch ELF metadata osCpe to Microsoft as vendor
