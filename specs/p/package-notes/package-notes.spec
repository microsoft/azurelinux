...
%build
sed -e "s|@OSCPE@|cpe:/o:microsoft:azure_linux:4.0|" -e "s|@OS@|azure_linux|" -e "s|@OSVERSION@|4.0|" %{SOURCE0} >redhat-package-notes
...
* Thu Jun 04 2026 azldev <azldev@local> - 0.5-21
