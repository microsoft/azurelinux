...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.10.2-9
- Uncommitted changes

* Wed Jan 21 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 3.10.2-8
- Rebuilt for blosc2-2.22.0

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.10.2-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.10.2-6
