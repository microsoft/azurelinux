...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.12.5-5
- Uncommitted changes

* Tue Aug 25 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.12.5-4
- Patch a test for typing-extensions 4.16 compatibility

* Sun Jan 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.12.5-3
- Skip a test that was expected to fail, but passes in Python 3.14.1+

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.12.5-2
