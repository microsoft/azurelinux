...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 235-20
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 235-19
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 235-18
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 235-17
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 235-16
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 235-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 235-14
- Rebuilt for Python 3.14

* Sun Jan 19 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 235-13
- Fix build with latest sphinx

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 235-12
