...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.6.0-2
- Uncommitted changes

* Mon Mar 09 2026 Vojtech Trefny <vtrefny@redhat.com> - 1.6.0-1
- Update to 1.6.0 (#2445178)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.5.5-19
