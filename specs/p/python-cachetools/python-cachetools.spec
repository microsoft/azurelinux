...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 7.0.0-2
- Uncommitted changes

* Tue Feb 03 2026 John Eckersberg <jeckersb@redhat.com> - 7.0.0-1
- New upstream release 7.0.0 (rhbz#2435823)

* Wed Jan 28 2026 John Eckersberg <jeckersb@redhat.com> - 6.2.6-1
- New upstream release 6.2.6 (rhbz#2433620)

* Mon Jan 26 2026 John Eckersberg <jeckersb@redhat.com> - 6.2.5-1
- New upstream release 6.2.5 (rhbz#2432684)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.2.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Dec 15 2025 John Eckersberg <jeckersb@redhat.com> - 6.2.3-1
- New upstream release 6.2.3 (rhbz#2421891)

* Thu Nov 13 2025 John Eckersberg <jeckersb@redhat.com> - 6.2.2-1
- New upstream release 6.2.2 (rhbz#2414887)

* Mon Oct 13 2025 John Eckersberg <jeckersb@redhat.com> - 6.2.1-1
- New upstream release 6.2.1 (rhbz#2403373)

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 6.2.0-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Mon Aug 25 2025 John Eckersberg <jeckersb@redhat.com> - 6.2.0-1
- New upstream release 6.2.0 (rhbz#2353472)
