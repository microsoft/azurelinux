...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.54.5-7
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.54.5-6
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.54.5-5
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Sun Nov 02 2025 Neal Gompa <ngompa@fedoraproject.org> - 3.54.5-4
- Re-add gobject-introspection BR for test suite

* Sun Nov 02 2025 Neal Gompa <ngompa@fedoraproject.org> - 3.54.5-3
- Add missing gcc BR

* Sat Nov 01 2025 Neal Gompa <ngompa@fedoraproject.org> - 3.54.5-2
- Drop unused gobject-introspection due to migration to glib2

* Mon Oct 20 2025 Matthias Clasen <mclasen@redhat.com> - 3.54.5-1
- Update to 3.54.5

* Mon Sep 29 2025 David King <amigadave@amigadave.com> - 3.54.3-1
- Update to 3.54.3

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.54.2-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Tue Sep 16 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 3.54.2-1
- Update to 3.54.2

* Mon Sep 08 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 3.54.0-1
- Update to 3.54.0

* Mon Sep 08 2025 Michael Catanzaro <mcatanzaro@redhat.com> - 3.53.0-4
- Fix warning when importing Gio

* Fri Sep 05 2025 Michael Catanzaro <mcatanzaro@gnome.org> - 3.53.0-2
- Add GDesktopAppInfo compatibility patch

* Thu Sep 04 2025 Michael Catanzaro <mcatanzaro@gnome.org> - 3.53.0-1
- Update to 3.53.0
