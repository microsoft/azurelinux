...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.1.0-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Jan 13 2026 Lumir Balhar <lbalhar@redhat.com> - 3.1.0-1
- Update to 3.1.0 (rhbz#2428707)

* Wed Nov 19 2025 Karolina Surma <ksurma@redhat.com> - 3.0.2-8
- Unpin upper-bound python-docutils version

* Tue Sep 30 2025 Karolina Surma <ksurma@redhat.com> - 3.0.2-7
- Make it possible to serve documentation with working fonts (rhbz#2398276)
