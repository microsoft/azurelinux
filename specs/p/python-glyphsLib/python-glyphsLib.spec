...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 6.14.0-2
- Uncommitted changes

* Sun Aug 02 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.14.0-1
- Update to 6.14.0 (close RHBZ#2510097)

* Sun Aug 02 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.13.1-10
- Use the provisional pyproject declarative buildsystem

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.13.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 05 2026 Python Maint <python-maint@redhat.com> - 6.13.1-2
- Rebuilt for Python 3.15

* Tue Apr 28 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.13.1-1
- Update to 6.13.1 (close RHBZ#2463535)

* Wed Apr 15 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.13.0-3
- Adapt tests for markClassPrefix change in ufo2ft 3.7.1

* Wed Apr 15 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.13.0-2
- Report and skip two test regressions with ufo2ft 3.7.1

* Tue Mar 10 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.13.0-1
- Update to 6.13.0 (close RHBZ#2445799)
