...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.16.0-4
- feat(render): convert static changelogs to interleaved releases for p*
  components

* Tue May 05 2026 Chris Co <chrco@microsoft.com> - 0.16.0-3
- fix(pkg): pin python-s3transfer to last building commit from upstream

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.16.0-2
