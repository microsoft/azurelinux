...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.20.0-12
- Uncommitted changes

* Wed Apr 01 2026 Michael J Gruber <mjg@fedoraproject.org> - 4.20.0-11
- Add selenium-manager symlink (rhbz#2278096)
