...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 26.7.0-2
- Uncommitted changes

* Sun Jul 26 2026 Antonio Trande <sagitter@fedoraproject.org> - 26.7.0-1
- Release 26.7.0

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 25.9.1-4
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 25.9.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 25.9.1-2
- Rebuilt for Python 3.15

* Sat Jan 24 2026 Antonio Trande <sagitter@fedoraproject.org> - 25.9.1-1
- Release 25.9.1

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 24.11.1-8
