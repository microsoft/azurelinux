...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.13.0-2
- Uncommitted changes

* Mon Jun 29 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.13.0-1
- Update to 0.13.0 (close RHBZ#2493936)

* Sun Jun 21 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.12.1-3
- Update examples to use PyO3 0.29

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.12.1-2
- Rebuilt for Python 3.15

* Thu Mar 26 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.12.1-1
- Update to 1.12.1 (close RHBZ#2451650)

* Fri Feb 27 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.12.0-2
- Allow building examples with PyO3 0.26, 0.27, and 0.28

* Fri Feb 27 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.12.0-1
- Update to 1.12.0 (close RHBZ#2391898)

* Fri Feb 27 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.11.1-7
- Be more precise about RHEL-vs-non-RHEL conditionals
