...
%pytest -v -W ignore::DeprecationWarning -W ignore::pytest.PytestUnraisableExceptionWarning
...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.18.1-10
- Uncommitted changes

* Thu Jan 22 2026 Tomáš Hrnčiar <thrnciar@redhat.com> - 0.18.1-9
- Temporarily ignore PytestUnraisableExceptionWarning

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.18.1-8
