...
%global common_desc %{expand:This package contains a Sphinx extension for BibTeX style citations.
...
* Wed May 06 2026 Jerry James <loganjerry@gmail.com> - 2.7.0-1
- Version 2.7.0
- Drop upstreamed patch for docutils 0.22 compatibility

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.6.5-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Nov 24 2025 Karolina Surma <ksurma@redhat.com> - 2.6.5-6
- Fix compatibility with docutils 0.22+

* Tue Nov 04 2025 Jerry James <loganjerry@gmail.com> - 2.6.5-5
- Do not use code coverage tools
- Run the autoapi tests
