...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 6.1.1-2
- Uncommitted changes

* Wed May 20 2026 Lumir Balhar <lbalhar@redhat.com> - 6.1.1-1
- Update to 6.1.1 (rhbz#2479697)

* Tue Apr 21 2026 Lumir Balhar <lbalhar@redhat.com> - 6.1.0-1
- Update to 6.1.0 (rhbz#2459408)

* Sun Apr 12 2026 Lumir Balhar <lbalhar@redhat.com> - 6.0.4-1
- Update to 6.0.4 (rhbz#2456899)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.0.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Sep 22 2025 Lumir Balhar <lbalhar@redhat.com> - 6.0.2-1
- Update to 6.0.2 (rhbz#2397231)
