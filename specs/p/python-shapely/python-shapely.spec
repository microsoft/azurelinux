...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.1.2-11
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.2-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Jan 14 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 2.1.2-9
- Drop support for i686

* Sat Dec 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-8
- Use the provisional pyproject declarative buildsystem

* Sat Dec 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-7
- Add an import “smoke test”

* Sat Dec 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-6
- Enable matplotlib-related tests

* Sat Dec 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-5
- Print reasons for skipped tests

* Sat Dec 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-3
- Report the failing doctest upstream
