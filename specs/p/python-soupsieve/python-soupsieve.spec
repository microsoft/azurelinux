...
* Tue Jan 20 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.8.3-1
- Version 2.8.3 (rhbz#2431119)
- Yet another tiny bugfix.

* Mon Jan 19 2026 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.8.2-1
- Version 2.8.2 (rhbz#2423595)
- Four bugfixes, nothing major.
...
* Fri Sep 12 2025 Zbigniew Jędrzejewski-Szmek <zbyszek@in.waw.pl> - 2.8-1
- Version 2.8 (rhbz#2391304)

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.7-5
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 2.7-3
- Rebuilt for Python 3.14

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 2.7-2
- Bootstrap for Python 3.14

* Sun Apr 27 2025 Romain Geissler <romain.geissler@amadeus.com> - 2.7-1
- Upgrade to upstream version 2.7 (rhbz#2361253)

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.6-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Sep 24 2024 Karolina Surma <ksurma@redhat.com> - 2.6-3
