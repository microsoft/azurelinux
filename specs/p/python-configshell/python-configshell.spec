...
%changelog
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1:2.0.2-4
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1:2.0.2-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:2.0.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 23 2025 Packit <hello@packit.dev> - 1:2.0.2-1
- Update to version 2.0.2

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 1:1.1.30-10
