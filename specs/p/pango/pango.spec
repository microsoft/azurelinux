...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.57.1-2
- Uncommitted changes

* Mon Mar 23 2026 Milan Crha <mcrha@redhat.com> - 1.57.1-1
- Update to 1.57.1

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 1.57.0-7
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 1.57.0-6
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 1.57.0-5
- Onboard to Packit for stable Fedora branches

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.57.0-4
