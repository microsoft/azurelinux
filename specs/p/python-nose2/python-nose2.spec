...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.16.0-4
- Uncommitted changes

* Fri May 01 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.16.0-3
- Fix Obsoletes for python-nose2+coverage_plugin

* Fri May 01 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.16.0-2
- Use %%pyproject_patch_dependency in lieu of tomcli

* Mon Mar 09 2026 Packit <hello@packit.dev> - 0.16.0-1
- Update to 0.16.0 upstream release
- Resolves: rhbz#2444837

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.15.1-19
