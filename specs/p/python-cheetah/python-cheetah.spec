...
* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.4.0-7
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 3.4.0-6
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.4.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 3.4.0-4
- Rebuilt for Python 3.14

* Sun Mar 30 2025 Carl George <carlwgeorge@fedoraproject.org> - 3.4.0-3
...
* Fri Dec 13 2024 Mike Bonnet <mikeb@redhat.com> - 3.4.0-1
- Update to the 3.4.0 release

* Tue Sep 24 2024 Carl George <carlwgeorge@fedoraproject.org> - 3.3.3.post1-1
- Update to 3.3.3.post1 rhbz#2313699
- Add upstream patch for Python 3.13 compatibility
