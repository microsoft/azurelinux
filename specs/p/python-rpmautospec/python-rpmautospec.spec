...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.8.3-6
- feat(render): convert static changelogs to interleaved releases for p*
  components

* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.8.3-5
- chore(lockfiles): update existing autochangelog packages to new lockfile
  format

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.8.3-4
