...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.10.3-2
- Uncommitted changes

* Sun Aug 02 2026 Thomas Moschny <thm@fedoraproject.org> - 3.10.3-1
- Update to 3.10.3.

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.10.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 3.10.2-2
- Rebuilt for Python 3.15

* Sun Mar 01 2026 Thomas Moschny <thm@fedoraproject.org> - 3.10.2-1
- Update to 3.10.2.
