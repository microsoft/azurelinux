...
* Sat Jul 20 2024 Tom Rix <trix@redhat.com> - 2.3.1-21
- Merge #3 `Rebuilt for fmt 11`

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.1-20
...
* Fri Mar 22 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-4
- Remove conditional around the rocm patches

* Fri Mar 22 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-3
- Split the ROCm gpu families out into subpackages.

* Thu Mar 21 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-2
- Update the source to 2.3-rc2

* Thu Mar 21 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-1
- Merge branch 'rhel-test' of ssh://pkgs.fedoraproject.org/rpms/python-
  torch into rawhide

* Sat Mar 16 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-7
- Disable opencv

* Sat Mar 16 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-6
- Sources for pybind11

* Sat Mar 16 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-5
- Sources for flatbuffers

* Sat Mar 16 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-4
- Source for 2.3

* Sat Mar 16 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-3
- Update to 2.3 beta

* Fri Mar 15 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-2
- Enable caffe2

* Tue Mar 12 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240307.975d428-1
- Prep for 2.3 changeover

* Sun Mar 10 2024 Tom Rix <trix@redhat.com> - 2.3.0-12
- Do not remove the empty files

* Sat Mar 09 2024 Tom Rix <trix@redhat.com> - 2.3.0-11
- Update RHEL CUDA

* Fri Mar 08 2024 Tom Rix <trix@redhat.com> - 2.3.0-10
- Update to ToT

* Tue Mar 05 2024 Tom Rix <trix@redhat.com> - 2.3.0-9
- Remove empty files

* Mon Mar 04 2024 Tom Rix <trix@redhat.com> - 2.3.0-8
- Switch to autochangelog

* Sun Mar 03 2024 Tom Rix <trix@redhat.com> - 2.3.0-7
- Update hipblaslt patch

* Thu Feb 29 2024 Tom Rix <trix@redhat.com> - 2.3.0-6
- Generalize rocm build

* Mon Feb 26 2024 Tom Rix <trix@redhat.com> - 2.3.0-5
- optional hipblaslt

* Sat Feb 24 2024 Tom Rix <trix@redhat.com> - 2.3.0-4
- add --with hipblaslt option

* Fri Feb 23 2024 Tom Rix <trix@redhat.com> - 2.3.0-3
- Cleanup combo of rocm and caffe2

* Thu Feb 22 2024 Tom Rix <trix@redhat.com> - 2.3.0-2
- get caffe2 building

* Tue Feb 20 2024 Tom Rix <trix@redhat.com> - 2.3.0-1
- add a --with cuda option

* Mon Feb 19 2024 Tom Rix <trix@redhat.com> - 2.1.2-13
- use third party pybind11

* Mon Feb 19 2024 Tom Rix <trix@redhat.com> - 2.1.2-12
- Try to get cuda going on rhel

* Sun Feb 18 2024 Tom Rix <trix@redhat.com> - 2.1.2-11
- Start building for RHEL

* Sun Feb 18 2024 Tom Rix <trix@redhat.com> - 2.1.2-10
- Update the next patchset

* Sun Feb 18 2024 Tom Rix <trix@redhat.com> - 2.1.2-9
- Update gitcommit to 2/18/24

* Sun Feb 11 2024 Tom Rix <trix@redhat.com> - 2.1.2-8
- Update gitcommit to recent ToT

* Thu Feb 08 2024 Tom Rix <trix@redhat.com> - 2.1.2-7
- Add --with distributed

* Sun Feb 04 2024 Tom Rix <trix@redhat.com> - 2.1.2-6
- A working --with gitcommit --with rocm

* Sat Feb 03 2024 Tom Rix <trix@redhat.com> - 2.1.2-5
- Prepare for the next release

* Fri Jan 26 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Mon Jan 22 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_40_Mass_Rebuild

* Sat Dec 30 2023 Tom Rix <trix@redhat.com> - 2.1.2-2
- Remove debugging cruft

* Sat Dec 30 2023 Tom Rix <trix@redhat.com> - 2.1.2-1
- Update to 2.1.2

* Wed Dec 20 2023 Tom Rix <trix@redhat.com> - 2.1.0-7
- Stub in rocm to test in flight packages

* Thu Dec 14 2023 Tom Rix <trix@redhat.com> - 2.1.0-6
- Move unversioned *.so's to main package

* Sat Dec 02 2023 Tom Rix <trix@redhat.com> - 2.1.0-5
- Initial import

* Wed Mar 20 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-4
- Add roctracer

* Tue Mar 19 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-3
- Better disabling of aotriton

* Tue Mar 19 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-2
- Fix ROCm build

* Sat Mar 16 2024 Tom Rix <trix@redhat.com> - 2.3.0^git20240313.6a89a75-1
- Update to 2.3.0-rc2
