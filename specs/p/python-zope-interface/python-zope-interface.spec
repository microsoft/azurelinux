...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 8.2-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 8.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sun Jan 11 2026 Lumir Balhar <lbalhar@redhat.com> - 8.2-1
- Update to 8.2 (rhbz#2428207)

* Sun Nov 02 2025 Lumir Balhar <lbalhar@redhat.com> - 8.0.1-1
- Update to 8.0.1 (rhbz#2394778)

* Thu Oct 16 2025 Orion Poplawski <orion@nwra.com> - 7.2-9
- Drop coverage dependency, old python_provide macro
