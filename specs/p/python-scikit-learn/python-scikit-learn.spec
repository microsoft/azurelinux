...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.8.0~rc1-4
- Uncommitted changes

* Thu Jan 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.8.0~rc1-3
- Remove upper bound on meson-python version

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.8.0~rc1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Dec 03 2025 Charalampos Stratakis <cstratak@redhat.com> - 1.8.0~rc1-1
- Update to 1.8.0rc1
- Fixes: rhbz#2417322, rhbz#2413963
