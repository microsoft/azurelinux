...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 40.1.2-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 40.1.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Jan 13 2026 Packit <hello@packit.dev> - 40.1.2-1
- Update to 40.1.2 upstream release
- Resolves: rhbz#2429386

* Mon Dec 29 2025 Packit <hello@packit.dev> - 40.1.0-1
- Update to 40.1.0 upstream release
- Resolves: rhbz#2425939

* Mon Dec 29 2025 Packit <hello@packit.dev> - 39.1.0-1
- Update to 39.1.0 upstream release
- Resolves: rhbz#2425841

* Wed Dec 17 2025 Packit <hello@packit.dev> - 39.0.0-1
- Update to 39.0.0 upstream release
- Resolves: rhbz#2402333

* Fri Sep 19 2025 Packit <hello@packit.dev> - 37.8.0-1
- Update to 37.8.0 upstream release
- Resolves: rhbz#2395625

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 37.6.0-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Tue Aug 26 2025 Packit <hello@packit.dev> - 37.6.0-1
- Update to 37.6.0 upstream release
- Resolves: rhbz#2380388

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 37.4.0-3
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 37.4.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Jun 11 2025 Packit <hello@packit.dev> - 37.4.0-1
- Update to 37.4.0 upstream release
- Resolves: rhbz#2372364

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 37.3.0-3
- Rebuilt for Python 3.14

* Mon May 26 2025 Mikel Olasagasti Uranga <mikel@olasagasti.info> - 37.3.0-2
- Drop tzdata module requirenment

* Thu May 15 2025 Packit <hello@packit.dev> - 37.3.0-1
- Update to 37.3.0 upstream release
- Resolves: rhbz#2343037

* Thu Jan 23 2025 Packit <hello@packit.dev> - 35.0.0-1
- Update to 35.0.0 upstream release
- Resolves: rhbz#2335464

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 33.1.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Thu Nov 28 2024 Packit <hello@packit.dev> - 33.1.0-1
- Update to 33.1.0 upstream release
- Resolves: rhbz#2329277

* Thu Nov 14 2024 Packit <hello@packit.dev> - 33.0.0-1
- Update to 33.0.0 upstream release
- Resolves: rhbz#2326165

* Fri Nov 01 2024 Packit <hello@packit.dev> - 30.8.2-1
- Update to 30.8.2 upstream release
- Resolves: rhbz#2323113

* Sat Oct 26 2024 Packit <hello@packit.dev> - 30.8.1-1
- Update to 30.8.1 upstream release
- Resolves: rhbz#2320995

* Mon Oct 21 2024 Mikel Olasagasti Uranga <mikel@olasagasti.info> - 30.6.0-1
- Update to 30.6.0 - Closes rhbz#2313779
