...
* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.5.0-6
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.5.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Karolina Surma <ksurma@redhat.com> - 1.5.0-3
- Fix build with python-setuptools_scm 10+ (rhbz#2453822)

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.5.0-2
- Rebuilt for Python 3.15

* Mon Mar 09 2026 Packit <hello@packit.dev> - 1.5.0-1
- Update to 1.5.0 upstream release
- Resolves: rhbz#2445769
