...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.5.1-12
- Uncommitted changes

* Thu Feb 26 2026 Michel Lind <salimma@fedoraproject.org> - 2.5.1-11
- Enable tests to pass with the latest Django 5.x/6.x

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.5.1-10
