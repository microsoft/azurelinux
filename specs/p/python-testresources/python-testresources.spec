...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.0.2-3
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.0.2-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Tue Aug 26 2025 Carl George <carlwgeorge@fedoraproject.org> - 2.0.2-1
- Update to version 2.0.2 rhbz#2361635

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.0.1-22
