...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.0.0-16
- Uncommitted changes

* Sat Jun 06 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 3.0.0-15
- Backport fix for test_stress_different_keys_threadsafe hang

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 3.0.0-14
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.0.0-13
