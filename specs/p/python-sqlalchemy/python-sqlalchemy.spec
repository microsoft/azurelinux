...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.0.52-2
- Uncommitted changes

* Wed Aug 12 2026 Nils Philippsen <nils@tiptoe.de> - 2.0.52-1
- Update to 2.0.52

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.0.51-3
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.51-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 18 2026 Nils Philippsen <nils@tiptoe.de> - 2.0.51-1
- Update to 2.0.51

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 2.0.50-2
- Rebuilt for Python 3.15

* Mon May 25 2026 Nils Philippsen <nils@tiptoe.de> - 2.0.50-1
- Update to 2.0.50

* Thu Apr 09 2026 Karolina Surma <ksurma@redhat.com> - 2.0.49-2
- Adjust the TypeError message to Python 3.15

* Sat Apr 04 2026 Nils Philippsen <nils@tiptoe.de> - 2.0.49-1
- Update to 2.0.49

* Thu Mar 05 2026 Nils Philippsen <nils@tiptoe.de> - 2.0.48-1
- Update to 2.0.48

* Thu Feb 26 2026 Nils Philippsen <nils@tiptoe.de> - 2.0.47-1
- Update to 2.0.47
