...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.32-9
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.32-8
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.32-7
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.32-6
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.32-5
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.32-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jul 18 2025 Dominik Mierzejewski <dominik@greysector.net> - 0.32-3
- switch to modern python packaging macros (resolves rhbz#2377387)

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 0.32-2
- Rebuilt for Python 3.14

* Sat Feb 22 2025 Dominik Mierzejewski <dominik@greysector.net> - 0.32-1
- update to 0.32 (resolves rhbz#2346620)
