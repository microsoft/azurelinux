...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 25.5.0-7
- Uncommitted changes

* Tue Feb 10 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 25.5.0-6
- Apply upstream fixes for Python 3.14

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 25.5.0-5
