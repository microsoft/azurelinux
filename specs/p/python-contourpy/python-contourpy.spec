...
* Fri Sep 18 2026 Unknown User <please-configure-git-user@example.com> - 1.3.3-10
- Uncommitted changes

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.3.3-9
- Rebuilt for Python 3.15.0b4 ABI change

* Mon Jul 20 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 1.3.3-8
- Re-enable tests on s390x

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.3-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Miro Hrončok <miro@hroncok.cz> - 1.3.3-6
- Cowardly deselect tests failing and/or crashing on s390x to unblock the
  Python 3.15 rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 1.3.3-5
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.3-4
