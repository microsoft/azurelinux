...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 6.0-4
- Uncommitted changes

* Tue Mar 10 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.0-3
- Fix FTBFS due to upstream pinning setuptools to an exact version

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 6.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Oct 20 2025 Dan Radez <dan@radez.net> - 6.0-1
- update to upstream 6.0 rhbz#2394780

* Mon Oct 20 2025 Dan Radez <dan@radez.net> - 5.1-8
- Stop using deprecated %%py3_build/%%py3_install macros rhbz#2378515
