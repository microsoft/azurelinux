...
* Sat Jan 11 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 1.2.0-2
- Allow portalocker 3; fix RHBZ#2336898, fix RHBZ#2337081

* Fri Jul 19 2024 Jeremy Cline <jeremy@jcline.org> - 1.2.0-1
- Merge #1 `Update to 1.2.0, with some packaging enhancements, and enable
  the tests`

* Fri Jul 19 2024 Fedora Release Engineering <releng@fedoraproject.org> - 1.2.0~b1-3
...
* Mon Jun 01 2020 Mohamed El Morabity <melmorabity@fedoraproject.org> - 0.2.2-2
- First import
