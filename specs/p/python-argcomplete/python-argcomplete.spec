...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.6.3-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 3.6.3-4
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 3.6.3-3
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Mon Oct 20 2025 Packit <hello@packit.dev> - 3.6.3-1
- Update to 3.6.3 upstream release
- Resolves: rhbz#2405049

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 3.6.2-7
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 3.6.2-6
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.6.2-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 3.6.2-4
- Rebuilt for Python 3.14

* Thu Apr 17 2025 Miro Hrončok <miro@hroncok.cz> - 3.6.2-2
- Do not interfere with PHP scripts
- Fixes: rhbz#2359689

* Thu Apr 03 2025 Packit <hello@packit.dev> - 3.6.2-1
- Update to 3.6.2 upstream release
- Resolves: rhbz#2354272

* Wed Mar 05 2025 Packit <hello@packit.dev> - 3.6.0-1
- Update to 3.6.0 upstream release
- Resolves: rhbz#2350204

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.5.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Tue Dec 31 2024 Packit <hello@packit.dev> - 3.5.3-1
- Update to 3.5.3 upstream release
- Resolves: rhbz#2335101
