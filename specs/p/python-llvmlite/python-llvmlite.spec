...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.46.0-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.46.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sat Jan 03 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.46.0-1
- Update to 0.46.0 (close RHBZ#2415071)

* Thu Oct 16 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 0.45.1-1
- Update to 0.45.1 (close RHBZ#2396540)
