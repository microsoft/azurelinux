...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.5.1-2
- Uncommitted changes

* Sat Aug 08 2026 Packit <hello@packit.dev> - 1.5.1-1
- Update to 1.5.1 upstream release
- Resolves: rhbz#2512726

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 1.5.0-9
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.5.0-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jun 19 2026 Sandro Mani <manisandro@gmail.com> - 1.5.0-7
- Rebuild (gdal)

* Wed Jun 10 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 1.5.0-6
- Skip a test that is now broken on Python 3.15

* Fri Jun 05 2026 Python Maint <python-maint@redhat.com> - 1.5.0-5
- Rebuilt for Python 3.15

* Wed Apr 29 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 1.5.0-4
...
* Sun Jan 11 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 1.5.0-2
- Drop support for i686

* Tue Jan 06 2026 Packit <hello@packit.dev> - 1.5.0-1
- Update to 1.5.0 upstream release
- Resolves: rhbz#2422323
