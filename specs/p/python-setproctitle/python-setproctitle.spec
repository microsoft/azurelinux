...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.3.7-5
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.3.7-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Nov 04 2025 Karolina Surma <ksurma@redhat.com> - 1.3.7-3
- Fix segfault with Python 3.15.0a1
