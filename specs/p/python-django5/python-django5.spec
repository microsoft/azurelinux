...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 5.2.16-2
- Uncommitted changes
...
* Sat Jun 06 2026 Michel Lind <salimma@fedoraproject.org> - 5.2.15-4
- Remove dump of disabled tests from the end of the spec

* Sat Jun 06 2026 Michel Lind <salimma@fedoraproject.org> - 5.2.15-3
- Disable failing tests on Python 3.15

* Fri Jun 05 2026 Michel Lind <salimma@fedoraproject.org> - 5.2.15-2
- Rebuilt for Python 3.15

* Fri Jun 05 2026 Michel Lind <salimma@fedoraproject.org> - 5.2.15-1
...
* Fri Jun 05 2026 Python Maint <python-maint@redhat.com> - 5.2.14-3
- Rebuilt for Python 3.15

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 5.2.14-2
