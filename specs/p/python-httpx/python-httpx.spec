...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.28.1-12
- Uncommitted changes

* Sun Feb 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.28.1-11
- Adapt test_response_decode_text_using_autodetect for chardet 6.0

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.28.1-10
