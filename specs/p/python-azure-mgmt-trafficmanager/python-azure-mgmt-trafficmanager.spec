...
# Upstream has not provided tests yet.
%bcond_with     tests
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.0.0-21
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.0.0-20
- build: mass rebuild auto-bumpable components
...
* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 1.0.0-15
...
* Sat Jun 08 2024 Python Maint <python-maint@redhat.com> - 1.0.0-12
...
* Mon May 08 2023 Major Hayden <major@redhat.com> - 1.0.0-7
- S
...
* Tue Feb 08 2022 Major Hayden <major@mhtx.net> - 1.0.0-2
- Update doc filenames

* Tue Feb 08 2022 Major Hayden <major@mhtx.net> - 1.0.0-1
- update to 1.0.0

* Fri Jan 21 2022 Fedora Release Engineering <releng@fedoraproject.org> - 0.51.0-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_36_Mass_Rebuild

* Wed Sep 08 2021 Major Hayden <major@mhtx.net> - 0.51.0-4
- Move obsoletes into subpackage

* Fri Jul 23 2021 Major Hayden <major@mhtx.net> - 0.51.0-3
- Remove python version macros

* Fri Jul 23 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.51.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_35_Mass_Rebuild

* Sat Jul 03 2021 Major Hayden <major@mhtx.net> - 0.51.0-1
- Initial import (#1971866)
