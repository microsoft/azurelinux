...
BuildRequires:  (php-composer(sebastian/exporter) >= 8.2.1            with php-composer(sebastian/exporter) < 9)
...
Requires:       (php-composer(sebastian/exporter) >= 8.2.1            with php-composer(sebastian/exporter) < 9)
...
\Fedora\Autoloader\Dependencies::required([
    ...
    '%{php_home}/SebastianBergmann/Diff9/autoload.php',
    ...
    '%{php_home}/SebastianBergmann/FileFilter1/autoload.php',
...
DEV='-d display_errors=1 -d display_startup_errors=1 -d error_reporting=-1 -d zend.assertions=1 -d memory_limit=-1'
OPT='--filter "^((?!(testIsInitialized|testExclusionOfFileCanBeQueried|testTestRunHistoryFileIsLocatedNextToTheScriptThatIsRunning)).)*$" --testsuite=unit --no-coverage'
...
- raise dependency on phpunit/php-file-iterator 7.0.1
- raise dependency on sebastian/object-enumerator 8.1.0
- raise dependency on sebastian/type 7.0.2

* Fri Aug  7 2026 Remi Collet <remi@remirepo.net> - 13.3.0-1
- update to 13.3.0
- raise dependency on phpunit/php-code-coverage 14.3
- raise dependency on sebastian/cli-parser 5.0.1
- raise dependency on sebastian/comparator 8.4
- raise dependency on sebastian/exporter 8.2.1
- raise dependency on sebastian/recursion-context 8.0.1

* Tue Jul 28 2026 Remi Collet <remi@remirepo.net> - 13.2.6-1
- update to 13.2.6
...
* Tue Jul  7 2026 Remi Collet <remi@remirepo.net> - 13.2.3-1
- update to 13.2.3
...
* Fri Jun  5 2026 Remi Collet <remi@remirepo.net> - 13.2.0-1
- update to 13.2.0
- raise dependency on phpunit/php-code-coverage 14.2
- raise dependency on sebastian/comparator 8.3
- raise dependency on sebastian/diff 9.0
- add dependency on sebastian/file-filter 1.0

* Thu Jun  4 2026 Remi Collet <remi@remirepo.net> - 13.1.14-1
- update to 13.1.14
- raise dependency on phpunit/php-code-coverage 14.1.10
- raise dependency on sebastian/global-state 9.0.1
...
- raise dependency on sebastian/comparator 8.2.1
- raise dependency on sebastian/environment 9.3.1
- raise dependency on sebastian/exporter 8.1.0
- raise dependency on sebastian/type 7.0.1
...
* Wed Feb 18 2026 Remi Collet <remi@remirepo.net> - 13.0.4-1
- update to 13.0.4

* Tue Feb 17 2026 Remi Collet <remi@remirepo.net> - 13.0.3-1
- update to 13.0.3

* Tue Feb 10 2026 Remi Collet <remi@remirepo.net> - 13.0.2-1
- update to 13.0.2

* Mon Feb  9 2026 Remi Collet <remi@remirepo.net> - 13.0.1-1
- update to 13.0.1
- raise dependency on phpunit/php-code-coverage 13.0.1

* Fri Feb  6 2026 Remi Collet <remi@remirepo.net> - 13.0.0-1
- update to 13.0.0
- raise dependency on PHP 8.4
- raise dependency on phpunit/php-code-coverage 13
- raise dependency on phpunit/php-file-iterator 7
- raise dependency on phpunit/php-invoker 7
- raise dependency on phpunit/php-text-template 6
- raise dependency on phpunit/php-timer 9
- raise dependency on sebastian/cli-parser 5
- raise dependency on sebastian/comparator 8
- raise dependency on sebastian/diff 8
- raise dependency on sebastian/environment 9
- raise dependency on sebastian/exporter 8
- raise dependency on sebastian/global-state 9
- raise dependency on sebastian/object-enumerator 8
- raise dependency on sebastian/type 7
- raise dependency on sebastian/version 7
- rename to phpunit13
- move to /usr/share/php/PHPUnit13

* Thu Feb  5 2026 Remi Collet <remi@remirepo.net> - 12.5.9-1
- update to 12.5.9
- raise dependency on phpunit/php-file-iterator 6.0.1
- re-add dependency on sebastian/recursion-context 7.0.1
...
* Thu Dec 11 2025 Remi Collet <remi@remirepo.net> - 12.5.3-1
- update to 12.5.3
...
* Wed Sep 24 2025 Remi Collet <remi@remirepo.net> - 12.3.14-1
- update to 12.3.14 (no change)
- raise dependency on sebastian/exporter 7.0.2

* Tue Sep 23 2025 Remi Collet <remi@remirepo.net> - 12.3.13-1
- update to 12.3.13 (no change)
- raise dependency on sebastian/exporter 7.0.1

* Mon Sep 22 2025 Remi Collet <remi@remirepo.net> - 12.3.12-1
- update to 12.3.12 (no change)
- raise dependency on phpunit/php-code-coverage 12.3.8
- raise dependency on sebastian/cli-parser 4.2.0

* Mon Sep 15 2025 Remi Collet <remi@remirepo.net> - 12.3.11-1
- update to 12.3.11
- raise dependency on sebastian/cli-parser 4.1.0
...
* Wed Sep  3 2025 Remi Collet <remi@remirepo.net> - 12.3.8-1
- update to 12.3.8
- raise dependency on phpunit/php-code-coverage 12.3.6
- raise dependency on sebastian/global-state 8.0.2

* Thu Aug 28 2025 Remi Collet <remi@remirepo.net> - 12.3.7-1
- update to 12.3.7
- raise dependency on phpunit/php-code-coverage 12.3.3

* Wed Aug 20 2025 Remi Collet <remi@remirepo.net> - 12.3.6-1
- update to 12.3.6
- raise dependency on sebastian/comparator 7.1.3

* Sun Aug 17 2025 Remi Collet <remi@remirepo.net> - 12.3.5-1
- update to 12.3.5
- raise dependency on sebastian/environment 8.0.3

* Wed Aug 13 2025 Remi Collet <remi@remirepo.net> - 12.3.4-1
- update to 12.3.4
...
* Sun Aug 10 2025 Remi Collet <remi@remirepo.net> - 12.3.1-1
- update to 12.3.1
- raise dependency on myclabs/deep-copy 1.13.4
- raise dependency on sebastian/type 6.0.3
...
* Sat Jun 21 2025 Remi Collet <remi@remirepo.net> - 12.2.3-1
- update to 12.2.3
- raise dependency on phpunit/php-code-coverage 12.3.0
- raise dependency on sebastian/comparator 7.1.0

* Mon Jun 16 2025 Remi Collet <remi@remirepo.net> - 12.2.2-1
- update to 12.2.2

* Sat Jun  7 2025 Remi Collet <remi@remirepo.net> - 12.2.1-1
- update to 12.2.1

* Fri Jun  6 2025 Remi Collet <remi@remirepo.net> - 12.2.0-1
- update to 12.2.0
- raise dependency on phpunit/php-code-coverage 12.3.0
- raise dependency on sebastian/environment 8.0.2
...
* Sun May  4 2025 Remi Collet <remi@remirepo.net> - 12.1.4-1
- update to 12.1.4
...
- raise dependency on sebastian/type 6.0.2

* Sat Mar  8 2025 Remi Collet <remi@remirepo.net> - 12.0.7-1
- update to 12.0.7
- raise dependency on sebastian/comparator 7.0.1

* Wed Mar  5 2025 Remi Collet <remi@remirepo.net> - 12.0.6-1
- update to 12.0.6
- raise dependency on phpunit/php-code-coverage 12.0.4

* Tue Feb 25 2025 Remi Collet <remi@remirepo.net> - 12.0.5-1
- update to 12.0.5

* Fri Feb 21 2025 Remi Collet <remi@remirepo.net> - 12.0.4-1
- update to 12.0.4
- raise dependency on myclabs/deep-copy 1.12.1
- raise dependency on phpunit/php-code-coverage 12.0.3
...
- raise dependency on phpunit/php-invoker 6
- raise dependency on phpunit/php-text-template 5
- raise dependency on phpunit/php-timer 8
- raise dependency on sebastian/cli-parser 4
- raise dependency on sebastian/comparator 7
- raise dependency on sebastian/diff 7
- raise dependency on sebastian/environment 8
- raise dependency on sebastian/exporter 7
- raise dependency on sebastian/global-state 8
- raise dependency on sebastian/object-enumerator 7
- raise dependency on sebastian/type 6
- raise dependency on sebastian/version 6
- drop dependency on sebastian/code-unit
- rename to phpunit12
- move to /usr/share/php/PHPUnit12
