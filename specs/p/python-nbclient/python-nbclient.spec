...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.10.2-14
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.10.2-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 16 2025 Lumir Balhar <lbalhar@redhat.com> - 0.10.2-12
- Fix compatibility of tests with ipython 9.8.0+

* Mon Nov 03 2025 Miro Hrončok <miro@hroncok.cz> - 0.10.2-11
- Convert the License tag to a real SPDX identifier

* Tue Oct 28 2025 Miro Hrončok <miro@hroncok.cz> - 0.10.2-10
- Remove unused dependency on pytest-cov
