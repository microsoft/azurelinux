...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1:0^20260319.75a7967-2
- Uncommitted changes

* Tue Apr 14 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1:0^20260319.75a7967-1
- Update to 0^20260319.75a7967
- `PyUnicodeWriter_WriteRepr(NULL)` now writes `"<NULL>"`
