...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.23.0-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 0.23.0-4
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 0.23.0-3
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 0.23.0-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Sat Sep 13 2025 Romain Geissler <romain.geissler@amadeus.com> - 0.23.0-1
- Update to 0.23.0 (rhbz#2394706)

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 0.22.1-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.22.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 0.22.1-2
- Rebuilt for Python 3.14

* Mon Jun 02 2025 Romain Geissler <romain.geissler@amadeus.com> - 0.22.1-1
- Update to 0.22.1 (rhbz#2369850)

* Sat May 17 2025 Romain Geissler <romain.geissler@amadeus.com> - 0.22.0-1
- Update to 0.22.0 (rhbz#2366949)

* Wed Mar 26 2025 Romain Geissler <romain.geissler@amadeus.com> - 0.21.1-1
- Update to 0.21.1 (rhbz#2330188)

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 0.21.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sun Oct 20 2024 Igor Raits <igor.raits@gmail.com> - 0.21.0-1
- Update to 0.21.0
