...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 27.2.0-2
- Uncommitted changes

* Fri Aug 21 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 27.2.0-1
- Update to 27.2.0 upstream release
- Resolves: rhbz#2520725

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 27.1.0-15
- Rebuilt for Python 3.15.0b4 ABI change

* Sat Jul 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 27.1.0-14
- Fix TestFrame.test_buffer_numpy on numpy 2.5

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 27.1.0-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 27.1.0-12
- Rebuilt for Python 3.15

* Wed May 20 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 27.1.0-11
- Use various long options

* Wed May 20 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 27.1.0-10
- Use long pyproject options

* Thu May 07 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 27.1.0-8
- Use %%pyproject_patch_dependency in lieu of sed

* Wed May 06 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 27.1.0-7
- Drop conditionals for Fedora 42, soon reaching end of life

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 27.1.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Dec 04 2025 Marcin Juszkiewicz <mjuszkiewicz@redhat.com> - 27.1.0-5
- disable green/gevent tests on riscv64

* Sun Nov 16 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 27.1.0-3
- Update scikit-build-core configuration
