...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.13.2-18
- Uncommitted changes

* Thu Feb 19 2026 Sergio Pascual <sergiopr@fedoraproject.org> - 0.13.2-17
- Patch removed numpy function in tests

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.13.2-16
