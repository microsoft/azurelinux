...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.4.6-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.4.6-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 23 2025 Michel Lind <salimma@fedoraproject.org> - 1.4.6-1
- Update to version 1.4.6; Fixes: rhbz#2267826
- Refreshed patches
- Backport committed PR 557 migrating from pkg_resources
