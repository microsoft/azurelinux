...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.12.0-2
- Uncommitted changes

* Sun Aug 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.12.0-1
- Update to 3.12.0 (close RHBZ#2516116)

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 3.11.9-5
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.11.9-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Fri Jul 10 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.11.9-3
- Update PyO3 to 0.29

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 3.11.9-2
- Rebuilt for Python 3.15

* Fri May 08 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.11.9-1
- Update to 3.11.9 (close RHBZ#2467292)

* Tue Mar 31 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.11.8-1
- Update to 3.11.8 (close RHBZ#2453455)
