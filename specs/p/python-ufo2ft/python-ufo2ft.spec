...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.9.0-2
- Uncommitted changes

* Wed Jul 15 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.9.0-1
- Update to 3.9.0 (close RHBZ#2499993)

* Tue Jun 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.8.2-1
- Update to 3.8.2 (close RHBZ#2488971)

* Fri Jun 05 2026 Python Maint <python-maint@redhat.com> - 3.8.1-2
- Rebuilt for Python 3.15

* Tue Jun 02 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.8.1-1
- Update to 3.8.1 (close RHBZ#2482793)

* Mon May 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.7.3-1
- Update to 3.7.3 (close RHBZ#2479635)

* Tue Apr 28 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.7.2-1
- Update to 3.7.2 (close RHBZ#2463521)

* Wed Mar 18 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 3.7.1-1
- Update to 3.7.1 (close RHBZ#2448616)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 16 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 3.7.0-1
- Update to 3.7.0 (close RHBZ#2422876)
