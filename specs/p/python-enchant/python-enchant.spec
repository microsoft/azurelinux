...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.3.0-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.3.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Nov 20 2025 Lumir Balhar <lbalhar@redhat.com> - 3.3.0-1
- Update to 3.3.0 (rhbz#2395062)

* Mon Oct 06 2025 Miro Hrončok <miro@hroncok.cz> - 3.2.2-24
- Exclude python3-wxpython4 build dependency on RHEL/ELN
