...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6.5.2-6
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6.5.2-5
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.5.2-4
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 6.5.2-3
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 6.5.2-2
- Rebuilt for Python 3.14.0rc2 bytecode

* Sat Aug 09 2025 Orion Poplawski <orion@nwra.com> - 6.5.2-1
- Update to 6.5.2

* Sat Aug 02 2025 Orion Poplawski <orion@nwra.com> - 6.5.1-1
- Update to 6.5.1 (rhbz#2327956) CVE-2025-47287

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.4.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 6.4.2-3
- Rebuilt for Python 3.14

* Wed May 21 2025 Karolina Surma <ksurma@redhat.com> - 6.4.2-2
- Support Python 3.14

* Sun Feb 02 2025 Orion Poplawski <orion@nwra.com> - 6.4.2-1
- Update to 6.4.2

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 6.4.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Sat Sep 28 2024 Fabian Affolter <mail@fabian-affolter.ch> - 6.4.1-1
- Update to latest upstream release (closes rhbz#2249963)
