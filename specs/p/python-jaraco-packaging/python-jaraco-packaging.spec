...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 10.2.3-9
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 10.2.3-8
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sat Dec 27 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 10.2.3-7
- Drop unnecessary dependency on types-docutils

* Mon Oct 20 2025 Cristian Le <cristian.le@mpsd.mpg.de> - 10.2.3-6
- Remove python3-jaraco
