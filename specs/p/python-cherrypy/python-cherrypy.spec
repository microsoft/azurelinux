...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 18.10.0-14
- Uncommitted changes

* Tue Feb 17 2026 Gwyn Ciesla <gwync@protonmail.com> - 18.10.0-13
- Fix FTBFS

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 18.10.0-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 18.10.0-10
