...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.2.2-4
- Uncommitted changes

* Wed Jul 22 2026 Python Maint <python-maint@redhat.com> - 2.2.2-3
- Rebuilt for Python 3.15.0b4 ABI change

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Sun Jun 21 2026 Packit <hello@packit.dev> - 2.2.2-1
- Update to 2.2.2 upstream release
- Resolves: rhbz#2491102

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 2.2.1-2
- Rebuilt for Python 3.15

* Fri May 22 2026 Packit <hello@packit.dev> - 2.2.1-1
- Update to 2.2.1 upstream release
- Resolves: rhbz#2480840

* Thu May 21 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.2.0-1
- Update to 2.2.0 upstream release
- Resolves: rhbz#2480346

* Tue May 19 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-3
- Use various long options

* Tue May 19 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 2.1.2-2
- Use long pyproject options

* Fri Mar 06 2026 Packit <hello@packit.dev> - 2.1.2-1
- Update to 2.1.2 upstream release
- Resolves: rhbz#2445064

* Tue Feb 03 2026 Packit <hello@packit.dev> - 2.1.1-1
- Update to 2.1.1 upstream release
- Resolves: rhbz#2436227

* Sun Feb 01 2026 Packit <hello@packit.dev> - 2.1.0-1
- Update to 2.1.0 upstream release
- Resolves: rhbz#2435733

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Nov 07 2025 Packit <hello@packit.dev> - 2.0.1-1
- Update to 2.0.1 upstream release
- Resolves: rhbz#2413300

* Wed Oct 29 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 2.0.0-1
- Update to 2.0.0 (close RHBZ#2387660)
