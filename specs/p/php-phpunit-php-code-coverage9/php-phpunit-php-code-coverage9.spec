...
\Fedora\Autoloader\Dependencies::required([
    ...
    '%{php_home}/%{ns_vendor}/Complexity/autoload.php',
    '%{php_home}/%{ns_vendor}/Environment5/autoload.php',
    '%{php_home}/%{ns_vendor}/LinesOfCode/autoload.php',
...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 9.2.32-5
- feat(render): convert static changelogs to interleaved releases for p*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 9.2.32-4
