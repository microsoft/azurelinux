...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1:3.1.3-4
- Uncommitted changes

* Fri May 22 2026 Karolina Surma <ksurma@redhat.com> - 1:3.1.3-3
- Temporarily skip a test failing with python-werkzeug 3.1.8

* Sun Mar 15 2026 František Zatloukal <fzatlouk@redhat.com> - 1:3.1.3-2
- Allow to use python-sphinx>=9

* Sun Mar 15 2026 František Zatloukal <fzatlouk@redhat.com> - 1:3.1.3-1
- Update to 3.1.3 (RHBZ#2440893)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1:3.1.2-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 1:3.1.2-3
- Rebuilt for Python 3.14.0rc3 bytecode

* Sun Aug 31 2025 František Zatloukal <fzatlouk@redhat.com> - 1:3.1.2-2
- Do some shuffling to work on f42 and epel10

* Sun Aug 31 2025 František Zatloukal <fzatlouk@redhat.com> - 1:3.1.2-1
- Update to 3.1.2 (RHBZ#2389601)

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 1:3.1.1-4
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:3.1.1-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 1:3.1.1-2
- Rebuilt for Python 3.14

* Tue May 20 2025 Karolina Surma <ksurma@redhat.com> - 1:3.1.1-1
- Update to 3.1.1

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1:3.1.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Thu Dec 05 2024 Benjamin A. Beasley <code@musicinmybrain.net> - 1:3.1.0-2
- Add a bcond for the -doc subpackage; disable it in EPEL10

* Fri Nov 22 2024 František Zatloukal <fzatlouk@redhat.com> - 1:3.1.0-1
- Update to 3.1.0 (fixes RHBZ#2326006)

* Thu Oct 10 2024 Troy Dawson <tdawson@redhat.com> - 1:3.0.3-8
- Fix License: python-flask uses BSD-3-Clause

* Wed Sep 04 2024 Miroslav Suchý <msuchy@redhat.com> - 1:3.0.3-7
