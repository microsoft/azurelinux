...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.86-5
...
* Fri Aug 20 2010 Alex Lancaster <alexlan@fedoraproject.org> - 1.54-5
...
* Mon Aug 27 2007 alexlan <alexlan@fedoraproject.org> - 1.43-6
- Used "MIT" as short license name as the "Biopython License Agreement" is
  the same as the CMU MIT variant.

* Wed Apr 25 2007 alexlan <alexlan@fedoraproject.org> - 1.43-5
- Add wise2 Requires since the Wise biopython module uses the command-line
  behind-the-scenes.

* Wed Apr 18 2007 alexlan <alexlan@fedoraproject.org> - 1.43-4
- Use python_sitearch macro to enable x86_64 builds work.

* Tue Apr 17 2007 alexlan <alexlan@fedoraproject.org> - 1.43-3
- Initial import.

* Thu Jul 29 2010 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.54-2
- dist-git conversion

* Fri May 21 2010 alexlan <alexlan@fedoraproject.org> - 1.54-1
- Update to upstream 1.54 final release.

* Tue Dec 15 2009 alexlan <alexlan@fedoraproject.org> - 1.53-1
- Update to 1.53

* Thu Nov 26 2009 Bill Nottingham <notting@fedoraproject.org> - 1.52-2
- Fix typo that causes a failure to update the common directory. (releng
  #2781)
...
* Tue Sep 29 2009 Jesse Keating <jkeating@fedoraproject.org> - 1.51-1
- Initialize branch F-12 for python-biopython

* Thu Jul 29 2010 Fedora Release Engineering <rel-eng@lists.fedoraproject.org> - 1.54-2
- dist-git conversion

* Fri May 21 2010 alexlan <alexlan@fedoraproject.org> - 1.54-1
- Update to upstream 1.54 final.

* Wed Feb 17 2010 Jesse Keating <jkeating@fedoraproject.org> - 1.53-2
- Initialize branch F-13 for python-biopython
