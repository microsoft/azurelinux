...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.0-40
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.0-39
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.0-38
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 2.0-37
- Rebuilt for java-25-openjdk as preffered jdk

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.0-36
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-35
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-34
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-33
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-32
- Remove javadoc subpackage

* Sat Feb 15 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-31
- Install license file in javadoc subpackage

* Sat Feb 15 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-30
- Don't use %%{name} for upstream artifact/tarball names

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.0-29
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.0-26
