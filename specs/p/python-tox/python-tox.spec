...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.35.0-4
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.35.0-3
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 4.35.0-2
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Feb 13 2026 Miro Hrončok <miro@hroncok.cz> - 4.35.0-1
- Update to 4.35.0
- Fixes: rhbz#2439637

* Tue Jan 20 2026 Miro Hrončok <miro@hroncok.cz> - 4.34.1-1
- Update to 4.34.1
- Fixes: rhbz#2428038

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.33.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Jan 05 2026 Miro Hrončok <miro@hroncok.cz> - 4.33.0-1
- Update to 4.33.0
- Fixes: rhbz#2426906

* Thu Nov 06 2025 Miro Hrončok <miro@hroncok.cz> - 4.32.0-1
- Update to 4.32.0
- Fixes: rhbz#2406240

* Mon Oct 06 2025 Miro Hrončok <miro@hroncok.cz> - 4.30.3-1
- Update to 4.30.3
- Fixes: rhbz#2393223

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 4.30.1-2
- Rebuilt for Python 3.14.0rc3 bytecode

* Thu Sep 04 2025 Miro Hrončok <miro@hroncok.cz> - 4.30.1-1
- Update to 4.30.1
- Fixes: rhbz#2382185

* Tue Sep 02 2025 Lukáš Zachar <lzachar@redhat.com> - 4.26.0-7
- Change all_supplementing_pythons to work with tmt

* Tue Sep 02 2025 Lukáš Zachar <lzachar@redhat.com> - 4.26.0-6
- Drop STI and use tmt instead

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 4.26.0-5
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 4.26.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Tue Jun 03 2025 Python Maint <python-maint@redhat.com> - 4.26.0-3
- Rebuilt for Python 3.14

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 4.26.0-2
- Bootstrap for Python 3.14

* Tue May 13 2025 Miro Hrončok <miro@hroncok.cz> - 4.26.0-1
- Update to 4.26.0
- Requires virtualenv 20.29+
- Supports freethreading Python
- Fixes: rhbz#2365939

* Tue May 13 2025 Miro Hrončok <miro@hroncok.cz> - 4.25.0-6
- Fix tests with virtualenv 20.31+

* Mon May 12 2025 Karolina Surma <ksurma@redhat.com> - 4.25.0-5
