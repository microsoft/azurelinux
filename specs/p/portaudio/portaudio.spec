...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 19.7.0-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 19.7.0-4
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 19.7.0-3
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 19.7.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sat Feb 01 2025 Robert-André Mauchin <zebob.m@gmail.com> - 19.7.0-1
- Fix version number and refactor
- The archive already used actually corresponds to version 19.7.0
- Grab the archive from the official VCS repo: this allows us to use
  %%{version} variable instead of a hardcoded archive name (useful if we
  want to use Packit later).
- License reanalysis with scancode (no change)
- Remove old cruft
