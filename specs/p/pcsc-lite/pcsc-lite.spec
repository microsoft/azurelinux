...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.3.3-4
- feat(render): convert static changelogs to interleaved releases for p*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.3.3-3
...
* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.3.1-2
...
* Thu Jul 18 2024 Fedora Release Engineering <releng@fedoraproject.org> - 2.2.3-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Mon May 27 2024 Jakub Jelen <jjelen@redhat.com> - 2.2.3-1
- New upstream release.

* Wed May 22 2024 Jakub Jelen <jjelen@redhat.com> - 2.2.2-1
- New upstream release (#2282164)

* Fri May 10 2024 Jakub Jelen <jjelen@redhat.com> - 2.2.1-1
- New upstream release.

* Fri May 10 2024 Jakub Jelen <jjelen@redhat.com> - 2.2.0-2
- Fix path to USB drop dir (#2279756)

* Mon May 06 2024 Jakub Jelen <jjelen@redhat.com> - 2.2.0-1
- New upstream release (#2274829)

* Mon Apr 15 2024 Jakub Jelen <jjelen@redhat.com> - 2.1.0-1
- New upstream release (#2274829)

* Mon Mar 04 2024 Jakub Jelen <jjelen@redhat.com> - 2.0.3-1
- New upstream release (#2267671)

* Mon Mar 04 2024 Jakub Jelen <jjelen@redhat.com> - 2.0.2-1
- New upstream release
