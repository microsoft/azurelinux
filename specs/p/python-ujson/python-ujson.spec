...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 5.13.0-2
- Uncommitted changes

* Mon Jun 15 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 5.13.0-1
- Update to 5.13.0 (close RHBZ#2488798)

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 5.12.1-2
- Rebuilt for Python 3.15

* Wed May 06 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 5.12.1-1
- Update to 5.12.1 (close RHBZ#2466927)

* Thu Apr 16 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 5.12.0-2
- Fix stray version.h with setuptools_scm 10+
- Fixes RHBZ#2453824
