...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.1.8-2
- Uncommitted changes

* Sat May 02 2026 František Zatloukal <fzatlouk@redhat.com> - 3.1.8-1
- Update to 3.1.8 (RHBZ#2450581)

* Sun Mar 15 2026 František Zatloukal <fzatlouk@redhat.com> - 3.1.6-2
- Allow to use python-sphinx>=9

* Sun Mar 15 2026 František Zatloukal <fzatlouk@redhat.com> - 3.1.6-1
- Update to 3.1.6 (RHBZ#2440998)

* Sun Feb 15 2026 František Zatloukal <fzatlouk@redhat.com> - 3.1.5-1
- Update to 3.1.5 (RHBZ#2428089)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.1.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Dec 05 2025 František Zatloukal <fzatlouk@redhat.com> - 3.1.4-1
- Update to 3.1.4 (RHBZ#2419332)
