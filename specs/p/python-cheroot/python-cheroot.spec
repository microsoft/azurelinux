...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 11.1.1-5
- Uncommitted changes
...
* Mon Oct 20 2025 Dan Radez <dradez@redhat.com> - 10.0.1-10
- Stop using deprecated %%py3_build/%%py3_install macros (rhbz#2377784)
