...
* Wed Jun 03 2026 Daniel McIlvaney <damcilva@microsoft.com> - 7.2.0-4
- feat(render): convert static changelogs to interleaved releases for p*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 7.2.0-3
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 7.2.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Thu Jul 17 2025 Aaron Merey <amerey@redhat.com> - 7.2.0-1
- Rebase to papi-7.2.0.
- Remove upstreamed patches
  papi-python3.patch
  papi-libsde.patch
  papi-gcc15.patch
- Add papi-revert-arm-test.patch.
- Add papi-revert-event-depr.patch.
