...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.31.0-6
- Uncommitted changes

* Thu Jan 22 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.31.0-5
- Report and skip a minor Python 3.15.0a5 regression (fix RHBZ#2431533)

* Wed Jan 21 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.31.0-4
- Remove a test skip that’s no longer needed

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.31.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Nov 25 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 0.31.0-1
- Update to 0.31.0 (close RHBZ#2416913)
