...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.28.0-3
- Uncommitted changes

* Tue Jan 20 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.28.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Oct 23 2025 Lumir Balhar <lbalhar@redhat.com> - 2.28.0-1
- Update to 2.28.0 (rhbz#2405826)
