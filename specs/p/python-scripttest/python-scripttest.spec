...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.0.post1-3
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.0.post1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Nov 12 2025 Lumir Balhar <lbalhar@redhat.com> - 2.0.post1-1
- Update to 2.0.post1 (rhbz#2350890)
