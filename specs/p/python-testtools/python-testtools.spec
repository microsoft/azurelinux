...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.8.7-2
- Uncommitted changes

* Sat Mar 14 2026 Packit <hello@packit.dev> - 2.8.7-1
- Update to 2.8.7 upstream release
- Resolves: rhbz#2447608

* Fri Mar 06 2026 Michel Lind <salimma@fedoraproject.org> - 2.8.5-1
- Update to 2.8.5 upstream release
- Resolves: rhbz#2413751
- Run tests with verbose output
- Enable Packit

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.2-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 2.7.2-14
- Rebuilt for Python 3.14.0rc3 bytecode

* Fri Aug 15 2025 Python Maint <python-maint@redhat.com> - 2.7.2-13
- Rebuilt for Python 3.14.0rc2 bytecode

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.2-12
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Wed Jun 04 2025 Python Maint <python-maint@redhat.com> - 2.7.2-11
- Rebuilt for Python 3.14

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 2.7.2-10
- Bootstrap for Python 3.14

* Mon Apr 07 2025 Michel Lind <salimma@fedoraproject.org> - 2.7.2-9
- Fix building with Python 3.14; Resolves: RHBZ#2353143

* Fri Jan 24 2025 Carl George <carlwgeorge@fedoraproject.org> - 2.7.2-8
- Fix twisted tests with upstream patch rhbz#2341223

* Sat Jan 18 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.2-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.2-5
- Fix inverted logic for twistedsupport tests buildrequirement generation

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.2-4
- Skip twistedsupport tests on EPEL, correctly this time

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.2-3
- Skip twistedsupport tests on EPEL

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.2-2
- Minor fix for description formatting

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.2-1
- Update to version 2.7.2 rhbz#2291170

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.1-9
- Run import check while bootstrapping

* Thu Nov 14 2024 Carl George <carlwgeorge@fedoraproject.org> - 2.7.1-8
