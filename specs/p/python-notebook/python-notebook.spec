...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 7.5.3-2
- Uncommitted changes

* Tue Jan 27 2026 Lumir Balhar <lbalhar@redhat.com> - 7.5.3-1
- Update to 7.5.3 (rhbz#2432755)

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 7.5.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Jan 13 2026 Lumir Balhar <lbalhar@redhat.com> - 7.5.2-1
- Update to 7.5.2 (rhbz#2428698)

* Tue Dec 16 2025 Lumir Balhar <lbalhar@redhat.com> - 7.5.1-1
- Update to 7.5.1 (rhbz#2422628)

* Wed Nov 19 2025 Lumir Balhar <lbalhar@redhat.com> - 7.5.0-1
- Update to 7.5.0 (rhbz#2415816)

* Mon Sep 29 2025 Lumir Balhar <lbalhar@redhat.com> - 7.4.7-1
- Update to 7.4.7 (rhbz#2399900)

* Fri Sep 26 2025 Lumir Balhar <lbalhar@redhat.com> - 7.4.6-1
- Update to 7.4.6 (rhbz#2399628)
