...
* Fri Sep 18 2026 Unknown User <please-configure-git-user@example.com> - 1.12.1.2-11
- Uncommitted changes

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.12.1.2-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.12.1.2-9
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.12.1.2-8
