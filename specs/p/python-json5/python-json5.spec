...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.12.1-6
- Uncommitted changes

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.12.1-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 0.12.1-4
- Rebuilt for Python 3.15

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.12.1-3
