...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.31.0-2
- Uncommitted changes

* Wed Jul 08 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.31.0-1
- Update to 1.31.0 (close RHBZ#2497958)

* Sun Jun 14 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.30.1-1
- Update to 1.30.1 (close RHBZ#2483862)

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 1.29.0-4
- Rebuilt for Python 3.15

* Sat May 23 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.29.0-3
- Use various long options

* Tue May 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.29.0-2
