...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 9.2.2-6
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 9.2.2-5
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Mon Jan 12 2026 Elliott Sales de Andrade <quantum.analyst@gmail.com> - 9.2.2-4
- Add a subpackage for the "simple" extra

* Mon Jan 05 2026 Yaakov Selkowitz <yselkowi@redhat.com> - 9.2.2-3
- Avoid python-pytest-timeout dependency on RHEL
