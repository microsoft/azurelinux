...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 4.70.0-3
- Uncommitted changes

* Mon Aug 24 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.70.0-1
- Update to 4.70.0

* Thu Jul 30 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.69.0-1
- Update to 4.69.0

* Thu Jul 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.68.4-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Tue Jul 07 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.68.4-1
- Update to 4.68.4

* Wed Jun 17 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.68.3-1
- Update to 4.68.3

* Wed Jun 10 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.68.2-1
- Update to 4.68.2

* Mon Jun 08 2026 Python Maint <python-maint@redhat.com> - 4.67.3-3
- Rebuilt for Python 3.15

* Wed Jun 03 2026 Python Maint <python-maint@redhat.com> - 4.67.3-2
- Bootstrap for Python 3.15

* Tue Feb 10 2026 Neel Chauhan <blackbird@sour.coffee> - 4.67.3-1
- python-tqdm 4.67.3

* Mon Feb 02 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.67.2-1
- Update to 4.67.2

* Thu Jan 29 2026 Stephen Gallagher <sgallagh@redhat.com> - 4.67.1-11
- Fix tests

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 4.67.1-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Sep 19 2025 Python Maint <python-maint@redhat.com> - 4.67.1-9
