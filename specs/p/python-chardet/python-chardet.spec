...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 6.0.0.post1-2
- Uncommitted changes

* Thu Mar 05 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.0.0.post1-1
- Update to 6.0.0.post1

* Mon Feb 23 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 6.0.0-1
- Update to 6.0.0
- Switch from PyPI sdist to GitHub archive as basis for filtered source
  archive, since the PyPI sdist now contains pre-generated HTML docs and is
  harder to audit
