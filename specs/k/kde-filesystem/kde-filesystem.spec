...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5-9
- feat(render): convert static changelogs to interleaved releases for k*
  components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 5-8
- feat: introduce deterministic commit resolution via Azure Linux lock file

* Thu Jul 24 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Fri Jan 17 2025 Fedora Release Engineering <releng@fedoraproject.org> - 5-5
