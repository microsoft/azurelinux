...
%define specversion 6.18.29
%define tarfile_release 6.18.29
...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.18.29-3
- feat(render): convert static changelogs to interleaved releases for k*
  components

* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.18.29-2
- chore(lockfiles): update existing autochangelog packages to new lockfile
  format

* Thu May 14 2026 Rachel Menge <rachelmenge@microsoft.com> - 6.18.29-1
- feat(kernel-headers): update source to 6.18.29.1

* Wed May 13 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.18.5-2
