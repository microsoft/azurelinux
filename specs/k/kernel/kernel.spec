...
%define specrelease %{kextraversion}.%autorelease
...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.18.29-15
- feat(render): convert static changelogs to interleaved releases for k*
  components

* Thu May 14 2026 Rachel Menge <rachelmenge@microsoft.com>
- chore(kernel): remove unused azurelinux_version macro

* Wed May 13 2026 Rachel Menge <rachelmenge@microsoft.com>
- feat(kernel): update source to 6.18.29.1 (rolling-lts/azl4)

* Wed May 13 2026 Daniel McIlvaney <damcilva@microsoft.com>
- chore(locks): update kernel locks to work with azldev 9696597 (allow file
  replacement)

* Mon May 11 2026 Tobias Brick <tobiasb@microsoft.com>
- kernel: Add bpf and ipe to CONFIG_LSM

* Mon May 11 2026 Rachel Menge <rachelmenge@microsoft.com>
...
* Fri May 08 2026 Rachel Menge <rachelmenge@microsoft.com>
...
* Fri May 08 2026 Rachel Menge <rachelmenge@microsoft.com>
- security(kernel): disable slab cache merging to prevent cross-cache
  attacks

* Fri May 08 2026 Rachel Menge <rachelmenge@microsoft.com>
- security(kernel): restore data structure integrity hardening

* Tue May 05 2026 Rachel Menge <rachelmenge@microsoft.com>
