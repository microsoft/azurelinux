...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 7.14.2-2
- Uncommitted changes
...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 7.13.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Dec 11 2025 Miro Hrončok <miro@hroncok.cz> - 7.13.0-3
- Use %%pyproject_buildrequires which is mandatory for other %%pyproject
  macros
