...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.23.0-5
- feat(render): convert static changelogs to interleaved releases for k*
  components

* Tue May 12 2026 reuben olinsky <reubeno@users.noreply.github.com> - 6.23.0-4
- refactor(kf6-kfilemetadata): drop ffmpeg-free-devel BuildRequires

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 6.23.0-3
