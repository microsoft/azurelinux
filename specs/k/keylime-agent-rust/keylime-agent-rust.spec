...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.2.9-3
- Uncommitted changes
...
* Thu Feb 12 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 0.2.8-12
- Update reqwest from 0.12 to 0.13
- Update reqwest-middleware and reqwest-retry at the same time

* Sat Feb 07 2026 Fabio Valentini <decathorpe@gmail.com> - 0.2.8-11
- Rebuild for RUSTSEC-2026-{0007,0008,0009} and CVE-2026-25537

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.8-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Thu Dec 18 2025 Benjamin A. Beasley <code@musicinmybrain.net> - 0.2.8-9
- Update reqwest-retry to 0.8, retry-policies to 0.5

* Thu Oct 23 2025 Yaakov Selkowitz <yselkowi@redhat.com> - 0.2.8-8
- Move LICENSE.dependencies and cargo-vendor.txt to binary packages

* Thu Sep 25 2025 Anderson Toshiyuki Sasaki <ansasaki@redhat.com> - 0.2.8-7
- Make keylime_agent keylime_push_model_agent services to conflict

* Thu Sep 25 2025 Anderson Toshiyuki Sasaki <ansasaki@redhat.com> - 0.2.8-6
- Update e2e test plans

* Mon Sep 22 2025 Anderson Toshiyuki Sasaki <ansasaki@redhat.com> - 0.2.8-5
- Drop the keylime-agent-rust-pull subpackage

* Tue Sep 16 2025 Anderson Toshiyuki Sasaki <ansasaki@redhat.com> - 0.2.8-4
- Do not remove wiremock, which is now available on Fedora

* Tue Sep 16 2025 Anderson Toshiyuki Sasaki <ansasaki@redhat.com> - 0.2.8-3
