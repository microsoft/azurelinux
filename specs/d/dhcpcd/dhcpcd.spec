...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 10.3.2-2
- Uncommitted changes

* Tue Jun 02 2026 Martin Osvald <mosvald@redhat.com> - 10.3.2-1
- Update to 10.3.2 (rhbz#2447974)

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 10.3.0-4
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 10.3.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
