...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.7.2-12
- feat(render): convert static changelogs to interleaved releases for d*
  components

* Tue May 12 2026 Thien Trung Vuong <tvuong@microsoft.com> - 1.7.2-11
- build: disable mingw cross-compilation via component group

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.7.2-10
