...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 5.5.0-2
- Uncommitted changes

* Mon Aug 17 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.5.0-1
- Update to release v5.5.0
- Resolves: rhbz#2510716
- Upstream improvements and fixes

* Mon Aug 17 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.4.0-2
- Exclude tags

* Mon Aug 03 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.4.0-1
- Update to release v5.4.0
- Upstream fixes and new features

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 5.3.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Tue Jul 07 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.3.1-1
- Update to release v5.3.1
- Resolves: rhbz#2497698
- Upstream fixes and dependency updates

* Thu Jul 02 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.3.0-1
...
* Tue Jun 23 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.2.0-1
...
- Important upstream note: This version introduces a new reconciliation
  ...
  experience any issues with a Compose workload that was previously
  working, please open an issue with upsteam.
...
* Thu Apr 09 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.1.2-1
- Update to v5.1.2
- Resolves: rhbz#2456890 = Upstream fixes

* Fri Mar 20 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.1.1-1
- Update to release v5.1.1
- Resolves: rhbz#2449479
- Upstream fixes

* Tue Feb 24 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.1.0-1
- Update to release v5.1.0
- Resolves rhbz#2442396
- Upstream new features and fixes

* Tue Feb 24 2026 Bradley G Smith <bradley.g.smith@gmail.com> - 5.0.2-3
- Remove unneeded manual license configuration
