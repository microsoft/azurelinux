...
%global         commit       23935ba31271e55890a2126bd0f1944daeb33438
...
# Change the python module name
#sed -i -e 's/PyAFF/pyaff/' pyaff/setup.py
...
%doc pyaff/README
%exclude %{python3_sitearch}/PyAFF*egg-info


%changelog
## START: Generated by rpmautospec
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 3.7.22-5
- Uncommitted changes

* Thu Jan 29 2026 Nicolas Chauvet <kwizart@gmail.com> - 3.7.22-4
- Attempt to fix afflib.so path

* Thu Jan 29 2026 Nicolas Chauvet <kwizart@gmail.com> - 3.7.22-3
- Update the right sources

* Thu Jan 29 2026 Nicolas Chauvet <kwizart@gmail.com> - 3.7.22-2
- Add missing sources

* Thu Jan 29 2026 Nicolas Chauvet <kwizart@gmail.com> - 3.7.22-1
- Update to 3.7.22 and pyprojectize

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.20-17
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.20-16
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.20-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Mon Jun 02 2025 Python Maint <python-maint@redhat.com> - 3.7.20-14
- Rebuilt for Python 3.14

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.20-13
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Wed Aug 28 2024 Miroslav Suchý <msuchy@redhat.com> - 3.7.20-12
- convert license to SPDX

* Wed Jul 17 2024 Fedora Release Engineering <releng@fedoraproject.org> - 3.7.20-11
- Rebuilt for https://fedoraproject.org/wiki/Fedora_41_Mass_Rebuild

* Fri Jun 14 2024 Michal Ambroz <rebus@seznam.cz> - 3.7.20-10
- sync with upstream, fix build with git snapshot

* Fri Jun 07 2024 Python Maint <python-maint@redhat.com> - 3.7.20-9
- Rebuilt for Python 3.13

* Thu Feb 15 2024 Nicolas Chauvet <kwizart@gmail.com> - 3.7.20-8
- Update upstream snapshot

* Tue Jan 30 2024 Nicolas Chauvet <kwizart@gmail.com> - 3.7.20-7
- Apply gcc-14 patch

* Tue Jan 30 2024 Nicolas Chauvet <kwizart@gmail.com> - 3.7.20-6
- Add gcc-14 patch

* Tue Jan 30 2024 Nicolas Chauvet <kwizart@gmail.com> - 3.7.20-5
- Fixup github url
