...
* Fri Aug 14 2026 Tobias Brick <tobiasb@microsoft.com> - 4.0-25
- refactor(azurelinux-release): adopt rpmautospec
...
* Fri Aug 07 2026 Lynsey Rydberg <lyrydber@microsoft.com> - 4.0-22
...
* Thu Jul 09 2026 Mitch Zhu <mitchzhu@microsoft.com> - 4.0-20
- feat(azurelinux-release): ship azure kvp config in cloud identity

* Tue Jul 07 2026 Brian Fjeldstad <bfjelds@microsoft.com> - 4.0-19
- netplan: enable netplan-configure.service by default

* Thu Jun 11 2026 Andrew Phelps <anphel@microsoft.com> - 4.0-18
- fix(azurelinux-release): correct OS CPE to well-formed CPE 2.3 string

* Tue May 12 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.0-17
- refactor: adjust azurelinux macro (major version only)

* Wed May 06 2026 Lynsey Rydberg <lyrydber@microsoft.com> - 4.0-16
- feat(openssh): add config file for PermitRootLogin

* Tue May 05 2026 Chris Co <chrco@microsoft.com> - 4.0-15
- fix(azurelinux-release): set prerelease name to Beta

* Thu May 07 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.0-14
- chore(azurelinux-release): add weak dep to select default repo variant

* Wed May 06 2026 Dan Streetman <ddstreet@ieee.org> - 4.0-13
- chore(azurelinux-release): update 'lock' file

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 4.0-12
