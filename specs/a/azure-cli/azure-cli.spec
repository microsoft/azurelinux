...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.83.0-4
- Uncommitted changes

* Thu Feb 12 2026 Jeremy Cline <jeremycline@linux.microsoft.com> - 2.83.0-3
- Relax pin on the azure-storage-queue 12.15b1

* Thu Feb 12 2026 Jeremy Cline <jeremycline@linux.microsoft.com> - 2.83.0-2
- Relax pins on a few azure deps

* Wed Feb 11 2026 Jeremy Cline <jeremycline@linux.microsoft.com> - 2.83.0-1
- Update to v2.83

* Wed Feb 11 2026 Jeremy Cline <jeremycline@linux.microsoft.com> - 2.81.0-4
- Relax the dependency on azure-core

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.81.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.81.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Tue Dec 02 2025 Jeremy Cline <jeremycline@linux.microsoft.com> - 2.81.0-1
- Update to v2.81.0
