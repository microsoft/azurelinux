...
* Tue Jun 02 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.5.3-4
- feat(render): convert static changelogs to interleaved releases for a*
  components

* Tue May 12 2026 reuben olinsky <reubeno@users.noreply.github.com> - 2.5.3-3
- fix: retarget openjdk21 references to openjdk25 across Java stack

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.5.3-2
