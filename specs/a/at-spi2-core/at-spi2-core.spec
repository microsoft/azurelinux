...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.60.6-2
- Uncommitted changes

* Sat Aug 01 2026 Packit <hello@packit.dev> - 2.60.6-1
- Update to 2.60.6 upstream release

* Sat Jun 27 2026 Packit <hello@packit.dev> - 2.60.5-1
- Update to 2.60.5 upstream release

* Sat May 23 2026 Packit <hello@packit.dev> - 2.60.4-1
- Update to 2.60.4 upstream release

* Wed Apr 29 2026 Milan Crha <mcrha@redhat.com> - 2.60.3-1
- Update to 2.60.3

* Mon Apr 27 2026 Milan Crha <mcrha@redhat.com> - 2.60.2-1
- Update to 2.60.2

* Mon Apr 20 2026 Milan Crha <mcrha@redhat.com> - 2.60.1-1
- Update to 2.60.1

* Mon Mar 16 2026 Milan Crha <mcrha@redhat.com> - 2.60.0-1
- Update to 2.60.0

* Tue Mar 03 2026 Jan Grulich <jgrulich@redhat.com> - 2.59.90-1
- Update to 2.59.90

* Mon Mar 02 2026 Jan Grulich <jgrulich@redhat.com> - 2.59.1-5
- Packit: drop upstream_project_url and rely on release-monitoring only

* Wed Feb 25 2026 Jan Grulich <jgrulich@redhat.com> - 2.59.1-4
- Packit: drop fast_forward_merge_into as current stable branches diverge

* Tue Feb 24 2026 Jan Grulich <jgrulich@redhat.com> - 2.59.1-3
- Onboard to Packit for stable Fedora branches

* Tue Feb 03 2026 Jan Horak <jhorak@redhat.com> - 2.59.1-1
- Update to 2.59.1

* Mon Jan 19 2026 Jan Horak <jhorak@redhat.com> - 2.59.0-1
- Update to 2.59.0

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.58.2-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.58.2-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
