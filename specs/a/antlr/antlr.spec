...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 2.7.7-85
- test: add initial lock files

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 2.7.7-84
- Rebuilt for java-25-openjdk as preffered jdk

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.7-83
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.7.7-82
- Remove javadoc subpackage

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.7.7-81
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.7.7-80
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.7.7-79
- Switch to javapackages tests from CentOS Stream GitLab

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 2.7.7-78
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.7.7-76
- Use %%jpackage_script

* Thu Nov 28 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.7.7-75
