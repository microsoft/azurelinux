...
* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.16.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.16.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
...
- Update to version 1.14.5
  https://github.com/freeipa/ansible-freeipa/releases/tag/v1.14.5
  - ipa* deployment roles: Hotfix for dns_over_tls (Freeipa#7343)

* Tue Feb  4 2025 Thomas Woerner <twoerner@redhat.com> - 1.14.4-1
- Update to version 1.14.4
  https://github.com/freeipa/ansible-freeipa/releases/tag/v1.14.4
