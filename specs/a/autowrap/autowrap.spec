...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 0.27.0-2
- Uncommitted changes

* Thu Aug 20 2026 Antonio Trande <sagitter@fedoraproject.org> - 0.27.0-1
- Release 0.27.0

* Wed Jul 15 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.26.0-6
- Rebuilt for https://fedoraproject.org/wiki/Fedora_45_Mass_Rebuild

* Thu Jun 04 2026 Python Maint <python-maint@redhat.com> - 0.26.0-5
- Rebuilt for Python 3.15

* Mon Feb 23 2026 Tomáš Hrnčiar <thrnciar@redhat.com> - 0.26.0-4
- Fix invalid extras in %%pyproject_buildrequires -x

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.26.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.26.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild
