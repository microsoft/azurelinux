...
Version:        4.0.0
Release:        1%{?dist}
License:        Microsoft Legal - Trademark and Brand Guidelines
...
%description
The Azure Linux penguin icon is inspired by the Linux mascot ("Tux"),
created by Larry Ewing. Microsoft permits the use of the Azure Linux
trademark and Azure Linux icon only in accordance with its trademark
and brand guidelines: https://www.microsoft.com/en-us/legal/intellectualproperty/trademarks
