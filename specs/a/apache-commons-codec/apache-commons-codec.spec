...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.19.0-4
- Uncommitted changes

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.19.0-3
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Jan 16 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.19.0-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Fri Oct 10 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.19.0-1
- Update to upstream version 1.19.0

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 1.17.1-16
- Rebuilt for java-25-openjdk as preffered jdk

* Wed Jul 23 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.17.1-15
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.1-14
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.1-13
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.1-12
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.1-11
- Remove javadoc subpackage

* Thu Jan 16 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.17.1-10
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.1-9
- Update upstream URL

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.17.1-7
