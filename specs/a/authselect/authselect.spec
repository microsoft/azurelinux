...
%{?azurelinux:%global default_profile local with-silent-lastlog with-faillock with-pwhistory without-nullok}
...
* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.6.2-5
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.6.2-4
- build: mass rebuild auto-bumpable components

* Mon Aug 10 2026 Lynsey Rydberg <lyrydber@microsoft.com> - 1.6.2-3
- feat(pam): enable CIS Level 1 password policy
