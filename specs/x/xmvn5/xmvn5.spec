...
%jp_binding --verbose --base-pkg %{name}-minimal --binding-pkg %{name}-toolchain-msopenjdk25 --variant msopenjdk25 --ghost %{name}-toolchains.xml --target %{_datadir}/%{name}/conf/toolchains-msopenjdk25.xml --requires msopenjdk-25
%files
...
* Thu Sep 10 2026 Nan Liu <liunan@microsoft.com> - 5.1.0-9
- feat(java): add Microsoft OpenJDK 25 bindings

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.1.0-8
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 5.1.0-7
- build: mass rebuild auto-bumpable components
