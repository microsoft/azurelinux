...
%jp_binding --verbose --base-pkg %{name}-minimal --binding-pkg %{name}-toolchain-openjdk25 --variant openjdk25 --ghost %{name}-toolchains.xml --target %{_datadir}/%{name}/conf/toolchains-openjdk25.xml --requires msopenjdk-25-fedora-compat
...
* Mon Sep 14 2026 Nan Liu <liunan@microsoft.com> - 5.1.0-10
