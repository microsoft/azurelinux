...
sed -i 's|/usr/lib/jvm/jre-25-openjdk|/usr/lib/jvm/msopenjdk-25|' %{buildroot}%{_bindir}/xml-resolver %{buildroot}%{_bindir}/xml-xread %{buildroot}%{_bindir}/xml-xparse
%files -f .mfiles
%doc KEYS
...
* Thu Sep 17 2026 Nan Liu <liunan@microsoft.com> - 1.2-62
- feat(java): migrate to Microsoft OpenJDK 25

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.2-61
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 1.2-60
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.2-59
