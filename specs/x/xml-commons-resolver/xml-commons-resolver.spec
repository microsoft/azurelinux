...
* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 1.2-56
- test: add initial lock files

* Thu Sep 04 2025 Jiri Vanek <jvanek@redhat.com> - 1.2-55
- manual bodhi update for jdk25 needed on selected pkgs

* Tue Jul 29 2025 Jiri Vanek <jvanek@redhat.com> - 1.2-54
- Rebuilt for java-25-openjdk as preffered jdk

* Fri Jul 25 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-53
- Rebuilt for https://fedoraproject.org/wiki/Fedora_43_Mass_Rebuild

* Sun Jul 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.2-52
- Build with OpenJDK 25

* Thu May 22 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.2-51
- Switch javapackages test plan to f43 ref

* Wed Mar 26 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.2-50
- Switch to javapackages tests from CentOS Stream GitLab

* Mon Mar 03 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.2-49
- Remove javadoc subpackage

* Sun Jan 19 2025 Fedora Release Engineering <releng@fedoraproject.org> - 1.2-48
- Rebuilt for https://fedoraproject.org/wiki/Fedora_42_Mass_Rebuild

* Mon Jan 13 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.2-47
- Switch upstream URL to https

* Fri Nov 29 2024 Mikolaj Izdebski <mizdebsk@redhat.com> - 1.2-45
- Drop explicit requires on javapackages-tools

* Tue Nov 19 2024 Marian Koncek <mkoncek@redhat.com> - 1.2-44
