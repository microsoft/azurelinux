...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 2.1.1-8
- Uncommitted changes

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 2.1.1-7
- Rebuilt for https://fedoraproject.org/wiki/Fedora_44_Mass_Rebuild

* Sat Oct 11 2025 Mikolaj Izdebski <mizdebsk@redhat.com> - 2.1.1-6
- Add commons-lang3 to generator classpath
