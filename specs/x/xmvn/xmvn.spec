...
%global __requires_exclude ^java-25-openjdk-headless$
...
Source26: toolchains-msopenjdk25.xml
...
install -p -m 644 %{SOURCE26} %{buildroot}%{_datadir}/%{name}/conf/toolchains-msopenjdk25.xml
%jp_binding --verbose --base-pkg xmvn-minimal --binding-pkg xmvn-toolchain-msopenjdk25 --variant msopenjdk25 --ghost xmvn-toolchains.xml --target %{_datadir}/%{name}/conf/toolchains-msopenjdk25.xml --requires msopenjdk-25

sed -i 's|/usr/lib/jvm/jre-25-openjdk|/usr/lib/jvm/msopenjdk-25|g' \
    %{buildroot}%{_bindir}/xmvn-{install,resolve,subst}
%files
%{_bindir}/mvn-local
...
* Thu Sep 10 2026 Nan Liu <liunan@microsoft.com> - 4.3.0-25
- feat(java): add Microsoft OpenJDK 25 bindings

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.3.0-24
- build: mass rebuild auto-bumpable components

* Wed Aug 19 2026 reuben olinsky <reubeno@users.noreply.github.com> - 4.3.0-23
- build: mass rebuild auto-bumpable components

* Thu Apr 30 2026 Daniel McIlvaney <damcilva@microsoft.com> - 4.3.0-22
