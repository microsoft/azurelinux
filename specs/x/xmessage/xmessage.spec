...
* Tue Sep 01 2026 Unknown User <please-configure-git-user@example.com> - 1.0.7-9
- Uncommitted changes

* Thu Jan 29 2026 Benjamin A. Beasley <code@musicinmybrain.net> - 1.0.7-8
- Depend on gpgverify rather than gnupg2 for source file verification

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 1.0.7-7
