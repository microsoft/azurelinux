...
### a) General  
You may install and use any number of copies of the software for your internal business purposes, subject to the terms below. 
...
The software includes open source components (“OSS Components”). The applicable open source license for each OSS Component is included in the accompanying licensing documentation and/or in the OSS Component’s source code or notice file. For the avoidance of doubt, nothing in these Microsoft license terms limits, supersedes or modifies your rights under any open source license. Your rights to use, copy, modify and redistribute OSS Components are governed solely by the applicable open source licenses.

### d) Third Party Programs  
The software may be provided with third party programs that are not part of the software. These third party programs are not required to run the software, are provided as a convenience to you, and are subject to their own license terms. The license terms either accompany the third party programs or can be viewed at the location specified by their licensors. If you do not agree to abide by the applicable license terms for the third party programs, then you should not install or use them.   

### e) Microsoft Azure Services  
The software is optimized for use with Microsoft Azure Services. The use of those services (but not the software) is governed by the separate terms and privacy policies associated with your Microsoft Azure subscription. The services may not be available in all regions. For more information see https://azure.microsoft.com/en-us/support/legal/.

---

## 2. DATA
This software may be configured to interact with other Microsoft products that collect data that is transmitted to Microsoft. Any such configuration is subject to separate Microsoft terms and conditions. To learn more about how Microsoft processes personal data we collect, please see the Microsoft Privacy Statement at https://go.microsoft.com/fwlink/?LinkId=248681. To the extent Microsoft is a processor or subprocessor of personal data in connection with any such configurations, Microsoft makes the commitments in the European Union General Data Protection Regulation Terms of the Online Services Terms to all customers effective May 25, 2018, at https://docs.microsoft.com/en-us/legal/gdpr. 
...
## 4. SUPPORT SERVICES
The software is optimized for use with Microsoft Azure Services. Support for the software will be provided pursuant to your separate support agreement with Microsoft for Microsoft Azure Services. Microsoft is not obligated to provide any support services for the software when it is used outside of Azure.  
...
## 6. APPLICABLE LAW AND PLACE TO RESOLVE DISPUTES 
...
## 7. CONSUMER RIGHTS; REGIONAL VARIATIONS
