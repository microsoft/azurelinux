...
%changelog
* Fri Mar 26 2021 Henry Li <lihl@microsoft.com> - 1.4.4-2
- Initial CBL-Mariner import from Fedora 32 (license: MIT).
- Remove gtk build requirement
- Add which as build requirement
- Remove ibus-setup-m17n which depends on gtk
