...
Name:           kernel-lpg-innovate-signed-%{buildarch}
Version:        6.6.89.2
Release:        1001%{?dist}
License:        GPLv2
...
#   4. Build this spec
Source0:        kernel-lpg-innovate-%{version}-%{release}.%{buildarch}.rpm
...
%description -n kernel-lpg-innovate
...
%triggerin -n kernel-lpg-innovate -- initramfs
mkdir -p %{_localstatedir}/lib/rpm-state/initramfs/pending
touch %{_localstatedir}/lib/rpm-state/initramfs/pending/%{uname_r}
echo "initrd generation of kernel-lpg-innovate %{uname_r} will be triggered later" >&2

%triggerun -n kernel-lpg-innovate -- initramfs
rm -rf %{_localstatedir}/lib/rpm-state/initramfs/pending/%{uname_r}
rm -rf /boot/initramfs-%{uname_r}.img
echo "initrd of kernel-lpg-innovate %{uname_r} removed" >&2

%postun -n kernel-lpg-innovate
%grub2_postun

%post -n kernel-lpg-innovate
/sbin/depmod -a %{uname_r}
%grub2_post

%files -n kernel-lpg-innovate
%defattr(-,root,root)
%license COPYING
...
%changelog
* Wed Jun 18 2025 Dan Streetman <ddstreet@ieee.org> - 6.6.89.2-1001
- Initial creation of kernel-lpg-innovate-signed spec
