...
# (debug, realtime/rt-64k, arm64-16k/64k, automotive) are
...
%ifnarch noarch %{nobuildarches}
%if !%{with_debug} && !%{with_up} && !%{with_arm64_16k} && !%{with_arm64_64k} && !%{with_realtime} && !%{with_realtime_arm64_64k} && !%{with_automotive}
