...
# The Go source tree ships test-data shared objects (e.g. libtiffxx.so.6); disable
# automatic Provides scanning so they are not exposed as package SONAME Provides. The
# real interfaces are declared explicitly via the Provides tags below.
