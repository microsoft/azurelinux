...
%description
The azurelinux-logos package contains Azure Linux brand icons, logos,
and Plymouth boot splash assets. It contains images and files that may
not be distributed with anything but unmodified packages from Azure Linux.
...
%description httpd
The azurelinux-logos-httpd package contains the "Powered by Azure Linux"
