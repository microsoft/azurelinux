...
# If the host machine rpm version is >= 4.16 (such as Azure Linux 2.0), it will create an "sqlite" rpm database backend incompatible with Azure Linux 1.0 (which uses "bdb")
