...
type RepoCloner interface {
	Initialize(destinationDir, tmpDir, workerTar, existingRpmsDir, toolchainRpmsDir string, usePreviewRepo bool, repoDefinitions []string, disableMarinerRepos bool) error
