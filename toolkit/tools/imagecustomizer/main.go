...
var (
	...
	outputPXEArtifactsDir       = app.Flag("output-pxe-artifacts-dir", "Directory to hold all artifacts that can be readily copied to a PXE server to boot a PXE client. It is applicable only if the output format is set to 'iso'.").String()
