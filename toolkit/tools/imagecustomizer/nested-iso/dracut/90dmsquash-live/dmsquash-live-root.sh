...
echo "------ dmsquash-live-root.sh ----- 1 ----- livedev = $1" > /dev/kmsg
echo "------ dmsquash-live-root.sh ----- 1.1 -----" > /dev/kmsg
ls -la /lib/dracut/hooks/initqueue/settled  > /dev/kmsg
echo "------ dmsquash-live-root.sh ----- 1.2 -----" > /dev/kmsg
find / -name rootfs.img > /dev/kmsg
echo "------ dmsquash-live-root.sh ----- 1.3 -----" > /dev/kmsg
lsblk -o NAME,FSTYPE,SIZE,MOUNTPOINT,LABEL,UUID,PARTLABEL,PARTUUID > /dev/kmsg
echo "------ dmsquash-live-root.sh ----- 1.4 -----" > /dev/kmsg
sleep 2s
...
echo "------ dmsquash-live-root.sh ----- 2 -----" > /dev/kmsg
sleep 5s
...
echo "------ dmsquash-live-root.sh ----- 8 -----" > /dev/kmsg
sleep 5s
