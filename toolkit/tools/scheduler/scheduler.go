...
var (
	...
	kernelMacrosFile           = app.Flag("kernel-macros-file", "File containing kernel macros to use while building packages.").ExistingFile()
...
func main() {
	...
	buildAgentConfig := &buildagents.BuildAgentConfig{
		...
		KernelMacrosFile:     *kernelMacrosFile,
