...
func (cfg *Config) ParseSPECsWrapper() error {
	return parseSPECsWrapper(cfg.BuildDir, cfg.SpecsDir, cfg.RpmsDir, cfg.SrpmsDir, cfg.DistTag, cfg.Output, cfg.WorkerTar, cfg.Workers, cfg.RunCheck)
