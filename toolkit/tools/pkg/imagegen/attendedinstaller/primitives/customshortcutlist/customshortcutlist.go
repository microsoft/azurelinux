...
// customshortcutlist is a modification of rivo/tview's list.go.
// Source:  https://github.com/rivo/tview/blob/master/list.go
// License: MIT
...
func (l *List) Draw(screen tcell.Screen) {
	...
	for index, item := range l.items {
		...
		if showShortcuts && item.Shortcut != 0 {
			tview.Print(screen, fmt.Sprintf("[%s[]", string(unicode.ToUpper(item.Shortcut))), x-7, y, 6, tview.AlignRight, l.shortcutColor)
		}
