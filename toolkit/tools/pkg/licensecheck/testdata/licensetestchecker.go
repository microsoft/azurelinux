...
var (
	...
	licensesIn    = app.Flag("licenses", "Path to the input file of license file paths to check for false negatives.").Required().ExistingFile()
...
func main() {
	...
	realLicenseLines, err := file.ReadLines(*licensesIn)
	if err != nil {
