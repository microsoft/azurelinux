...
### RPM manifest file
Azure Linux distroless container images do not contain an RPM database. In order for Secure Composition Analysis tools to detect the contents of a Azure Linux distroless container image, the file `/var/lib/rpmmanifest/container-manifest-2` contains the output of the following command:
