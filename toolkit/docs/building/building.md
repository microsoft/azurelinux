...
| MAX_CASCADING_REBUILDS        | -1                                                                                                     | When a package rebuilds, how many additional layers of dependant packages will be forced to rebuild (-1 is unbounded, i.e., all downstream packages will rebuild)
