...
| EXTRA_MACROS_FILES              |                                                                                                        | Space separated list of additional `<macros.name>` files whose content will be appended to the main `macros.releaseversions` file used during package build. Used to resolve versions of kernel Out of Tree Modules.
