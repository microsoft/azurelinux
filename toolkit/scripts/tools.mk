...
go_ldflags := 	-X github.com/microsoft/azure/toolkit/tools/internal/exe.ToolkitVersion=$(RELEASE_VERSION) \
				-X github.com/microsoft/azure/toolkit/tools/pkg/imagecustomizerlib.ToolVersion=$(IMAGE_CUSTOMIZER_FULL_VERSION) \
				-X github.com/microsoft/azure/toolkit/tools/internal/exe.DistroNameAbbreviation=$(DIST_NAME_ABRV) \
				-X github.com/microsoft/azure/toolkit/tools/internal/exe.DistroMajorVersion=$(dist_major_version_number)
