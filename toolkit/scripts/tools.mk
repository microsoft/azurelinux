...
$(warning Go version '$(go_current_version)' is less than minimum required version '$(go_min_version)')
$(warning -----------------------------------------------------------------------)
...
$(warning |     latest dependencies and configure go symlinks and docker user.  |)
$(warning -----------------------------------------------------------------------)
$(error Fatal Error - Go version '$(go_current_version)' is less than minimum required version '$(go_min_version)'.)
endif
endif
