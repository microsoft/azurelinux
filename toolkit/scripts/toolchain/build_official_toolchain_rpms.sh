...
case $(uname -m) in
    x86_64)
        wget -nv --no-clobber --timeout=30 https://packages.microsoft.com/cbl-mariner/2.0/prod/Microsoft/x86_64/msopenjdk-11-11.0.15-1.x86_64.rpm --directory-prefix=$CHROOT_RPMS_DIR_ARCH
    ;;
    aarch64)
        wget -nv --no-clobber --timeout=30 https://packages.microsoft.com/cbl-mariner/2.0/prod/Microsoft/aarch64/msopenjdk-11-11.0.15-1.aarch64.rpm --directory-prefix=$CHROOT_RPMS_DIR_ARCH
    ;;
esac
