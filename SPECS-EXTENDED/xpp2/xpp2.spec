...
%exclude %{_javadocdir}/%{name}/api/legal/LICENSE
%exclude %{_javadocdir}/%{name}/api/legal/ADDITIONAL_LICENSE_INFO
%exclude %{_javadocdir}/%{name}/api_impl/legal/LICENSE
%exclude %{_javadocdir}/%{name}/api_impl/legal/ADDITIONAL_LICENSE_INFO
