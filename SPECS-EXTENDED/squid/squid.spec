...
if ! getent passwd squid >/dev/null 2>&1 ; then
  /usr/sbin/useradd -g 23 -u 23 -d /var/spool/squid -r -s /usr/sbin/nologin squid >/dev/null 2>&1 || exit 1 
fi
...
* Fri Apr 30 2021 Pawel Winogrodzki <pawelwi@microsoft.com> - 7:4.13-2
