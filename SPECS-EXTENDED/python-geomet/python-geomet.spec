...
Source0: https://github.com/geomet/geomet/archive/refs/tags/0.3.0.tar.gz#/python-%{srcname}-%{version}.tar.gz
...
%changelog
* Thu May 22 2025 Jyoti kanase <v-jykanase@microsoft.com> -  0.3.0-2
