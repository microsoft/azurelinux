...
%doc CHANGELOG.rst README.rst *.md
%license LICENSE.txt 
%{python3_sitelib}/%{pypi_name}-%{version}.dist-info/licenses/LICENSE.txt


%changelog
* Wed Feb 26 2025 Aninda Pradhan <v-anipradhan@microsoft.com> - 0.4.6-10
- Initial Azure Linux import from Fedora 41 (license: MIT)
- License Verified
- Added additional dependencies for successful build
