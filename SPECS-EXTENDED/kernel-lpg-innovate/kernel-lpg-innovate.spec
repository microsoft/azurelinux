...
Source2:        kernel-lpg-innovate.secure.config
...
CheckConfig %{SOURCE1} build_normal
CheckConfig %{SOURCE2} build_secure

# Add CBL-Mariner cert into kernel's trusted keyring
cp %{SOURCE4} certs/mariner.pem
sed -i 's,CONFIG_SYSTEM_TRUSTED_KEYS="",CONFIG_SYSTEM_TRUSTED_KEYS="certs/mariner.pem",' build_normal/.config

sed -i 's/CONFIG_LOCALVERSION=""/CONFIG_LOCALVERSION="-%{release}"/' build_normal/.config
