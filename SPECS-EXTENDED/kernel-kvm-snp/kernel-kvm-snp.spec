...
Summary:        Linux Kernel that supports SEV-SNP on QEMU-KVM as the nested virtualization layer on Microsoft Hyper-V.
Name:           kernel-kvm-snp
Version:        5.19.0
Release:        1%{?dist}
License:        GPLv2
...
URL:            https://github.com/jepio/linux/tree/jepio-nested-snp-5.19-v8
...
Source0:        linux-snp-host-5.19.0.tar.gz
Source1:        config
...
%define uname_r %{version}-rc6-%{release}+
...
%changelog
* Thu Dec 14 2023 Archana Choudhary <archana1@microsoft.com> - 5.19.0-1.cm2
- Initial build
- First version of kernel supporting SEV-SNP on QEMU-KVM
