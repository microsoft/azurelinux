...
<head>
    ...
    <link type="text/css" rel="stylesheet" nonce="FdlNHpz9lVuQjueIInYbRqAw0" href="/static/vendor/font-awesome/font-awesome.css?version=5.13.3"/>
    <link type="text/css" rel="stylesheet" nonce="FdlNHpz9lVuQjueIInYbRqAw0" href="/static/pagure.css?version=5.13.3"/>
<link nonce="FdlNHpz9lVuQjueIInYbRqAw0" rel="stylesheet" href="/static/vendor/highlight.js/styles/github.css?version=5.13.3"/>
<link nonce="FdlNHpz9lVuQjueIInYbRqAw0" rel="stylesheet" href="/static/vendor/highlightjs-line-numbers/highlightjs-line-numbers.min.css?version=5.13.3"/>
<style nonce="FdlNHpz9lVuQjueIInYbRqAw0">
  .hljs {
    background: #fff;
  }
</style>
    ...
    <nav class="navbar navbar-light masthead p-0 navbar-expand">
      <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="btn btn-primary" href="/login/?next=https://src.fedoraproject.org/rpms/ganglia/blob/f32/f/conf.php">Log In</a>
          </li>
        </ul>
      </div>
    </nav>
...
"
  ...
  <script type="text/javascript" nonce="FdlNHpz9lVuQjueIInYbRqAw0">
  ...
  <div class="card-body p-0">
            <div class="bg-light border text-right pr-2">
                <form class="btn btn-sm" method="POST" name="fork_project"
                    action="/fork_edit/rpms/ganglia/edit/f32/f/conf.php">
                ...
                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/blob/f32/f/conf.php" title="View as blob">Blob</a>

                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/blame/conf.php?identifier=f32" title="View git blame">Blame</a>

                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/history/conf.php?identifier=f32" title="View git log for this file">History</a>

                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/raw/f32/f/conf.php" title="View as raw">Raw</a>
            </div>

        <pre class="syntaxhighlightblock"><code class="">&lt;?php
...
?&gt;</code></pre>
    ...
    <script type="text/javascript" nonce="FdlNHpz9lVuQjueIInYbRqAw0" src="/static/vendor/jquery/jquery.min.js?version=5.13.3"></script>
...
<script type="text/javascript"  nonce="FdlNHpz9lVuQjueIInYbRqAw0" src="/static/vendor/lazyload/lazyload.min.js?version=5.13.3"></script>
...
<script type="text/javascript" nonce="FdlNHpz9lVuQjueIInYbRqAw0" src="/static/vendor/highlight.js/highlight.pack.js?version=5.13.3"></script>
<script type="text/javascript" nonce="FdlNHpz9lVuQjueIInYbRqAw0" src="/static/vendor/highlightjs-line-numbers/highlightjs-line-numbers.min.js?version=5.13.3"></script>
<script type="text/javascript" nonce="FdlNHpz9lVuQjueIInYbRqAw0" src="/static/vendor/highlight.js/spec.js?version=5.13.3"></script>
