...
<head>
    ...
    <link type="text/css" rel="stylesheet" nonce="7OCkHK8gqvwrPpww6YHbm6ABz" href="/static/vendor/font-awesome/font-awesome.css?version=5.13.3"/>
    <link type="text/css" rel="stylesheet" nonce="7OCkHK8gqvwrPpww6YHbm6ABz" href="/static/pagure.css?version=5.13.3"/>
<link nonce="7OCkHK8gqvwrPpww6YHbm6ABz" rel="stylesheet" href="/static/vendor/highlight.js/styles/github.css?version=5.13.3"/>
<link nonce="7OCkHK8gqvwrPpww6YHbm6ABz" rel="stylesheet" href="/static/vendor/highlightjs-line-numbers/highlightjs-line-numbers.min.css?version=5.13.3"/>
<style nonce="7OCkHK8gqvwrPpww6YHbm6ABz">
  .hljs {
    background: #fff;
  }
</style>
    ...
    <nav class="navbar navbar-light masthead p-0 navbar-expand">
      <div class="container">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="btn btn-primary" href="/login/?next=https://src.fedoraproject.org/rpms/ganglia/blob/f32/f/ganglia-httpd.conf.d">Log In</a>
          </li>
        </ul>
      </div>
    </nav>
...
"
  ...
  <script type="text/javascript" nonce="7OCkHK8gqvwrPpww6YHbm6ABz">
  ...
  <div class="card-body p-0">
            <div class="bg-light border text-right pr-2">
                <form class="btn btn-sm" method="POST" name="fork_project"
                    action="/fork_edit/rpms/ganglia/edit/f32/f/ganglia-httpd.conf.d">
                ...
                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/blob/f32/f/ganglia-httpd.conf.d" title="View as blob">Blob</a>

                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/blame/ganglia-httpd.conf.d?identifier=f32" title="View git blame">Blame</a>

                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/history/ganglia-httpd.conf.d?identifier=f32" title="View git log for this file">History</a>

                <a class="btn btn-secondary btn-sm" href="/rpms/ganglia/raw/f32/f/ganglia-httpd.conf.d" title="View as raw">Raw</a>
            </div>
...
&lt;/Location&gt;
    ...
    <script type="text/javascript" nonce="7OCkHK8gqvwrPpww6YHbm6ABz" src="/static/vendor/jquery/jquery.min.js?version=5.13.3"></script>
...
<script type="text/javascript"  nonce="7OCkHK8gqvwrPpww6YHbm6ABz" src="/static/vendor/lazyload/lazyload.min.js?version=5.13.3"></script>
...
<script type="text/javascript" nonce="7OCkHK8gqvwrPpww6YHbm6ABz" src="/static/vendor/highlight.js/highlight.pack.js?version=5.13.3"></script>
<script type="text/javascript" nonce="7OCkHK8gqvwrPpww6YHbm6ABz" src="/static/vendor/highlightjs-line-numbers/highlightjs-line-numbers.min.js?version=5.13.3"></script>
<script type="text/javascript" nonce="7OCkHK8gqvwrPpww6YHbm6ABz" src="/static/vendor/highlight.js/spec.js?version=5.13.3"></script>
