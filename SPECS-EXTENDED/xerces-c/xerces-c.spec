...
Source0:	https://downloads.apache.org/xerces/c/3/sources/xerces-c-%{version}.tar.xz#/%{name}-%{version}.tar.gz
...
%changelog
* Wed Aug 09 2023 Archana Choudhary <archana1@microsoft.com> - 3.2.4-1
