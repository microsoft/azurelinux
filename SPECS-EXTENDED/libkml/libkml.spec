...
Source0:        https://github.com/libkml/libkml/archive/%{version}/libkml-%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
%changelog
* Thu Aug 03 2023 Archana Choudhary <archana1@microsoft.com> - 1.3.0-41
