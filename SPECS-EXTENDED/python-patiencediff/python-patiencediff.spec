...
%changelog
* Mon Apr 13 2026 Akarsh Chaudhary <v-akarshc@microsoft.com> - 0.2.15-9
- Initial CBL-Mariner import from Fedora 43 (license: MIT).
- License verified.

* Sat Jan 17 2026 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.15-8
...
* Thu Jun 13 2024 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.15-1
- Update to 0.2.15
...
* Mon Sep 18 2023 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.14-1
- Update to 0.2.14
...
* Tue Feb 28 2023 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.13-1
- Update to 0.2.13
- Resolves: rhbz#2167981

* Mon Jan 16 2023 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.12-1
- Update to 0.2.12
- Migrate to the newest python macros
- Convert license to SPDX
- Resolves: rhbz#2137836

* Wed Oct 19 2022 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.6-1
- Update to 0.2.6
- Resolves: rhbz#2135936

* Wed Sep 07 2022 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.3-1
- Update to 0.2.3
...
* Mon Mar 29 2021 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.2-1
- Update to 0.2.2

* Wed Jan 27 2021 Fedora Release Engineering <releng@fedoraproject.org> - 0.2.1-2
- Rebuilt for https://fedoraproject.org/wiki/Fedora_34_Mass_Rebuild

* Tue Sep 15 2020 Ondrej Pohorelsky <opohorel@redhat.com> - 0.2.1-1
- Initial package.
