...
BuildRequires: python3-decorator, python3-pyudev
Requires: python3-decorator, python3-pyudev, python3-configobj
Requires: python3-schedutils, python3-linux-procfs, python3-perf
# BuildRequires for 'make test'
...
%install
make install DESTDIR=%{buildroot} DOCDIR=%{docdir} PYTHON=%{__python3}
...
%changelog
* Thu Oct 14 2021 Pawel Winogrodzki <pawelwi@microsoft.com> - 2.15.0-3
- Converting the 'Release' tag to the '[number].[distribution]' format.

* Wed Aug 11 2021 Thomas Crain <thcrain@microsoft.com> - 2.15.0-2
- Initial CBL-Mariner import from Fedora 33 (license: MIT).
- Remove python2, RHEL support
- Conditionally build docs, off by default
