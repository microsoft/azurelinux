...
Source0:        https://files.pythonhosted.org/packages/source/S/%{srcname}/%{srcname}-%{srcversion}.tar.gz#/python-%{srcname}-%{srcversion}.tar.gz
...
%changelog
* Thu Feb 04 2021 Joe Schmitt <joschmit@microsoft.com> - 1.3.22-2
