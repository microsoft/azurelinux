...
%changelog
* Wed Oct 06 2021 Pawel Winogrodzki <pawelwi@microsoft.com> - 1.26.4-3
- Bringing back the dependency on 'cairo'.

* Wed Jun 16 2021 Thomas Crain <thcrain@microsoft.com> - 1.26.4-2
- Initial CBL-Mariner import from Fedora 32 (license: MIT).
- Change "cairo" requirement to "UI-cairo" to avoid runtime conflicts
