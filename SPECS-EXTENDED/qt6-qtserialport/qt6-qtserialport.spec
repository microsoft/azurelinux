...
Requires: %{name}%{?_isa} = %{version}-%{release}
# BuildRequires: qt-qtserialport-devel >= %{version}
...
%files
%license LICENSES/*
%{_qt_libdir}/libQt6SerialPort.so.6*

%files devel
%{_qt_headerdir}/QtSerialPort/
%{_qt_libdir}/libQt6SerialPort.so
%{_qt_libdir}/libQt6SerialPort.prl
%{_qt_libdir}/cmake/Qt6BuildInternals/StandaloneTests/QtSerialPortTestsConfig.cmake
%dir %{_qt_libdir}/cmake/Qt6SerialPort/
%{_qt_libdir}/cmake/Qt6SerialPort/*.cmake
%{_qt_archdatadir}/mkspecs/modules/qt_lib_serialport*.pri
...
%changelog
* Fri Dec 05 2025 Sandeep Karambelkar <skarambelkar@microsoft.com> - 6.5.7-1
