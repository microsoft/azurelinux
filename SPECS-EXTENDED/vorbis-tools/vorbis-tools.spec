...
Obsoletes:	vorbis < %{version}-%{release}
...
%changelog
* Thu Oct 28 2021 Muhammad Falak <mwani@microsft.com> - 1.4.0-35
- Remove epoch

* Fri Oct 15 2021 Pawel Winogrodzki <pawelwi@microsoft.com> - 1:1.4.0-34
