...
Source0: https://support.hdfgroup.org/ftp/HDF/releases/HDF%{version}/src/%{name}-%{version}.tar.bz2#/%{name}-%{version}.tar.gz
Source1: h4comp
...
%changelog
* Fri Aug 04 2023 Archana Choudhary <archana1@microsoft.com> - 4.2.15-12
