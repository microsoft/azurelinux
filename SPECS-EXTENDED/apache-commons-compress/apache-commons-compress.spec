...
%build
mkdir -p lib
cp -v /usr/share/java/{xz-java,commons-io,commons-codec,commons-lang3}.jar lib/

ant -f build.xml package javadoc

%install
# Install JAR
install -dm 0755 %{buildroot}%{_javadir}

install -pm 0644 target/commons-compress-%{version}.jar %{buildroot}%{_javadir}/%{short_name}-%{version}.jar
ln -sf %{short_name}-%{version}.jar %{buildroot}%{_javadir}/%{name}.jar
...
-------------------------------------------------------------------
Tue May 14 10:26:58 UTC 2024 - Fridrich Strba <fstrba@suse.com>
