...
Source0:	https://files.pythonhosted.org/packages/source/p/%{pypi_name}/%{pypi_name}-%{version}.tar.gz#/%{pypi_name}-%{version}.tar.gz
...
%pyproject_save_files cdio iso9660 pycdio pyiso9660
...
* Tue May 26 2020 Miro HronÄ¨ok <mhroncok@redhat.com> - 2.1.0-2
