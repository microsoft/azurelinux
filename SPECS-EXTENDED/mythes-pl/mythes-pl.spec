...
Version: 1.5
Release: 26%{?dist}
Source0: https://downloads.sourceforge.net/synonimy/OOo2-Thesaurus-%{version}.zip
Source1: %{name}-LICENSE.txt
# URL is dead now, please don't file bugs to fix it
URL: https://synonimy.ux.pl/
License: LGPLv2
BuildArch: noarch
Requires: mythes
...
%changelog
* Fri Dec 10 2021 Thomas Crain <thcrain@microsoft.com> - 1.5-26
- License verified
