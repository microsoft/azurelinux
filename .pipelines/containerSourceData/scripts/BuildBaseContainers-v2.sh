...
# TODO: Update the script to use base directory instead of base-v2.
...
function docker_build {
    ...
    cp "$CONTAINER_SRC_DIR/base-v2/$dockerfile" "$build_dir/dockerfile"
...
function docker_build_custom {
    ...
    docker build . \
        ...
        -t "$image_full_name" \
        -f "$CONTAINER_SRC_DIR/base-v2/$dockerfile" \
        --no-cache
