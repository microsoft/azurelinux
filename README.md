...
## ISO
You can try out CBL-Mariner with the following unsupported ISO Image: [x86_64 ISO](https://osrelease.download.prss.microsoft.com/pr/download/Mariner-1.0-x86_64.iso).  After downloading the ISO, use the [following instructions](./toolkit/docs/quick_start/quickstart.md#prepare-vm) to install and use in a Hyper-V VM.
